...
#if !defined(__paSurface_hpp)
#define __paSurface_hpp
...
//	friend class paContactGen;
	...
	int setContactAmpMin(paFloat a) { m_contactAmpMin = a; return 0; }
	...
	int setMaxHardness(paFloat h) { m_maxHardness = h; return 0; }
	// Stiffness control
	int setImpulseToHardnessBreakpoint(paFloat i) { m_impulseToHardnessBreakpoint = i; return 0; }
