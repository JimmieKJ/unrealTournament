...
class USoundClassGraph : public UEdGraph
{
	 ...
	 */
	UNREALED_API void SetRootSoundClass(class USoundClass* InSoundClass);
	/**
	 ...
	 */
	UNREALED_API void AddNewSoundClass(UEdGraphPin* FromPin, class USoundClass* SoundClass, int32 NodePosX, int32 NodePosY, bool bSelectNewNode = true);
	/**
	 ...
	 */
	UNREALED_API void RefreshGraphLinks();
	/**
	 * Recursively remove a set of nodes from this graph and re-link SoundClasses afterwards
	 */
	UNREALED_API void RecursivelyRemoveNodes(const TSet<class UObject*> NodesToRemove);
