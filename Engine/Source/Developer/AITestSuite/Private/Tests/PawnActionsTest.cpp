...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_Push, "Engine.AI.Pawn Actions.Pushing Single Action")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_PushingSameActionWithDelay, "Engine.AI.Pawn Actions.Pusihng action that has already been pushed should fail")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_Pause, "Engine.AI.Pawn Actions.Pausing Action by younger Action of same priority")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_SamePriorityOrder, "Engine.AI.Pawn Actions.Respecting push order")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_DoublePushingAction, "Engine.AI.Pawn Actions.Pushing same action twice")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_SimplePriority, "Engine.AI.Pawn Actions.Pushing different priority actions")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_HighPriorityKeepRunning, "Engine.AI.Pawn Actions.High priority action still running after pushing lower priority action")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_SamePriorityActionsPushing, "Engine.AI.Pawn Actions.Pushing multiple actions of same priority")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_Aborting, "Engine.AI.Pawn Actions.Basic aborting mechanics")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_PushAndAbort, "Engine.AI.Pawn Actions.Push and Abort same frame")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_AbortAfterPushingNewAction, "Engine.AI.Pawn Actions.Abort action after a newer action has been pushed")
...
IMPLEMENT_AI_LATENT_TEST(FAITest_PawnActions_ActionPushingActions, "Engine.AI.Pawn Actions.Action pushing Actions")
