...
#include "Widgets/SProjectLauncherBuildTaskSettings.h"
...
void SProjectLauncherBuildTaskSettings::Construct( const FArguments& InArgs, const FProjectLauncherModelRef& InModel )
{
	Model = InModel;
