...
<TpsData xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <Notification>NVIDIA Corporation
Software License Agreement –SDK
IMPORTANT - READ BEFORE COPYING, INSTALLING OR USING
Do not use or load the SDK and any associated materials provided by NVIDIA on the extranet (collectively, the “Software”) until You have carefully read the following terms and conditions. By loading or using the Software, You agree to fully comply with the terms and conditions of this Software License Agreement (“Agreement”) by and between NVIDIA Corporation, a Delaware corporation with its principal place of business at 2701 San Tomas Expressway, Santa Clara, California 95050 U.S.A. (“NVIDIA”), and You. If You do not wish to so agree, do not install or use the Software.
For the purposes of this Agreement:
“Licensee,” “You” and/or “Your” shall mean, collectively and individually, Original Equipment Manufacturers, Independent Hardware Vendors, Independent Software Vendors, and End-Users of the Software pursuant to the terms and conditions of this Agreement.
...
(b) to transfer, distribute and sublicense Derivative Works (in object code only)
created by You as incorporated (in whole or in part) in Your software applications that execute on or use NVIDIA hardware and software.
You may exercise your license rights pursuant to Subsection 1(b) above pursuant to the terms and conditions of any form of end-user software license agreement, provided Your end-user agrees to be bound by terms and conditions that are as protective of NVIDIA’s Intellectual Property Rights in the Software as this Agreement.
...
If applicable, any exchange of Confidential Information (as defined in the NDA) shall be made pursuant to the terms and conditions of a separately signed Non-Disclosure Agreement (“NDA”) by and between NVIDIA and You. For the sake of clarity, You agree that the Software is Confidential Information of NVIDIA.
...
SECTION 3 - OWNERSHIP OF SOFTWARE AND INTELLECTUAL PROPERTY RIGHTS. All rights, title and interest to all copies of the Software remain with NVIDIA, subsidiaries, licensors, or its suppliers. The Software is copyrighted and protected by the laws of the
United States and other countries, and international treaty provisions. You may not remove any copyright notices from the Software. NVIDIA may make changes to the Software, or to items referenced therein, at any time and without notice, but is not obligated to support or update the Software. Except as otherwise expressly provided, NVIDIA grants no express or implied right under any NVIDIA patents, copyrights, trademarks, or other intellectual property rights.
...
No failure or delay on the part of either party in the exercise of any right, power or remedy under this Agreement or under law, or to insist upon or enforce performance by the other party of any of the provisions of this Agreement or under law, shall operate as a waiver thereof, nor shall any single or partial exercise of any right, power or remedy preclude
 
other or further exercise thereof, or the exercise of any other right, power or remedy; rather the provision, right, or remedy shall be and remain in full force and effect.
