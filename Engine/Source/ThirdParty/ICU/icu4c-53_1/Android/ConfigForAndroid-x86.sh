...
GCCTOOLCHAIN=$NDKROOT/toolchains/x86-4.8/prebuilt/windows-x86_64
...
export CPPFLAGS="$COMMONTOOLCHAINFLAGS $COMMONINCLUDES -MD -MF /dev/null -DANDROID -frtti -fno-exceptions -fdata-sections -ffunction-sections -DUCONFIG_NO_TRANSLITERATION=1 -DPIC -DU_HAVE_NL_LANGINFO_CODESET=0 -DU_TIMEZONE=0"
...
../../Source/configure --prefix=$PWD --build=x86_64-unknown-cygwin --with-cross-build=$PWD/../../Win64/VS2013 --host=i686-none-linux-android --enable-debug --disable-release --enable-static --disable-shared --with-data-packaging=files