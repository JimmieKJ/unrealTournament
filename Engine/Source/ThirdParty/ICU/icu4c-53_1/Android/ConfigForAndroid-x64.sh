SYSROOT=$NDKROOT/platforms/android-20/arch-x86_64
...
../../Source/configure --prefix=$PWD --build=x86_64-unknown-cygwin --with-cross-build=$PWD/../../Win64/VS2013 --host=x86_64-none-linux-android --enable-debug --disable-release --enable-static --disable-shared --with-data-packaging=files