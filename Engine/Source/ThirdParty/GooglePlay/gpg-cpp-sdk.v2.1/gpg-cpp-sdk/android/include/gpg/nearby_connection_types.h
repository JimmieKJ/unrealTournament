...
struct GPG_EXPORT AppIdentifier {
   ...
   * on
   * the platform. For Android, this string is a package name.
   */
 ...
 * remote endpoint
 * attempts to connect to the app's own endpoint.
 * <code>client_id</code> is the ID of the <code>NearbyConnections</code>
 * instance that
 * received this request.
 * <code>request</code> contains the details of the connection request.
 * @ingroup Callbacks
 */
 ...
 * local
 * endpoint advertising attempt is complete; its success field indicates whether
 * advertising started successfully.
 * <code>client_id</code> is the ID of the <code>NearbyConnections</code>
 * instance that
 * tried to start advertising.
 * <code>result</code> contains the results of that advertisement.
 * @ingroup Callbacks
 */
typedef std::function<
    void(int64_t client_id, StartAdvertisingResult const &result)>
 ...
 * <code>response</code> contains the details of the response.
 */
typedef std::function<
    void(int64_t client_id, ConnectionResponse const &response)>
