...
class GPG_EXPORT EndpointDiscoveryListenerHelper {
 public:
   ...
   * <code>EndpointDiscoveryListenerHelperImpl</code>.
  ...
  typedef std::function<
      void(int64_t client_id, EndpointDetails const &endpoint_details)>
   ...
   */
  typedef std::function<
      void(int64_t client_id, std::string const &remote_endpoint_id)>
