...
class GPG_EXPORT SnapshotManager {
 public:
   ...
   * <code>GameServices::Snapshots</code> call.
   */
   ...
   * provided in the <code>conflict_id</code>, <code>conflict_base</code>,
   * and <code>conflict_remote</code> fields.
  ...
  struct OpenResponse {
     ...
     * <code>conflict_id</code>, <code>conflict_base</code>, and
     * <code>conflict_remote</code>.
     */
     ...
     * current base version of the snapshot.
     */
    SnapshotMetadata conflict_base;
     ...
     * device.
     */
    SnapshotMetadata conflict_remote;
  };
  /**
   ...
   *
   * <code>SnapshotManager::BASE_WINS</code> - In the event of a
   * conflict, the base snapshot will be used.
   *
   * <code>SnapshotManager::REMOTE_WINS</code> - In the event of a
