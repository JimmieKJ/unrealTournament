...
class GPG_EXPORT QuestMilestone {
 public:
   ...
   */
  explicit QuestMilestone(std::shared_ptr<QuestMilestoneImpl> impl);
  ...
  /**
   * Returns the milestone state: <code>NOT_COMPLETED, COMPLETED_NOT_CLAIMED,
   * </code> or <code>CLAIMED</code>.
   * <code>QuestMilestone::Valid()</code> must return true for this function
   * to be usable.
   */
 ...
 private:
  friend class QuestMilestoneImpl;
  std::shared_ptr<QuestMilestoneImpl> impl_;
};
