...
class GPG_EXPORT LeaderboardManager {
 public:
  /**
   * Constructs a <code>LeaderboardManager</code> from a
   * <code>GameServicesImpl</code>. This is not intended to be called by
   * consumers of this API. Instead, an app should retrieve the
   * <code>LeaderboardManager</code> via the
   * <code>GameServices::Leaderboards()</code> call.
   */
   ...
   * on the resulting score page, which may be be no larger than 25.
   */
  void FetchScorePage(DataSource data_source,
                      ScorePage::ScorePageToken const &token,
                      uint32_t max_results,
   ...
   * leaderboard. Returns when the user has dismissed the UI.
   */
