...
class GPG_EXPORT PlayerManager {
 public:
   ...
   * FetchSelf(DataSource data_source, FetchSelfCallback callback), with
   ...
   * <code>Player</code>. The data value is only <Code>Valid()</code> if
   ...
   */
  void FetchRecentlyPlayed(DataSource data_source,
