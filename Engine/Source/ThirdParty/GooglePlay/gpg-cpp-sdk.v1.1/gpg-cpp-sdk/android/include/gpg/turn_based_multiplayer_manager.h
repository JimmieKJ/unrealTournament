...
class GPG_EXPORT TurnBasedMultiplayerManager {
 public:
  ...
  /**
   * Constructs a <code>TurnBasedMultiplayerManager</code> from a
   * <code>GameServicesImpl</code>. This is not intended to be called by
   * consumers of this API. Instead, an app should retrieve the
   * <code>TurnBasedMultiplayerManager</code> via the
   * <code>GameServices::TurnBasedMultiplayer()</code> call.
   */
   ...
   *     {@link TurnBasedMatch::AutomatchingSlotsAvailable} may be used to
   *     specify that the next participant should be selected via auto-matching.
