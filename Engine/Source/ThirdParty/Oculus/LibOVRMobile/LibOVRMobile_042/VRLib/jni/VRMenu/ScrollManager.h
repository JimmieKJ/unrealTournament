...
struct OvrScrollBehavior
{
	...
	: FrictionPerSec( 5.0f )
	, Padding( 1.0f )
	, WrapAroundHoldTime( 0.5f )
	, WrapAroundSpeed( 1.5f )
...
{
public:
			OvrScrollManager( ScrollType type );
	void 	SnapToNearestItemAndLoseFocus();
...
private:
	...
	ScrollType 								CurrentScrollType; // Is it horizontal scrolling or vertical scrolling
