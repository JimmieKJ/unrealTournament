...
double TimeInSeconds();	// JDC


//-------------------------------------------------------------------------------------
// ***** Sensor State

// These values are reported as compatible with CAPI.
...
private:
    ...
    // This flag is set while Sensor is attached and running.
    volatile bool     		SensorDataAvailable;
