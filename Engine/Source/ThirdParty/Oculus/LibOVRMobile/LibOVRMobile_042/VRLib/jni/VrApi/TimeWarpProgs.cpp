...
void TimeWarpLocal::BuildWarpProgPair( warpProgram_t simpleIndex,
...
void TimeWarpLocal::BuildWarpProgMatchedPair( warpProgram_t simpleIndex,
		const char * simpleVertex, const char * simpleFragment
		)
{
	warpPrograms[ simpleIndex ] =
