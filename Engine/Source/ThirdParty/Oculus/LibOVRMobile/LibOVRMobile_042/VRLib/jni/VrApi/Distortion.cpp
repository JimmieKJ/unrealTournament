		...
		int eyeBlocksWide, int eyeBlocksHigh )
{
	...
	const float	horizontalShiftMeters =  ( hmdInfo.lensSeparation / 2 ) - ( hmdInfo.widthMeters / 4 );
	const float	horizontalShiftView = 2 * aspect * horizontalShiftMeters / hmdInfo.widthMeters;
