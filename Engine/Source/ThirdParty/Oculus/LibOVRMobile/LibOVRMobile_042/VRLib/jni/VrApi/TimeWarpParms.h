...
static const int SWAP_OPTION_FIXED_OVERLAY = 32;
...
// the camera view with the given modelViewMatrix, it can alternately be
...
ovrMatrix4f TanAngleMatrixFromFov( const float fieldOfView );
