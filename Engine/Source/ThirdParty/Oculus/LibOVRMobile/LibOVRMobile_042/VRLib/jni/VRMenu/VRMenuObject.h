...
typedef OVR::TypesafeNumberT< UInt64, eMenuIdType, INVALID_MENU_OBJECT_ID >	menuHandle_t;
...
public:
	...
	virtual void 				RegenerateSurfaceGeometry( int const surfaceIndex ) = 0;
