...
// be called earlier so hybrid apps can tell when they need to go to vr mode.
//
// This can't be merged into ovr_OnLoad, because the ActivityObject
...
// when the headset has been connected or disconnected.
