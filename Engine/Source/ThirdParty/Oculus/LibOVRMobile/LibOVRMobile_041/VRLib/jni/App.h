...
public:
	...
	// Switch to another application. FIXME: do we need this now?
	virtual void				SendIntent( const char * package, const char * data ) = 0;
	...
	// FIXME: this probably should be moved somewhere else now that App is abstract
	// convenience string function for command messages
