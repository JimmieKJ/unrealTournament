...
{
public:
	static const float DEFAULT_TEXT_SCALE;
	...
	virtual void				RenderSubmitted( Matrix4f const & worldMVP ) = 0;

    virtual GlProgram *         GetGUIGlProgram( eGUIProgramType const programType ) = 0;
};
