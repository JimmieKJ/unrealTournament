...
public:
    ...
    bool                    IsOpenOrOpening() const { return CurMenuState == MENUSTATE_OPEN || CurMenuState == MENUSTATE_OPENING; }
    
    bool                    IsClosed() const { return CurMenuState == MENUSTATE_CLOSED; }
    bool                    IsClosedOrClosing() const { return CurMenuState == MENUSTATE_CLOSED || CurMenuState == MENUSTATE_CLOSING; }
