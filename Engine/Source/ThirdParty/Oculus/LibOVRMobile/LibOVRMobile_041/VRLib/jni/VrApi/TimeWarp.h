...
public:
	...
	// a fatal error.
	virtual void		WarpSwap( const TimeWarpParms & parms ) = 0;

	virtual void		WarpSwapBlack( const float fovDegrees ) = 0;
	virtual void		WarpSwapLoadingIcon( const float fovDegrees ) = 0;
