...
public interface IVRManager
{
	...
	/**
	 * setCPUClockMhz 
	 * Locks the CPU to the closest matching frequency.  Returns the actual frequency set.
	 * @param pkg String identifying app package
	 * @param mhz array of mhz values indexed to their respective CPU core
	 * @return integer array of actual values set to the cores
	 * {@hide}
	 */
	abstract public int[] setCPUClockMhz( String pkg, int[] mhz );
	
	// Samsung provided interfaces
	
	abstract public int[] setCPUClockMhz( String pkg, int[] mhz , int corenum);
	abstract public void releaseCPUMhz( String pkg);
	abstract public void releaseGPUMhz( String pkg);
	
	/**
	 * setGPUClockMhz 
	 * Locks the GPU to the closest matching frequency.  Returns the actual frequency set.
	 * @param pkg String identifying app package
	 * @param mhz GPU processor speed
	 * @return integer result of processor speed set
	 * {@hide}
	 */
	abstract public int setGPUClockMhz( String pkg, int mhz );
