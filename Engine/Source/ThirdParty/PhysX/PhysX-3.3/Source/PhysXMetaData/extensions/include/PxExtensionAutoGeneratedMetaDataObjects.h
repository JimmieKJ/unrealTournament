...
template<> struct PxEnumTraits< physx::PxJointActorIndex::Enum > { PxEnumTraits() : NameConversion( g_physx__PxJointActorIndex__EnumConversion ) {} const PxU32ToName* NameConversion; }; 
	static PxU32ToName g_physx__PxJointConcreteType__EnumConversion[] = {
		{ "eSPHERICAL", static_cast<PxU32>( physx::PxJointConcreteType::eSPHERICAL ) },
		{ "eREVOLUTE", static_cast<PxU32>( physx::PxJointConcreteType::eREVOLUTE ) },
		{ "ePRISMATIC", static_cast<PxU32>( physx::PxJointConcreteType::ePRISMATIC ) },
		{ "eFIXED", static_cast<PxU32>( physx::PxJointConcreteType::eFIXED ) },
		{ "eDISTANCE", static_cast<PxU32>( physx::PxJointConcreteType::eDISTANCE ) },
		{ "eD6", static_cast<PxU32>( physx::PxJointConcreteType::eD6 ) },
		{ "eLast", static_cast<PxU32>( physx::PxJointConcreteType::eLast ) },
		{ NULL, 0 }
	};

template<> struct PxEnumTraits< physx::PxJointConcreteType::Enum > { PxEnumTraits() : NameConversion( g_physx__PxJointConcreteType__EnumConversion ) {} const PxU32ToName* NameConversion; }; 
	class PxJoint;
...
template<> struct PxEnumTraits< physx::PxSphericalJointFlag::Enum > { PxEnumTraits() : NameConversion( g_physx__PxSphericalJointFlag__EnumConversion ) {} const PxU32ToName* NameConversion; }; 
		...
		: PxJointLimitParametersGeneratedInfo
	{
		...
		TReturnType visitType( TOperator inOperator ) const
		{
			return inOperator( (PxJointLinearLimit*)NULL );
		}
		template<typename TOperator>
		void visitBases( TOperator inOperator )
		{
		...
		: PxJointLimitParametersGeneratedInfo
	{
		...
		TReturnType visitType( TOperator inOperator ) const
		{
			return inOperator( (PxJointLinearLimitPair*)NULL );
		}
		template<typename TOperator>
		void visitBases( TOperator inOperator )
		{
		...
		: PxJointLimitParametersGeneratedInfo
	{
		...
		TReturnType visitType( TOperator inOperator ) const
		{
			return inOperator( (PxJointAngularLimitPair*)NULL );
		}
		template<typename TOperator>
		void visitBases( TOperator inOperator )
		{
...

	{
		...
		TReturnType visitType( TOperator inOperator ) const
		{
			return inOperator( (PxSpring*)NULL );
		}
		template<typename TOperator>
		void visitBases( TOperator inOperator )
		{
