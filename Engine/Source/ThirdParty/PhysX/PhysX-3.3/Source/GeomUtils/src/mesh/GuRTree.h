...
#pragma warning(disable: 4251 ) // class needs to have dll-interface to be used by clients of class
	...
	//==================================================================================================
		...
		PxBounds3	refitAll(CallbackRefit& cb); // returns bounds of the entire tree
		PxBounds3	refitRecursive(PxU8* nodes, PxU32 top, RTreePage* parentPage, PxU32 parentSubIndex, CallbackRefit& cb);
		void		refitAllStaticTree(CallbackRefit& cb, PxBounds3* resultMeshBounds); // faster version of refit for static RTree only

		////////////////////////////////////////////////////////////////////////////
		// DEBUG HELPER FUNCTIONS
		void		validate(CallbackRefit* cb = NULL); // verify that all children are indeed included in parent bounds
		void		openTextDump();
		void		closeTextDump();
