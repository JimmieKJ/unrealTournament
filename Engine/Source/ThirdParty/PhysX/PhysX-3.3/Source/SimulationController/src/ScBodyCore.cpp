...
:	RigidCore(type)
{
	...
	mWakeCounter = Sc::Physics::sWakeCounterOnCreation;
	...
	mFreezeThreshold				= 2.5e-5f * scale.speed * scale.speed;
	mSimStateData					= NULL;
...
PxReal Sc::BodyCore::getWakeCounter() const
{
	return mWakeCounter;
}
