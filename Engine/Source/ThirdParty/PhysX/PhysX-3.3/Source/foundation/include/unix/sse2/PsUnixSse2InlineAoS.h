...
#define _PX_FPCLASS_SNAN   0x0001  /* signaling NaN */
#define _PX_FPCLASS_QNAN   0x0002  /* quiet NaN */
#define _PX_FPCLASS_NINF   0x0004  /* negative infinity */
#define _PX_FPCLASS_PINF   0x0200  /* positive infinity */
...
{
	const PxU32 badNumber = (_PX_FPCLASS_SNAN | _PX_FPCLASS_QNAN | _PX_FPCLASS_NINF | _PX_FPCLASS_PINF);
	const FloatV vBadNum = FLoad((PxF32&)badNumber);
...
{
	const PxU32 badNumber = (_PX_FPCLASS_SNAN | _PX_FPCLASS_QNAN | _PX_FPCLASS_NINF | _PX_FPCLASS_PINF);
	const Vec3V vBadNum = V3Load((PxF32&)badNumber);
...
PX_FORCE_INLINE bool isFiniteVec4V(const Vec4V a)
{
	...
	const PxU32 badNumber = (_PX_FPCLASS_SNAN | _PX_FPCLASS_QNAN | _PX_FPCLASS_NINF | _PX_FPCLASS_PINF);
	const Vec4V vBadNum = V4Load((PxF32&)badNumber);
	const BoolV vMask = BAnd(vBadNum,  a);
...
{
	UnionM128 a(in);
	return Vec4VLoadXYZW(PxCeil(a.m128_f32[0]), PxCeil(a.m128_f32[1]), PxCeil(a.m128_f32[2]), PxCeil(a.m128_f32[3]));
}

PX_FORCE_INLINE Vec4V V4Floor(const Vec4V in)
{
	UnionM128 a(in);
	return Vec4VLoadXYZW(PxFloor(a.m128_f32[0]), PxFloor(a.m128_f32[1]), PxFloor(a.m128_f32[2]), PxFloor(a.m128_f32[3]));
}
