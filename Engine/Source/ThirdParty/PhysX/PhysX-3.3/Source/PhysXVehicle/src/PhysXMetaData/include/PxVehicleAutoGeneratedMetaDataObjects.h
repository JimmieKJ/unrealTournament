...
template<> struct PxEnumTraits< physx::PxVehicleClutchAccuracyMode::Enum > { PxEnumTraits() : NameConversion( g_physx__PxVehicleClutchAccuracyMode__EnumConversion ) {} const PxU32ToName* NameConversion; }; 
...

	{
		...
		PxU32 visitInstanceProperties( TOperator inOperator, PxU32 inStartIndex = 0 ) const
		{
			...
			inOperator( TireLoadFilterData, inStartIndex + 10 );; 
			inOperator( MinLongSlipDenominator, inStartIndex + 11 );; 
			inOperator( ThresholdLongSpeed, inStartIndex + 12 );; 
			inOperator( LowForwardSpeedSubStepCount, inStartIndex + 13 );; 
			inOperator( HighForwardSpeedSubStepCount, inStartIndex + 14 );; 
			inOperator( WheelEnabledState, inStartIndex + 15 );; 
