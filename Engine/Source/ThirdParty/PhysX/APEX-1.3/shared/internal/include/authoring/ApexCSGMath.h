...
public:
	...
	PX_INLINE		Pos(const physx::PxF32* v) : Vec4Real()
	{
		set((Real)v[0], (Real)v[1], (Real)v[2]);
	}
	PX_INLINE		Pos(const physx::PxF64* v) : Vec4Real()
	{
		set((Real)v[0], (Real)v[1], (Real)v[2]);
	}
...
public:
	...
	PX_INLINE		Dir(const physx::PxF32* v) : Vec4Real()
	{
		set((Real)v[0], (Real)v[1], (Real)v[2]);
	}
	PX_INLINE		Dir(const physx::PxF64* v) : Vec4Real()
	{
		set((Real)v[0], (Real)v[1], (Real)v[2]);
	}
