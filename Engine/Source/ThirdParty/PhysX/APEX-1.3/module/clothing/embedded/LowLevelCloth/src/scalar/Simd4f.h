...
template <>
inline Simd4fFactory<detail::IntType<0x8000000> >::operator Scalar4f() const
{
	int32_t i = 0x8000000;
...
template <>
inline Simd4fFactory<detail::IntType<-1> >::operator Scalar4f() const
{
	int32_t i = -1;
	return Scalar4f(i, i, i, i);
}
...
{
	return Scalar4f(v.u4[0] & ~complement.v.u4[0], v.u4[1] & ~complement.v.u4[1], 
		v.u4[2] & ~complement.v.u4[2], v.u4[3] & ~complement.v.u4[3]);
}
...
{
	return Scalar4f(v0.f4[0] == v1.f4[0], v0.f4[1] == v1.f4[1], 
		v0.f4[2] == v1.f4[2], v0.f4[3] == v1.f4[3]);
}
...
inline Scalar4f operator&( const Scalar4f& v0, const Scalar4f& v1 )
{
	return Scalar4f(v0.u4[0] & v1.u4[0], v0.u4[1] & v1.u4[1], 
		v0.u4[2] & v1.u4[2], v0.u4[3] & v1.u4[3]);
}
...
{
	return Scalar4f(v.u4[0] << shift, v.u4[1] << shift, 
		v.u4[2] << shift, v.u4[3] << shift);
}
...
inline void storeAligned( float* ptr, int offset, const Scalar4f& v )
{
	storeAligned( reinterpret_cast<float*>(
...
{
	return Scalar4f(std::max(v0.f4[0], v1.f4[0]), std::max(v0.f4[1], v1.f4[1]), 
		std::max(v0.f4[2], v1.f4[2]), std::max(v0.f4[3], v1.f4[3]));
}

inline Scalar4f min(const Scalar4f& v0, const Scalar4f& v1)
{
	return Scalar4f(std::min(v0.f4[0], v1.f4[0]), std::min(v0.f4[1], v1.f4[1]), 
		std::min(v0.f4[2], v1.f4[2]), std::min(v0.f4[3], v1.f4[3]));
}
...
template <int n>
Scalar4f recipT( const Scalar4f& v )
{
	Scalar4f two = simd4f(2.0f);
	Scalar4f recipV = recip(v);
	for(int i=0; i<n; ++i)
...
template <int n>
Scalar4f rsqrtT( const Scalar4f& v )
{
	Scalar4f halfV = v * simd4f(0.5f);
	Scalar4f threeHalf = simd4f(1.5f);
	Scalar4f rsqrtV = rsqrt(v);
	for(int i=0; i<n; ++i)
...
inline Scalar4f exp2( const Scalar4f& v )
{
	...
	return Scalar4f(::expf(v.f4[0] * scale), ::expf(v.f4[1] * scale), 
		::expf(v.f4[2] * scale), ::expf(v.f4[3] * scale));
}

namespace simdf
{
	// PSP2 is confused resolving about exp2, forwarding works
	inline Scalar4f exp2( const Scalar4f& v) { return ::exp2(v); }
}

inline Scalar4f log2( const Scalar4f& v )
{
	float scale = 1.44269504088896341f; // 1/ln(2)
	return Scalar4f(::logf(v.f4[0]) * scale, ::logf(v.f4[1]) * scale, 
		::logf(v.f4[2]) * scale, ::logf(v.f4[3]) * scale);
}
...
{
	return simd4f(
		v0.f4[1]*v1.f4[2] - v0.f4[2]*v1.f4[1],
		v0.f4[2]*v1.f4[0] - v0.f4[0]*v1.f4[2],
...
inline void transpose(Scalar4f& x, Scalar4f& y, Scalar4f& z, Scalar4f& w)
{
	...
	x.f4[1] = y.f4[0]; x.f4[2] = z.f4[0]; x.f4[3] = w.f4[0];
	y.f4[0] = x1;      y.f4[2] = z.f4[1]; y.f4[3] = w.f4[1];
	z.f4[0] = x2;      z.f4[1] = y2;      z.f4[3] = w.f4[2];
	w.f4[0] = x3;      w.f4[1] = y3;      w.f4[2] = z3;
}

inline int allEqual( const Scalar4f& v0, const Scalar4f& v1 )
{
	return v0.f4[0] == v1.f4[0] && v0.f4[1] == v1.f4[1] && 
		v0.f4[2] == v1.f4[2] && v0.f4[3] == v1.f4[3];
}

inline int allEqual( const Scalar4f& v0, const Scalar4f& v1, Scalar4f& outMask )
{
	bool b0 = v0.f4[0] == v1.f4[0], b1 = v0.f4[1] == v1.f4[1],
		b2 = v0.f4[2] == v1.f4[2], b3 = v0.f4[3] == v1.f4[3];
