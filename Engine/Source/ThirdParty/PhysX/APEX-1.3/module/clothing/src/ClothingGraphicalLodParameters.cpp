...
const char* const ClothingGraphicalLodParametersFactory::vptr =
    NxParameterized::getVptr<ClothingGraphicalLodParameters, ClothingGraphicalLodParameters::ClassAlignment>();
...
NxParameterized::MutexType ClothingGraphicalLodParameters::mBuiltFlagMutex;

ClothingGraphicalLodParameters::ClothingGraphicalLodParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingGraphicalLodParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingGraphicalLodParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingGraphicalLodParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
