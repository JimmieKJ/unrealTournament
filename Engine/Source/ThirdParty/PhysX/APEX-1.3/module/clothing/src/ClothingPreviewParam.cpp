...
const char* const ClothingPreviewParamFactory::vptr =
    NxParameterized::getVptr<ClothingPreviewParam, ClothingPreviewParam::ClassAlignment>();
...
NxParameterized::MutexType ClothingPreviewParam::mBuiltFlagMutex;

ClothingPreviewParam::ClothingPreviewParam(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingPreviewParam::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPreviewParam::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingPreviewParam::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPreviewParam::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPreviewParam::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
