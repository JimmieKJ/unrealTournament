...
const char* const ClothingActorParamFactory::vptr =
    NxParameterized::getVptr<ClothingActorParam, ClothingActorParam::ClassAlignment>();
...
NxParameterized::MutexType ClothingActorParam::mBuiltFlagMutex;

ClothingActorParam::ClothingActorParam(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingActorParam::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingActorParam::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
