...
const char* const ClothingCookedPhysX3ParamFactory::vptr =
    NxParameterized::getVptr<ClothingCookedPhysX3Param, ClothingCookedPhysX3Param::ClassAlignment>();
...
NxParameterized::MutexType ClothingCookedPhysX3Param::mBuiltFlagMutex;

ClothingCookedPhysX3Param::ClothingCookedPhysX3Param(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingCookedPhysX3Param::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
