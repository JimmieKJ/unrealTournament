...
const char* const ClothingModuleParametersFactory::vptr =
    NxParameterized::getVptr<ClothingModuleParameters, ClothingModuleParameters::ClassAlignment>();
...
NxParameterized::MutexType ClothingModuleParameters::mBuiltFlagMutex;

ClothingModuleParameters::ClothingModuleParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingModuleParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingModuleParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingModuleParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingModuleParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingModuleParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingModuleParameters::initDefaults(void)
{
	...
	freeReferences();
	freeDynamicArrays();
	maxNumCompartments = physx::PxU32(4);
	maxUnusedPhysXResources = physx::PxU32(5);
	allowAsyncCooking = bool(true);
	asyncFetchResults = bool(true);
	avgSimFrequencyWindow = physx::PxU32(60);
	allowApexWorkBetweenSubsteps = bool(false);
	interCollisionDistance = physx::PxF32(0.0);
	interCollisionStiffness = physx::PxF32(1.0);
	interCollisionIterations = physx::PxU32(1);
	sparseSelfCollision = bool(false);
	maxTimeRenderProxyInPool = physx::PxU32(100);
