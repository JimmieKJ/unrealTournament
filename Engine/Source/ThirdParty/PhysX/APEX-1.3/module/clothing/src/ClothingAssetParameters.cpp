...
const char* const ClothingAssetParametersFactory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters, ClothingAssetParameters::ClassAlignment>();
...
NxParameterized::MutexType ClothingAssetParameters::mBuiltFlagMutex;

ClothingAssetParameters::ClothingAssetParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingAssetParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
