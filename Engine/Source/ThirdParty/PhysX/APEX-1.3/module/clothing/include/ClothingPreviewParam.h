...
static const physx::PxU32 checksum[] = { 0x614ffe9f, 0x273131aa, 0xa5bdd27c, 0xfe7fba5b, };

} // namespace ClothingPreviewParamNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingPreviewParam : public NxParameterized::NxParameters, public ClothingPreviewParamNS::ParametersStruct
{
public:
	ClothingPreviewParam(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingPreviewParamFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingPreviewParam::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPreviewParam");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingPreviewParam)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingPreviewParam)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingPreviewParam::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingPreviewParam::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPreviewParam");
			return 0;
		}
