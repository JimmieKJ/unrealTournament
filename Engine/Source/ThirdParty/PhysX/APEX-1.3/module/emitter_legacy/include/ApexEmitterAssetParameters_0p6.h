...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ApexEmitterAssetParameters_0p6 : public NxParameterized::NxParameters, public ApexEmitterAssetParameters_0p6NS::ParametersStruct
{
public:
	ApexEmitterAssetParameters_0p6(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ApexEmitterAssetParameters_0p6Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ApexEmitterAssetParameters_0p6::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ApexEmitterAssetParameters_0p6");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ApexEmitterAssetParameters_0p6)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ApexEmitterAssetParameters_0p6)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ApexEmitterAssetParameters_0p6::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ApexEmitterAssetParameters_0p6::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ApexEmitterAssetParameters_0p6");
			return 0;
		}
