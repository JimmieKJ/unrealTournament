...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EmitterGeomSphereShellParams_0p1 : public NxParameterized::NxParameters, public EmitterGeomSphereShellParams_0p1NS::ParametersStruct
{
public:
	EmitterGeomSphereShellParams_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EmitterGeomSphereShellParams_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EmitterGeomSphereShellParams_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterGeomSphereShellParams_0p1");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, EmitterGeomSphereShellParams_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EmitterGeomSphereShellParams_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EmitterGeomSphereShellParams_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterGeomSphereShellParams_0p1");
			return 0;
		}
