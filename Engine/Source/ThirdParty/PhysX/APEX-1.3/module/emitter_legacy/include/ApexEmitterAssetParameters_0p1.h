...
static const physx::PxU32 checksum[] = { 0x2f2cb691, 0x5b4330a5, 0x00f9325f, 0x44b4fdae, };

} // namespace ApexEmitterAssetParameters_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ApexEmitterAssetParameters_0p1 : public NxParameterized::NxParameters, public ApexEmitterAssetParameters_0p1NS::ParametersStruct
{
public:
	ApexEmitterAssetParameters_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ApexEmitterAssetParameters_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ApexEmitterAssetParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ApexEmitterAssetParameters_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ApexEmitterAssetParameters_0p1)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ApexEmitterAssetParameters_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ApexEmitterAssetParameters_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ApexEmitterAssetParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ApexEmitterAssetParameters_0p1");
			return 0;
		}
