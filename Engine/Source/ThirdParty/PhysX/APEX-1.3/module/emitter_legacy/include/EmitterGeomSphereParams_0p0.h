...
static const physx::PxU32 checksum[] = { 0x099589b2, 0xbf071475, 0xc3e554df, 0x9c851f5c, };

} // namespace EmitterGeomSphereParams_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EmitterGeomSphereParams_0p0 : public NxParameterized::NxParameters, public EmitterGeomSphereParams_0p0NS::ParametersStruct
{
public:
	EmitterGeomSphereParams_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EmitterGeomSphereParams_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EmitterGeomSphereParams_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterGeomSphereParams_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(EmitterGeomSphereParams_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, EmitterGeomSphereParams_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EmitterGeomSphereParams_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EmitterGeomSphereParams_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterGeomSphereParams_0p0");
			return 0;
		}
