...
const char* const ApexEmitterAssetParameters_0p2Factory::vptr =
    NxParameterized::getVptr<ApexEmitterAssetParameters_0p2, ApexEmitterAssetParameters_0p2::ClassAlignment>();
...
NxParameterized::MutexType ApexEmitterAssetParameters_0p2::mBuiltFlagMutex;

ApexEmitterAssetParameters_0p2::ApexEmitterAssetParameters_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ApexEmitterAssetParameters_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ApexEmitterAssetParameters_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ApexEmitterAssetParameters_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ApexEmitterAssetParameters_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ApexEmitterAssetParameters_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
