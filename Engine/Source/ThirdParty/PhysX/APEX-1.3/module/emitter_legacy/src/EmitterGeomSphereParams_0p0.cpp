...
const char* const EmitterGeomSphereParams_0p0Factory::vptr =
    NxParameterized::getVptr<EmitterGeomSphereParams_0p0, EmitterGeomSphereParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType EmitterGeomSphereParams_0p0::mBuiltFlagMutex;

EmitterGeomSphereParams_0p0::EmitterGeomSphereParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EmitterGeomSphereParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EmitterGeomSphereParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EmitterGeomSphereParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EmitterGeomSphereParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EmitterGeomSphereParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
