...
const char* const EmitterGeomSphereShellParams_0p0Factory::vptr =
    NxParameterized::getVptr<EmitterGeomSphereShellParams_0p0, EmitterGeomSphereShellParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType EmitterGeomSphereShellParams_0p0::mBuiltFlagMutex;

EmitterGeomSphereShellParams_0p0::EmitterGeomSphereShellParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EmitterGeomSphereShellParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EmitterGeomSphereShellParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EmitterGeomSphereShellParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EmitterGeomSphereShellParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EmitterGeomSphereShellParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
