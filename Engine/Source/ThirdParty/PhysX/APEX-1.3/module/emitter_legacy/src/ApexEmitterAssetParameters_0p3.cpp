...
const char* const ApexEmitterAssetParameters_0p3Factory::vptr =
    NxParameterized::getVptr<ApexEmitterAssetParameters_0p3, ApexEmitterAssetParameters_0p3::ClassAlignment>();
...
NxParameterized::MutexType ApexEmitterAssetParameters_0p3::mBuiltFlagMutex;

ApexEmitterAssetParameters_0p3::ApexEmitterAssetParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ApexEmitterAssetParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ApexEmitterAssetParameters_0p3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ApexEmitterAssetParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ApexEmitterAssetParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ApexEmitterAssetParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
