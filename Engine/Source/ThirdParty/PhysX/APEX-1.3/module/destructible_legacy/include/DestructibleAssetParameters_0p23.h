...
static const physx::PxU32 checksum[] = { 0x23366b01, 0x536b5be2, 0x10f1c105, 0x9aefafa9, };

} // namespace DestructibleAssetParameters_0p23NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p23 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p23NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p23(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class DestructibleAssetParameters_0p23Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p23::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p23");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p23)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p23::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p23::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p23");
			return 0;
		}
