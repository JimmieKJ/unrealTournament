...
#ifndef HEADER_DestructibleAssetParameters_0p3_h
#define HEADER_DestructibleAssetParameters_0p3_h
...
namespace DestructibleAssetParameters_0p3NS
{
...
static const physx::PxU32 checksum[] = { 0xa0659145, 0x7c7853ec, 0x5925b84a, 0xe016e03b, };

} // namespace DestructibleAssetParameters_0p3NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p3 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p3NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p3(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p3();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p3NS::checksum);
	...
	const DestructibleAssetParameters_0p3NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p3* tmpThis = const_cast<DestructibleAssetParameters_0p3*>(this);
		return *(static_cast<DestructibleAssetParameters_0p3NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p3NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p3NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p3Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p3), DestructibleAssetParameters_0p3::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p3");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p3)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p3)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p3::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p3");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p3 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p3*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p3::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p3::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p3::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p3::staticChecksum(bits));
	}
};
