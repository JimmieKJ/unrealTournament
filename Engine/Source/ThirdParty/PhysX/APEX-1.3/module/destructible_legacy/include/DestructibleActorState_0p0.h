...
#ifndef HEADER_DestructibleActorState_0p0_h
#define HEADER_DestructibleActorState_0p0_h
...
namespace DestructibleActorState_0p0NS
{
...
static const physx::PxU32 checksum[] = { 0x531aca30, 0xee1057d7, 0x30a2ad2f, 0xae006f8e, };

} // namespace DestructibleActorState_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorState_0p0 : public NxParameterized::NxParameters, public DestructibleActorState_0p0NS::ParametersStruct
{
public:
	DestructibleActorState_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorState_0p0();
	...
	{
		bits = 8 * sizeof(DestructibleActorState_0p0NS::checksum);
		return DestructibleActorState_0p0NS::checksum;
	}
	...
	const DestructibleActorState_0p0NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorState_0p0* tmpThis = const_cast<DestructibleActorState_0p0*>(this);
		return *(static_cast<DestructibleActorState_0p0NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorState_0p0NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorState_0p0NS::ParametersStruct*>(this));
	}
...
class DestructibleActorState_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorState_0p0), DestructibleActorState_0p0::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorState_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorState_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorState_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorState_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorState_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorState_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorState_0p0");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorState_0p0 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorState_0p0*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorState_0p0::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorState_0p0::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorState_0p0::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorState_0p0::staticChecksum(bits));
	}
};
