...
#ifndef HEADER_DestructibleActorParam_0p0_h
#define HEADER_DestructibleActorParam_0p0_h
...
namespace DestructibleActorParam_0p0NS
{
...
static const physx::PxU32 checksum[] = { 0xd4b08535, 0x3442a17d, 0xa9c52df2, 0x56f139da, };

} // namespace DestructibleActorParam_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p0 : public NxParameterized::NxParameters, public DestructibleActorParam_0p0NS::ParametersStruct
{
public:
	DestructibleActorParam_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p0();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p0NS::checksum);
		return DestructibleActorParam_0p0NS::checksum;
	}
	...
	const DestructibleActorParam_0p0NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p0* tmpThis = const_cast<DestructibleActorParam_0p0*>(this);
		return *(static_cast<DestructibleActorParam_0p0NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p0NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p0NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p0), DestructibleActorParam_0p0::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p0");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p0 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p0*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p0::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p0::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p0::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p0::staticChecksum(bits));
	}
};
