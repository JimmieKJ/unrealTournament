...
#ifndef HEADER_DestructibleActorParam_0p6_h
#define HEADER_DestructibleActorParam_0p6_h
...
namespace DestructibleActorParam_0p6NS
{
...
static const physx::PxU32 checksum[] = { 0x66bd8343, 0xed0adc83, 0x8728cbf8, 0xf6c36870, };

} // namespace DestructibleActorParam_0p6NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p6 : public NxParameterized::NxParameters, public DestructibleActorParam_0p6NS::ParametersStruct
{
public:
	DestructibleActorParam_0p6(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p6();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p6NS::checksum);
		return DestructibleActorParam_0p6NS::checksum;
	}
	...
	const DestructibleActorParam_0p6NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p6* tmpThis = const_cast<DestructibleActorParam_0p6*>(this);
		return *(static_cast<DestructibleActorParam_0p6NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p6NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p6NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p6Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p6), DestructibleActorParam_0p6::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p6::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p6");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p6)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p6)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p6::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p6::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p6");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p6 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p6*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p6::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p6::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p6::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p6::staticChecksum(bits));
	}
};
