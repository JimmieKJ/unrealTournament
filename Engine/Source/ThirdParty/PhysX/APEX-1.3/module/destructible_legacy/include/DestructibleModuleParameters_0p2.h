...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleModuleParameters_0p2 : public NxParameterized::NxParameters, public DestructibleModuleParameters_0p2NS::ParametersStruct
{
public:
	DestructibleModuleParameters_0p2(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class DestructibleModuleParameters_0p2Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, DestructibleModuleParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleModuleParameters_0p2");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleModuleParameters_0p2)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleModuleParameters_0p2::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleModuleParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleModuleParameters_0p2");
			return 0;
		}
