...
#ifndef HEADER_DestructibleActorParam_0p17_h
#define HEADER_DestructibleActorParam_0p17_h
...
namespace DestructibleActorParam_0p17NS
{
...
static const physx::PxU32 checksum[] = { 0x0f6b3b48, 0xf9950d84, 0x860f86a3, 0x7373e712, };

} // namespace DestructibleActorParam_0p17NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p17 : public NxParameterized::NxParameters, public DestructibleActorParam_0p17NS::ParametersStruct
{
public:
	DestructibleActorParam_0p17(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p17();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p17NS::checksum);
		return DestructibleActorParam_0p17NS::checksum;
	}
	...
	const DestructibleActorParam_0p17NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p17* tmpThis = const_cast<DestructibleActorParam_0p17*>(this);
		return *(static_cast<DestructibleActorParam_0p17NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p17NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p17NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p17Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p17), DestructibleActorParam_0p17::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p17::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p17");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p17)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p17)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p17::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p17::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p17");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p17 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p17*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p17::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p17::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p17::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p17::staticChecksum(bits));
	}
};
