...
#ifndef HEADER_DestructibleActorParam_0p13_h
#define HEADER_DestructibleActorParam_0p13_h
...
namespace DestructibleActorParam_0p13NS
{
...
static const physx::PxU32 checksum[] = { 0x61491594, 0xc6bbcc7e, 0x465e5e58, 0x1aac70b5, };

} // namespace DestructibleActorParam_0p13NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p13 : public NxParameterized::NxParameters, public DestructibleActorParam_0p13NS::ParametersStruct
{
public:
	DestructibleActorParam_0p13(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p13();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p13NS::checksum);
		return DestructibleActorParam_0p13NS::checksum;
	}
	...
	const DestructibleActorParam_0p13NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p13* tmpThis = const_cast<DestructibleActorParam_0p13*>(this);
		return *(static_cast<DestructibleActorParam_0p13NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p13NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p13NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p13Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p13), DestructibleActorParam_0p13::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p13::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p13");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p13)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p13)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p13::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p13::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p13");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p13 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p13*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p13::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p13::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p13::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p13::staticChecksum(bits));
	}
};
