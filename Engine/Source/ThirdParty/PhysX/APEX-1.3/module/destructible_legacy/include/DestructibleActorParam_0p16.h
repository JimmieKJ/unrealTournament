...
#ifndef HEADER_DestructibleActorParam_0p16_h
#define HEADER_DestructibleActorParam_0p16_h
...
namespace DestructibleActorParam_0p16NS
{
...
static const physx::PxU32 checksum[] = { 0x200aebdd, 0x2a042ee9, 0x8778a11c, 0xfe43f8e4, };

} // namespace DestructibleActorParam_0p16NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p16 : public NxParameterized::NxParameters, public DestructibleActorParam_0p16NS::ParametersStruct
{
public:
	DestructibleActorParam_0p16(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p16();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p16NS::checksum);
		return DestructibleActorParam_0p16NS::checksum;
	}
	...
	const DestructibleActorParam_0p16NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p16* tmpThis = const_cast<DestructibleActorParam_0p16*>(this);
		return *(static_cast<DestructibleActorParam_0p16NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p16NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p16NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p16Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p16), DestructibleActorParam_0p16::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p16::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p16");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p16)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p16)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p16::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p16::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p16");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p16 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p16*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p16::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p16::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p16::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p16::staticChecksum(bits));
	}
};
