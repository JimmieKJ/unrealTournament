...
#ifndef HEADER_DestructibleActorParam_0p14_h
#define HEADER_DestructibleActorParam_0p14_h
...
namespace DestructibleActorParam_0p14NS
{
...
static const physx::PxU32 checksum[] = { 0xb1ba7cab, 0x2d216f2b, 0x80fa1a34, 0xd796c0b0, };

} // namespace DestructibleActorParam_0p14NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p14 : public NxParameterized::NxParameters, public DestructibleActorParam_0p14NS::ParametersStruct
{
public:
	DestructibleActorParam_0p14(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p14();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p14NS::checksum);
		return DestructibleActorParam_0p14NS::checksum;
	}
	...
	const DestructibleActorParam_0p14NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p14* tmpThis = const_cast<DestructibleActorParam_0p14*>(this);
		return *(static_cast<DestructibleActorParam_0p14NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p14NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p14NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p14Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p14), DestructibleActorParam_0p14::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p14::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p14");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p14)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p14)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p14::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p14::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p14");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p14 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p14*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p14::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p14::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p14::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p14::staticChecksum(bits));
	}
};
