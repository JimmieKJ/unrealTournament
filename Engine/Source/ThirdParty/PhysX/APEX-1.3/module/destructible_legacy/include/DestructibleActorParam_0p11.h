...
struct ParametersStruct
{
	...
	physx::PxF32 sleepVelocitySmoothingFactor;
...
static const physx::PxU32 checksum[] = { 0xdd5dd270, 0x74d8996a, 0x63268e74, 0xb3dc6115, };

} // namespace DestructibleActorParam_0p11NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p11 : public NxParameterized::NxParameters, public DestructibleActorParam_0p11NS::ParametersStruct
{
public:
	DestructibleActorParam_0p11(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class DestructibleActorParam_0p11Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p11::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p11");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p11)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p11)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p11::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p11::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p11");
			return 0;
		}
