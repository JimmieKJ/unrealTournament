...
#ifndef HEADER_DestructibleActorParam_0p28_h
#define HEADER_DestructibleActorParam_0p28_h
...
namespace DestructibleActorParam_0p28NS
{
...
static const physx::PxU32 checksum[] = { 0x05dc3ae5, 0x2af4434c, 0xf48d05ee, 0x0a67215b, };

} // namespace DestructibleActorParam_0p28NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p28 : public NxParameterized::NxParameters, public DestructibleActorParam_0p28NS::ParametersStruct
{
public:
	DestructibleActorParam_0p28(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p28();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)28;
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p28NS::checksum);
		return DestructibleActorParam_0p28NS::checksum;
	}
	...
	const DestructibleActorParam_0p28NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p28* tmpThis = const_cast<DestructibleActorParam_0p28*>(this);
		return *(static_cast<DestructibleActorParam_0p28NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p28NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p28NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p28Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p28), DestructibleActorParam_0p28::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p28::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p28");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p28)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p28)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p28::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p28::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p28");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p28 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p28*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p28::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p28::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p28::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p28::staticChecksum(bits));
	}
};
