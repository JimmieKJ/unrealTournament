...
#ifndef HEADER_DestructibleActorParam_0p9_h
#define HEADER_DestructibleActorParam_0p9_h
...
namespace DestructibleActorParam_0p9NS
{
...
static const physx::PxU32 checksum[] = { 0xa5173bb5, 0xce9e156c, 0x762125a2, 0x20d5f8a4, };

} // namespace DestructibleActorParam_0p9NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p9 : public NxParameterized::NxParameters, public DestructibleActorParam_0p9NS::ParametersStruct
{
public:
	DestructibleActorParam_0p9(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p9();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p9NS::checksum);
		return DestructibleActorParam_0p9NS::checksum;
	}
	...
	const DestructibleActorParam_0p9NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p9* tmpThis = const_cast<DestructibleActorParam_0p9*>(this);
		return *(static_cast<DestructibleActorParam_0p9NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p9NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p9NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p9Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p9), DestructibleActorParam_0p9::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p9::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p9");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p9)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p9)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p9::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p9::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p9");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p9 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p9*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p9::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p9::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p9::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p9::staticChecksum(bits));
	}
};
