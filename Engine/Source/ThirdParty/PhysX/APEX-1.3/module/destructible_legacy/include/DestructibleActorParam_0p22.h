...
#ifndef HEADER_DestructibleActorParam_0p22_h
#define HEADER_DestructibleActorParam_0p22_h
...
namespace DestructibleActorParam_0p22NS
{
...
static const physx::PxU32 checksum[] = { 0x5d2a8218, 0x162303c2, 0x230965d3, 0x8f4a9ad3, };

} // namespace DestructibleActorParam_0p22NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p22 : public NxParameterized::NxParameters, public DestructibleActorParam_0p22NS::ParametersStruct
{
public:
	DestructibleActorParam_0p22(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p22();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p22NS::checksum);
		return DestructibleActorParam_0p22NS::checksum;
	}
	...
	const DestructibleActorParam_0p22NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p22* tmpThis = const_cast<DestructibleActorParam_0p22*>(this);
		return *(static_cast<DestructibleActorParam_0p22NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p22NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p22NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p22Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p22), DestructibleActorParam_0p22::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p22::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p22");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p22)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p22)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p22::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p22::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p22");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p22 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p22*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p22::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p22::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p22::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p22::staticChecksum(bits));
	}
};
