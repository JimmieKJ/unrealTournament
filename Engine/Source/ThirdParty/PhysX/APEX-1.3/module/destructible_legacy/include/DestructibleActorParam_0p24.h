...
#ifndef HEADER_DestructibleActorParam_0p24_h
#define HEADER_DestructibleActorParam_0p24_h
...
namespace DestructibleActorParam_0p24NS
{
...
static const physx::PxU32 checksum[] = { 0x12f03764, 0x6a055959, 0xdb7782c7, 0xd6f432b2, };

} // namespace DestructibleActorParam_0p24NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p24 : public NxParameterized::NxParameters, public DestructibleActorParam_0p24NS::ParametersStruct
{
public:
	DestructibleActorParam_0p24(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p24();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p24NS::checksum);
		return DestructibleActorParam_0p24NS::checksum;
	}
	...
	const DestructibleActorParam_0p24NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p24* tmpThis = const_cast<DestructibleActorParam_0p24*>(this);
		return *(static_cast<DestructibleActorParam_0p24NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p24NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p24NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p24Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p24), DestructibleActorParam_0p24::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p24::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p24");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p24)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p24)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p24::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p24::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p24");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p24 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p24*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p24::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p24::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p24::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p24::staticChecksum(bits));
	}
};
