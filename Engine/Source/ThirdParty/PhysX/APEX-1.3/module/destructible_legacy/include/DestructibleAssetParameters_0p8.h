...
#ifndef HEADER_DestructibleAssetParameters_0p8_h
#define HEADER_DestructibleAssetParameters_0p8_h
...
namespace DestructibleAssetParameters_0p8NS
{
...
static const physx::PxU32 checksum[] = { 0xe8a2332d, 0xf757b2db, 0x07eb1ca5, 0x80693529, };

} // namespace DestructibleAssetParameters_0p8NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p8 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p8NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p8(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p8();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p8NS::checksum);
		return DestructibleAssetParameters_0p8NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p8NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p8* tmpThis = const_cast<DestructibleAssetParameters_0p8*>(this);
		return *(static_cast<DestructibleAssetParameters_0p8NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p8NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p8NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p8Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p8), DestructibleAssetParameters_0p8::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p8::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p8");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p8)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p8)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p8::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p8::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p8");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p8 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p8*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p8::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p8::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p8::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p8::staticChecksum(bits));
	}
};
