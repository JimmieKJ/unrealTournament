...
#ifndef HEADER_DestructibleActorParam_0p27_h
#define HEADER_DestructibleActorParam_0p27_h
...
namespace DestructibleActorParam_0p27NS
{
...
static const physx::PxU32 checksum[] = { 0x1401008a, 0x584084b6, 0x4a58beff, 0xbf4018ea, };

} // namespace DestructibleActorParam_0p27NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p27 : public NxParameterized::NxParameters, public DestructibleActorParam_0p27NS::ParametersStruct
{
public:
	DestructibleActorParam_0p27(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p27();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)27;
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p27NS::checksum);
		return DestructibleActorParam_0p27NS::checksum;
	}
	...
	const DestructibleActorParam_0p27NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p27* tmpThis = const_cast<DestructibleActorParam_0p27*>(this);
		return *(static_cast<DestructibleActorParam_0p27NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p27NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p27NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p27Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p27), DestructibleActorParam_0p27::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p27::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p27");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p27)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p27)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p27::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p27::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p27");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p27 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p27*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p27::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p27::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p27::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p27::staticChecksum(bits));
	}
};
