...
#ifndef HEADER_DestructibleAssetParameters_0p24_h
#define HEADER_DestructibleAssetParameters_0p24_h
...
namespace DestructibleAssetParameters_0p24NS
{
...
static const physx::PxU32 checksum[] = { 0x1850e66c, 0xb88dc447, 0x01dfd5c9, 0x4fccef9c, };

} // namespace DestructibleAssetParameters_0p24NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p24 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p24NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p24(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p24();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)24;
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p24NS::checksum);
		return DestructibleAssetParameters_0p24NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p24NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p24* tmpThis = const_cast<DestructibleAssetParameters_0p24*>(this);
		return *(static_cast<DestructibleAssetParameters_0p24NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p24NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p24NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p24Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p24), DestructibleAssetParameters_0p24::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p24::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p24");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p24)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p24)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p24::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p24::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p24");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p24 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p24*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p24::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p24::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p24::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p24::staticChecksum(bits));
	}
};
