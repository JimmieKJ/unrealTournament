...
#ifndef HEADER_DestructibleActorParam_0p10_h
#define HEADER_DestructibleActorParam_0p10_h
...
namespace DestructibleActorParam_0p10NS
{
...
static const physx::PxU32 checksum[] = { 0xbe978f37, 0x502639bf, 0x1719eb6b, 0xded5e239, };

} // namespace DestructibleActorParam_0p10NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p10 : public NxParameterized::NxParameters, public DestructibleActorParam_0p10NS::ParametersStruct
{
public:
	DestructibleActorParam_0p10(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p10();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p10NS::checksum);
		return DestructibleActorParam_0p10NS::checksum;
	}
	...
	const DestructibleActorParam_0p10NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p10* tmpThis = const_cast<DestructibleActorParam_0p10*>(this);
		return *(static_cast<DestructibleActorParam_0p10NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p10NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p10NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p10Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p10), DestructibleActorParam_0p10::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p10::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p10");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p10)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p10)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p10::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p10::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p10");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p10 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p10*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p10::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p10::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p10::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p10::staticChecksum(bits));
	}
};
