...
#ifndef HEADER_DestructibleAssetParameters_0p13_h
...
namespace DestructibleAssetParameters_0p13NS
{
...
static const physx::PxU32 checksum[] = { 0xf6cfcb55, 0x7ca1003a, 0x9133ce4f, 0x3268033e, };

} // namespace DestructibleAssetParameters_0p13NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p13 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p13NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p13(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p13();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p13NS::checksum);
		return DestructibleAssetParameters_0p13NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p13NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p13* tmpThis = const_cast<DestructibleAssetParameters_0p13*>(this);
		return *(static_cast<DestructibleAssetParameters_0p13NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p13NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p13NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p13Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p13), DestructibleAssetParameters_0p13::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p13::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p13");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p13)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p13)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p13::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p13::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p13");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p13 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p13*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p13::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p13::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p13::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p13::staticChecksum(bits));
	}
};
