...
#ifndef HEADER_DestructibleAssetParameters_0p4_h
#define HEADER_DestructibleAssetParameters_0p4_h
...
namespace DestructibleAssetParameters_0p4NS
{
...
static const physx::PxU32 checksum[] = { 0xdbc7d73d, 0x74b66caa, 0x71f94316, 0xf7f9a2be, };

} // namespace DestructibleAssetParameters_0p4NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p4 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p4NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p4();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p4NS::checksum);
		return DestructibleAssetParameters_0p4NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p4NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p4* tmpThis = const_cast<DestructibleAssetParameters_0p4*>(this);
		return *(static_cast<DestructibleAssetParameters_0p4NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p4NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p4NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p4), DestructibleAssetParameters_0p4::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p4");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p4)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p4");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p4 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p4*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p4::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p4::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p4::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p4::staticChecksum(bits));
	}
};
