...
#ifndef HEADER_DestructibleAssetParameters_0p7_h
#define HEADER_DestructibleAssetParameters_0p7_h
...
namespace DestructibleAssetParameters_0p7NS
{
...
static const physx::PxU32 checksum[] = { 0x413f957f, 0x3e6c42e8, 0xa52b14f8, 0xb0466d5c, };

} // namespace DestructibleAssetParameters_0p7NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p7 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p7NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p7(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p7();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p7NS::checksum);
		return DestructibleAssetParameters_0p7NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p7NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p7* tmpThis = const_cast<DestructibleAssetParameters_0p7*>(this);
		return *(static_cast<DestructibleAssetParameters_0p7NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p7NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p7NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p7Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p7), DestructibleAssetParameters_0p7::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p7::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p7");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p7)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p7)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p7::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p7::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p7");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p7 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p7*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p7::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p7::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p7::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p7::staticChecksum(bits));
	}
};
