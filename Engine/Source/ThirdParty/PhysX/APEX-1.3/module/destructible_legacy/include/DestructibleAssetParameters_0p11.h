...
#ifndef HEADER_DestructibleAssetParameters_0p11_h
#define HEADER_DestructibleAssetParameters_0p11_h
...
namespace DestructibleAssetParameters_0p11NS
{
...
static const physx::PxU32 checksum[] = { 0x71b03c11, 0x44ff53cb, 0xe355f2f6, 0xbba1e381, };

} // namespace DestructibleAssetParameters_0p11NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p11 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p11NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p11(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p11();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)11;
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p11NS::checksum);
	...
	const DestructibleAssetParameters_0p11NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p11* tmpThis = const_cast<DestructibleAssetParameters_0p11*>(this);
		return *(static_cast<DestructibleAssetParameters_0p11NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p11NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p11NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p11Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p11), DestructibleAssetParameters_0p11::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p11::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p11");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p11)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p11)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p11::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p11::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p11");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p11 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p11*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p11::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p11::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p11::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p11::staticChecksum(bits));
	}
};
