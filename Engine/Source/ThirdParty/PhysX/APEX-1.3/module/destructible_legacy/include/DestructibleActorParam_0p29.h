...
#ifndef HEADER_DestructibleActorParam_0p29_h
#define HEADER_DestructibleActorParam_0p29_h
...
namespace DestructibleActorParam_0p29NS
{
...
static const physx::PxU32 checksum[] = { 0xe5587c94, 0x690bed50, 0x7ac92918, 0xa6fd441e, };

} // namespace DestructibleActorParam_0p29NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p29 : public NxParameterized::NxParameters, public DestructibleActorParam_0p29NS::ParametersStruct
{
public:
	DestructibleActorParam_0p29(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p29();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)29;
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p29NS::checksum);
		return DestructibleActorParam_0p29NS::checksum;
	}
	...
	const DestructibleActorParam_0p29NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p29* tmpThis = const_cast<DestructibleActorParam_0p29*>(this);
		return *(static_cast<DestructibleActorParam_0p29NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p29NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p29NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p29Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p29), DestructibleActorParam_0p29::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p29::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p29");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p29)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p29)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p29::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p29::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p29");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p29 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p29*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p29::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p29::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p29::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p29::staticChecksum(bits));
	}
};
