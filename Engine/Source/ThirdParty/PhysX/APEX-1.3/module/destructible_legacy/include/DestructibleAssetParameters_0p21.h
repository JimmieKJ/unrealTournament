...
#ifndef HEADER_DestructibleAssetParameters_0p21_h
#define HEADER_DestructibleAssetParameters_0p21_h
...
namespace DestructibleAssetParameters_0p21NS
{
...
struct Chunk_Type
{
	...
	physx::PxU16 firstScatterMesh;
	physx::PxU16 scatterMeshCount;
};
struct ActorDescFlags_Type
{
...
static const physx::PxU32 checksum[] = { 0x77041176, 0x2d446a05, 0xc794c6d6, 0x41b8ccbd, };

} // namespace DestructibleAssetParameters_0p21NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p21 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p21NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p21(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p21();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)21;
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p21NS::checksum);
		return DestructibleAssetParameters_0p21NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p21NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p21* tmpThis = const_cast<DestructibleAssetParameters_0p21*>(this);
		return *(static_cast<DestructibleAssetParameters_0p21NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p21NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p21NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p21Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p21), DestructibleAssetParameters_0p21::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p21::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p21");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p21)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p21)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p21::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p21::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p21");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p21 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p21*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p21::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p21::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p21::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p21::staticChecksum(bits));
	}
};
