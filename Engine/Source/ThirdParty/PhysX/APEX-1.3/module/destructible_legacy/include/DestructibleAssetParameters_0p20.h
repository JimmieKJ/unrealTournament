...
#ifndef HEADER_DestructibleAssetParameters_0p20_h
...
namespace DestructibleAssetParameters_0p20NS
{
...
static const physx::PxU32 checksum[] = { 0x5b26de1a, 0x32420a3c, 0x92dc08b2, 0x4f9aac6c, };

} // namespace DestructibleAssetParameters_0p20NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p20 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p20NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p20(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p20();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)20;
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p20NS::checksum);
		return DestructibleAssetParameters_0p20NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p20NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p20* tmpThis = const_cast<DestructibleAssetParameters_0p20*>(this);
		return *(static_cast<DestructibleAssetParameters_0p20NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p20NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p20NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p20Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p20), DestructibleAssetParameters_0p20::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p20::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p20");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p20)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p20)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p20::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p20::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p20");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p20 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p20*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p20::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p20::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p20::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p20::staticChecksum(bits));
	}
};
