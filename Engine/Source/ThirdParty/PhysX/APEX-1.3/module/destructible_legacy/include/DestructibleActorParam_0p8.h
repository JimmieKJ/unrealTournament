...
#ifndef HEADER_DestructibleActorParam_0p8_h
#define HEADER_DestructibleActorParam_0p8_h
...
namespace DestructibleActorParam_0p8NS
{
...
static const physx::PxU32 checksum[] = { 0xd51fd85d, 0x75255e3b, 0x5caf5452, 0x7cc72a14, };

} // namespace DestructibleActorParam_0p8NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p8 : public NxParameterized::NxParameters, public DestructibleActorParam_0p8NS::ParametersStruct
{
public:
	DestructibleActorParam_0p8(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p8();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p8NS::checksum);
		return DestructibleActorParam_0p8NS::checksum;
	}
	...
	const DestructibleActorParam_0p8NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p8* tmpThis = const_cast<DestructibleActorParam_0p8*>(this);
		return *(static_cast<DestructibleActorParam_0p8NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p8NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p8NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p8Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p8), DestructibleActorParam_0p8::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p8::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p8");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p8)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p8)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p8::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p8::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p8");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p8 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p8*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p8::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p8::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p8::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p8::staticChecksum(bits));
	}
};
