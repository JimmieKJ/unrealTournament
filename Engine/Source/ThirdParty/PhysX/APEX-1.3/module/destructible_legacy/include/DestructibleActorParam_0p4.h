...
#ifndef HEADER_DestructibleActorParam_0p4_h
#define HEADER_DestructibleActorParam_0p4_h
...
namespace DestructibleActorParam_0p4NS
{
...
static const physx::PxU32 checksum[] = { 0x9a70837f, 0xfa71b6aa, 0x939a9985, 0xb53b11ec, };

} // namespace DestructibleActorParam_0p4NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p4 : public NxParameterized::NxParameters, public DestructibleActorParam_0p4NS::ParametersStruct
{
public:
	DestructibleActorParam_0p4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p4();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p4NS::checksum);
		return DestructibleActorParam_0p4NS::checksum;
	}
	...
	const DestructibleActorParam_0p4NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p4* tmpThis = const_cast<DestructibleActorParam_0p4*>(this);
		return *(static_cast<DestructibleActorParam_0p4NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p4NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p4NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p4), DestructibleActorParam_0p4::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p4");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p4)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p4");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p4 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p4*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p4::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p4::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p4::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p4::staticChecksum(bits));
	}
};
