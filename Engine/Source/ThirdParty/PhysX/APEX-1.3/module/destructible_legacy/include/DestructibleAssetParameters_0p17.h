...
#ifndef HEADER_DestructibleAssetParameters_0p17_h
#define HEADER_DestructibleAssetParameters_0p17_h
...
namespace DestructibleAssetParameters_0p17NS
{
...
static const physx::PxU32 checksum[] = { 0xba335223, 0x3f1fce17, 0x52b089db, 0x03236282, };

} // namespace DestructibleAssetParameters_0p17NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p17 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p17NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p17(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p17();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)17;
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p17NS::checksum);
		return DestructibleAssetParameters_0p17NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p17NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p17* tmpThis = const_cast<DestructibleAssetParameters_0p17*>(this);
		return *(static_cast<DestructibleAssetParameters_0p17NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p17NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p17NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p17Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p17), DestructibleAssetParameters_0p17::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p17::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p17");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p17)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p17)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p17::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p17::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p17");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p17 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p17*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p17::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p17::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p17::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p17::staticChecksum(bits));
	}
};
