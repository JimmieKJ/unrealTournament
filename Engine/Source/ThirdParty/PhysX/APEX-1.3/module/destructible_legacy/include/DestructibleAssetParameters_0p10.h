...
#ifndef HEADER_DestructibleAssetParameters_0p10_h
...
namespace DestructibleAssetParameters_0p10NS
{
...
static const physx::PxU32 checksum[] = { 0xed9b0702, 0x552412c3, 0x3dffc236, 0xde7cd7c8, };

} // namespace DestructibleAssetParameters_0p10NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p10 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p10NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p10(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p10();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p10NS::checksum);
		return DestructibleAssetParameters_0p10NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p10NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p10* tmpThis = const_cast<DestructibleAssetParameters_0p10*>(this);
		return *(static_cast<DestructibleAssetParameters_0p10NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p10NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p10NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p10Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p10), DestructibleAssetParameters_0p10::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p10::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p10");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p10)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p10)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p10::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p10::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p10");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p10 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p10*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p10::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p10::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p10::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p10::staticChecksum(bits));
	}
};
