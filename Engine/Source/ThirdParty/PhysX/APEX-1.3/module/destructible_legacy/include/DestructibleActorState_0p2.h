...
#ifndef HEADER_DestructibleActorState_0p2_h
#define HEADER_DestructibleActorState_0p2_h
...
namespace DestructibleActorState_0p2NS
{
...
static const physx::PxU32 checksum[] = { 0x6e71d0c6, 0x94af2f1d, 0x37ac87d3, 0xc9970214, };

} // namespace DestructibleActorState_0p2NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorState_0p2 : public NxParameterized::NxParameters, public DestructibleActorState_0p2NS::ParametersStruct
{
public:
	DestructibleActorState_0p2(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorState_0p2();
	...
	{
		bits = 8 * sizeof(DestructibleActorState_0p2NS::checksum);
		return DestructibleActorState_0p2NS::checksum;
	}
	...
	const DestructibleActorState_0p2NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorState_0p2* tmpThis = const_cast<DestructibleActorState_0p2*>(this);
		return *(static_cast<DestructibleActorState_0p2NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorState_0p2NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorState_0p2NS::ParametersStruct*>(this));
	}
...
class DestructibleActorState_0p2Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorState_0p2), DestructibleActorState_0p2::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorState_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorState_0p2");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorState_0p2)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorState_0p2)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorState_0p2::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorState_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorState_0p2");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorState_0p2 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorState_0p2*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorState_0p2::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorState_0p2::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorState_0p2::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorState_0p2::staticChecksum(bits));
	}
};
