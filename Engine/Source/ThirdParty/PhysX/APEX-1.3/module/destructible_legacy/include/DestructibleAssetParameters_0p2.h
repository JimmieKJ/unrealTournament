...
#ifndef HEADER_DestructibleAssetParameters_0p2_h
#define HEADER_DestructibleAssetParameters_0p2_h
...
namespace DestructibleAssetParameters_0p2NS
{
...
static const physx::PxU32 checksum[] = { 0x82d197c5, 0x1d6d15b6, 0x620e886e, 0x3682b492, };

} // namespace DestructibleAssetParameters_0p2NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p2 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p2NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p2(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p2();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p2NS::checksum);
		return DestructibleAssetParameters_0p2NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p2NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p2* tmpThis = const_cast<DestructibleAssetParameters_0p2*>(this);
		return *(static_cast<DestructibleAssetParameters_0p2NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p2NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p2NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p2Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p2), DestructibleAssetParameters_0p2::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p2");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p2)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p2)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p2::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p2");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p2 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p2*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p2::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p2::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p2::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p2::staticChecksum(bits));
	}
};
