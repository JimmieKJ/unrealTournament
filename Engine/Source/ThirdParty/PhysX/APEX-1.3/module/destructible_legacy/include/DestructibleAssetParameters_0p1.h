...
#ifndef HEADER_DestructibleAssetParameters_0p1_h
#define HEADER_DestructibleAssetParameters_0p1_h
...
namespace DestructibleAssetParameters_0p1NS
{
...
static const physx::PxU32 checksum[] = { 0x2486dde1, 0x2298a3d7, 0x0ce27ce1, 0x2c97bc7d, };

} // namespace DestructibleAssetParameters_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p1 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p1NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p1();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p1NS::checksum);
		return DestructibleAssetParameters_0p1NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p1NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p1* tmpThis = const_cast<DestructibleAssetParameters_0p1*>(this);
		return *(static_cast<DestructibleAssetParameters_0p1NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p1NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p1NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p1), DestructibleAssetParameters_0p1::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p1)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p1");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p1 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p1*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p1::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p1::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p1::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p1::staticChecksum(bits));
	}
};
