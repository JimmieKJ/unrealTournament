...
#ifndef HEADER_DestructibleActorParam_0p30_h
#define HEADER_DestructibleActorParam_0p30_h
...
namespace DestructibleActorParam_0p30NS
{
...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p30 : public NxParameterized::NxParameters, public DestructibleActorParam_0p30NS::ParametersStruct
{
public:
	DestructibleActorParam_0p30(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p30();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p30NS::checksum);
	...
	const DestructibleActorParam_0p30NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p30* tmpThis = const_cast<DestructibleActorParam_0p30*>(this);
		return *(static_cast<DestructibleActorParam_0p30NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p30NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p30NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p30Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p30), DestructibleActorParam_0p30::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p30::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p30");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p30)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p30)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p30::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p30::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p30");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p30 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p30*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p30::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p30::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p30::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p30::staticChecksum(bits));
	}
};
