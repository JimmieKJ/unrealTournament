...
#ifndef HEADER_DestructibleActorParam_0p2_h
#define HEADER_DestructibleActorParam_0p2_h
...
namespace DestructibleActorParam_0p2NS
{
...
static const physx::PxU32 checksum[] = { 0x6c437fe3, 0x3032d3f2, 0xf24de685, 0x6c9d9517, };

} // namespace DestructibleActorParam_0p2NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p2 : public NxParameterized::NxParameters, public DestructibleActorParam_0p2NS::ParametersStruct
{
public:
	DestructibleActorParam_0p2(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p2();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p2NS::checksum);
		return DestructibleActorParam_0p2NS::checksum;
	}
	...
	const DestructibleActorParam_0p2NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p2* tmpThis = const_cast<DestructibleActorParam_0p2*>(this);
		return *(static_cast<DestructibleActorParam_0p2NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p2NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p2NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p2Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p2), DestructibleActorParam_0p2::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p2");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p2)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p2)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p2::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p2");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p2 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p2*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p2::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p2::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p2::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p2::staticChecksum(bits));
	}
};
