...
#ifndef HEADER_DestructibleAssetParameters_0p14_h
#define HEADER_DestructibleAssetParameters_0p14_h
...
namespace DestructibleAssetParameters_0p14NS
{
...
static const physx::PxU32 checksum[] = { 0x0b98015c, 0x926d82d2, 0x34a14a73, 0x19363b21, };

} // namespace DestructibleAssetParameters_0p14NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p14 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p14NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p14(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p14();
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p14NS::checksum);
		return DestructibleAssetParameters_0p14NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p14NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p14* tmpThis = const_cast<DestructibleAssetParameters_0p14*>(this);
		return *(static_cast<DestructibleAssetParameters_0p14NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p14NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p14NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p14Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p14), DestructibleAssetParameters_0p14::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p14::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p14");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p14)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p14)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p14::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p14::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p14");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p14 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p14*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p14::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p14::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p14::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p14::staticChecksum(bits));
	}
};
