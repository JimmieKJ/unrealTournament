...
#ifndef HEADER_DestructibleAssetParameters_0p15_h
#define HEADER_DestructibleAssetParameters_0p15_h
...
namespace DestructibleAssetParameters_0p15NS
{
...
struct BehaviorGroup_Type
{
	...
	physx::PxF32 minimumDamageRadius;
	physx::PxF32 damageRadiusMultiplier;
	physx::PxF32 damageFalloffExponent;
...
static const physx::PxU32 checksum[] = { 0x6ed3c943, 0x51e5ef25, 0xb38b4cf4, 0x4f8e506e, };

} // namespace DestructibleAssetParameters_0p15NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleAssetParameters_0p15 : public NxParameterized::NxParameters, public DestructibleAssetParameters_0p15NS::ParametersStruct
{
public:
	DestructibleAssetParameters_0p15(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleAssetParameters_0p15();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)15;
	...
	{
		bits = 8 * sizeof(DestructibleAssetParameters_0p15NS::checksum);
		return DestructibleAssetParameters_0p15NS::checksum;
	}
	...
	const DestructibleAssetParameters_0p15NS::ParametersStruct& parameters(void) const
	{
		DestructibleAssetParameters_0p15* tmpThis = const_cast<DestructibleAssetParameters_0p15*>(this);
		return *(static_cast<DestructibleAssetParameters_0p15NS::ParametersStruct*>(tmpThis));
	}

	DestructibleAssetParameters_0p15NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleAssetParameters_0p15NS::ParametersStruct*>(this));
	}
...
class DestructibleAssetParameters_0p15Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleAssetParameters_0p15), DestructibleAssetParameters_0p15::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleAssetParameters_0p15::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p15");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleAssetParameters_0p15)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleAssetParameters_0p15)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleAssetParameters_0p15::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleAssetParameters_0p15::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleAssetParameters_0p15");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleAssetParameters_0p15 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleAssetParameters_0p15*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleAssetParameters_0p15::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleAssetParameters_0p15::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleAssetParameters_0p15::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleAssetParameters_0p15::staticChecksum(bits));
	}
};
