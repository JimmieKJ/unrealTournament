...
#ifndef HEADER_DestructibleActorParam_0p25_h
#define HEADER_DestructibleActorParam_0p25_h
...
namespace DestructibleActorParam_0p25NS
{
...
static const physx::PxU32 checksum[] = { 0xd9bc5e44, 0x46845bcb, 0x9290fe16, 0x5b7dbd03, };

} // namespace DestructibleActorParam_0p25NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p25 : public NxParameterized::NxParameters, public DestructibleActorParam_0p25NS::ParametersStruct
{
public:
	DestructibleActorParam_0p25(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p25();
	...
	static const physx::PxU32 ClassVersion = ((physx::PxU32)0 << 16) + (physx::PxU32)25;
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p25NS::checksum);
		return DestructibleActorParam_0p25NS::checksum;
	}
	...
	const DestructibleActorParam_0p25NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p25* tmpThis = const_cast<DestructibleActorParam_0p25*>(this);
		return *(static_cast<DestructibleActorParam_0p25NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p25NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p25NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p25Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p25), DestructibleActorParam_0p25::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p25::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p25");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p25)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p25)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p25::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p25::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p25");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p25 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p25*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p25::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p25::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p25::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p25::staticChecksum(bits));
	}
};
