...
#ifndef HEADER_DestructibleActorParam_0p15_h
#define HEADER_DestructibleActorParam_0p15_h
...
namespace DestructibleActorParam_0p15NS
{
...
static const physx::PxU32 checksum[] = { 0x78c8fde9, 0x751632a2, 0x8b1f93be, 0xace8e25b, };

} // namespace DestructibleActorParam_0p15NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p15 : public NxParameterized::NxParameters, public DestructibleActorParam_0p15NS::ParametersStruct
{
public:
	DestructibleActorParam_0p15(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p15();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p15NS::checksum);
		return DestructibleActorParam_0p15NS::checksum;
	}
	...
	const DestructibleActorParam_0p15NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p15* tmpThis = const_cast<DestructibleActorParam_0p15*>(this);
		return *(static_cast<DestructibleActorParam_0p15NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p15NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p15NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p15Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p15), DestructibleActorParam_0p15::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p15::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p15");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p15)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p15)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p15::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p15::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p15");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p15 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p15*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p15::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p15::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p15::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p15::staticChecksum(bits));
	}
};
