...
#ifndef HEADER_DestructibleActorParam_0p21_h
#define HEADER_DestructibleActorParam_0p21_h
...
namespace DestructibleActorParam_0p21NS
{
...
static const physx::PxU32 checksum[] = { 0xb123fb7a, 0xec9ad0ae, 0x50f992cf, 0xb7c21c7e, };

} // namespace DestructibleActorParam_0p21NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorParam_0p21 : public NxParameterized::NxParameters, public DestructibleActorParam_0p21NS::ParametersStruct
{
public:
	DestructibleActorParam_0p21(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~DestructibleActorParam_0p21();
	...
	{
		bits = 8 * sizeof(DestructibleActorParam_0p21NS::checksum);
		return DestructibleActorParam_0p21NS::checksum;
	}
	...
	const DestructibleActorParam_0p21NS::ParametersStruct& parameters(void) const
	{
		DestructibleActorParam_0p21* tmpThis = const_cast<DestructibleActorParam_0p21*>(this);
		return *(static_cast<DestructibleActorParam_0p21NS::ParametersStruct*>(tmpThis));
	}

	DestructibleActorParam_0p21NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<DestructibleActorParam_0p21NS::ParametersStruct*>(this));
	}
...
class DestructibleActorParam_0p21Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(DestructibleActorParam_0p21), DestructibleActorParam_0p21::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorParam_0p21::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p21");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorParam_0p21)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorParam_0p21)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorParam_0p21::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorParam_0p21::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorParam_0p21");
			return 0;
		}
		...
		// We used to call empty constructor of DestructibleActorParam_0p21 here
		...
		*(const char**)bufObj = vptr;
		...
		return (DestructibleActorParam_0p21*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (DestructibleActorParam_0p21::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (DestructibleActorParam_0p21::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (DestructibleActorParam_0p21::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (DestructibleActorParam_0p21::staticChecksum(bits));
	}
};
