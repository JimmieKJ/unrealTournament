...
const char* const DestructibleAssetParameters_0p18Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p18, DestructibleAssetParameters_0p18::ClassAlignment>();

const physx::PxU32 NumParamDefs = 121;
...
NxParameterized::MutexType DestructibleAssetParameters_0p18::mBuiltFlagMutex;

DestructibleAssetParameters_0p18::DestructibleAssetParameters_0p18(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p18::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p18::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p18::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p18::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p18::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleAssetParameters_0p18::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=51, longName="chunkConvexHulls"
	{
		...
		ParamDefTable[51].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=101, longName="renderMeshAsset"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[101].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[101].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=111, longName="overlapsAtDepth"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[111].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[111].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=112, longName="overlapsAtDepth[]"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[112].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		HintTable[1].init("longDescription", "The chunk overlaps (adjacencies) at each depth of the hierarchy.", true);
		HintTable[2].init("shortDescription", "The chunk overlaps at each depth of the hierarchy", true);
		ParamDefTable[112].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
