...
using namespace DestructibleActorParam_0p6NS;

const char* const DestructibleActorParam_0p6Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p6, DestructibleActorParam_0p6::ClassAlignment>();
...
bool DestructibleActorParam_0p6::mBuiltFlag = false;
NxParameterized::MutexType DestructibleActorParam_0p6::mBuiltFlagMutex;

DestructibleActorParam_0p6::DestructibleActorParam_0p6(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleActorParam_0p6FactoryInst);
...
DestructibleActorParam_0p6::~DestructibleActorParam_0p6()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void DestructibleActorParam_0p6::destroy()
{
	...
	this->~DestructibleActorParam_0p6();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* DestructibleActorParam_0p6::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p6::getParameterDefinitionTree(void) const
{
	DestructibleActorParam_0p6* tmpParam = const_cast<DestructibleActorParam_0p6*>(this);
...
NxParameterized::ErrorType DestructibleActorParam_0p6::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p6::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p6::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleActorParam_0p6::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleActorParam_0p6::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p6::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=157, longName="p3ShapeDescTemplate.material"
	{
...
void DestructibleActorParam_0p6::initStrings(void)
{
...
void DestructibleActorParam_0p6::initDynamicArrays(void)
{
...
void DestructibleActorParam_0p6::initDefaults(void)
{
...
void DestructibleActorParam_0p6::initReferences(void)
{
}

void DestructibleActorParam_0p6::freeDynamicArrays(void)
{
...
void DestructibleActorParam_0p6::freeStrings(void)
{
...
void DestructibleActorParam_0p6::freeReferences(void)
{
}
