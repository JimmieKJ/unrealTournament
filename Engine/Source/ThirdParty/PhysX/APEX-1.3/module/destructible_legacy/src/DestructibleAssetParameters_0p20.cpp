...
const char* const DestructibleAssetParameters_0p20Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p20, DestructibleAssetParameters_0p20::ClassAlignment>();

const physx::PxU32 NumParamDefs = 150;
...
NxParameterized::MutexType DestructibleAssetParameters_0p20::mBuiltFlagMutex;

DestructibleAssetParameters_0p20::DestructibleAssetParameters_0p20(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p20::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p20::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p20::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p20::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p20::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
