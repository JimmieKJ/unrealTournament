...
const char* const DestructibleActorParam_0p18Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p18, DestructibleActorParam_0p18::ClassAlignment>();
...
NxParameterized::MutexType DestructibleActorParam_0p18::mBuiltFlagMutex;

DestructibleActorParam_0p18::DestructibleActorParam_0p18(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p18::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p18::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p18::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p18::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p18::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p18::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=208, longName="structureSettings"
	{
		...
		ParamDefTable[208].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
