...
const char* const DestructibleActorParam_0p29Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p29, DestructibleActorParam_0p29::ClassAlignment>();
...
NxParameterized::MutexType DestructibleActorParam_0p29::mBuiltFlagMutex;

DestructibleActorParam_0p29::DestructibleActorParam_0p29(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p29::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p29::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p29::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p29::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p29::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
NxParameterized::ErrorType DestructibleActorParam_0p29::copy(const NxParameterized::Interface &other)
{
	...
	const DestructibleActorParam_0p29* inParams = (const DestructibleActorParam_0p29*)(&other);
	DestructibleActorParam_0p29* outParams = (DestructibleActorParam_0p29*)(this);
	
	// first, shallow copy the entire class
	physx::PxMemCopy(outParams, inParams, sizeof(DestructibleActorParam_0p29));
