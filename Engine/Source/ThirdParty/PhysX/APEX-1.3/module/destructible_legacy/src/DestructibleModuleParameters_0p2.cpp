...
const char* const DestructibleModuleParameters_0p2Factory::vptr =
    NxParameterized::getVptr<DestructibleModuleParameters_0p2, DestructibleModuleParameters_0p2::ClassAlignment>();
...
NxParameterized::MutexType DestructibleModuleParameters_0p2::mBuiltFlagMutex;

DestructibleModuleParameters_0p2::DestructibleModuleParameters_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleModuleParameters_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleModuleParameters_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleModuleParameters_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleModuleParameters_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleModuleParameters_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleModuleParameters_0p2::initDefaults(void)
{
	...
	gpuRigidBodySettings.sphereSlices = physx::PxU32(4);
	gpuRigidBodySettings.sphereStacks = physx::PxU32(4);
	gpuRigidBodySettings.capsuleSlices = physx::PxU32(6);
	gpuRigidBodySettings.capsuleStacks = physx::PxU32(4);
