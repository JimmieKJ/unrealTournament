...
const char* const DestructibleModuleParameters_0p3Factory::vptr =
    NxParameterized::getVptr<DestructibleModuleParameters_0p3, DestructibleModuleParameters_0p3::ClassAlignment>();
...
NxParameterized::MutexType DestructibleModuleParameters_0p3::mBuiltFlagMutex;

DestructibleModuleParameters_0p3::DestructibleModuleParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleModuleParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleModuleParameters_0p3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleModuleParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleModuleParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleModuleParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
