...
const char* const DestructibleActorParam_0p22Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p22, DestructibleActorParam_0p22::ClassAlignment>();

const physx::PxU32 NumParamDefs = 277;
...
NxParameterized::MutexType DestructibleActorParam_0p22::mBuiltFlagMutex;

DestructibleActorParam_0p22::DestructibleActorParam_0p22(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p22::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p22::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p22::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p22::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p22::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p22::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=84, longName="shapeDescTemplate"
	{
		...
		ParamDefTable[84].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[84].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=226, longName="structureSettings"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("editorDisplay", "false", true);
		ParamDefTable[226].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[226].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
