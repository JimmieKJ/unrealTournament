...
const char* const DestructibleActorParam_0p30Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p30, DestructibleActorParam_0p30::ClassAlignment>();

const physx::PxU32 NumParamDefs = 293;
...
NxParameterized::MutexType DestructibleActorParam_0p30::mBuiltFlagMutex;

DestructibleActorParam_0p30::DestructibleActorParam_0p30(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p30::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p30::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p30::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p30::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p30::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p30::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=158, longName="bodyDescTemplate"
	{
		...
		ParamDefTable[158].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=175, longName="p3ShapeDescTemplate"
	{
		...
		HintTable[1].init("longDescription", "Contains the parameters the application can override on any actor shapes created.", true);
		HintTable[2].init("shortDescription", "Contains the parameters the application can override on any actor shapes created", true);
		ParamDefTable[175].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=224, longName="p3BodyDescTemplate"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("editorDisplay", "false", true);
		ParamDefTable[224].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		HintTable[1].init("longDescription", "Contains the parameterse that the application can override for the body descriptor of rigid body actors created.", true);
		HintTable[2].init("shortDescription", "Contains the parameterse that the application can override for the body descriptor of rigid body actors created", true);
		ParamDefTable[224].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=238, longName="structureSettings"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("editorDisplay", "false", true);
		ParamDefTable[238].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[238].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	{
		NxParameterized::DefinitionImpl* ParamDef = &ParamDefTable[292];
		...
		ParamDefTable[292].setHints((const NxParameterized::Hint**)HintPtrTable, 2);
...
NxParameterized::ErrorType DestructibleActorParam_0p30::copy(const NxParameterized::Interface &other)
{
	...
	const DestructibleActorParam_0p30* inParams = (const DestructibleActorParam_0p30*)(&other);
	DestructibleActorParam_0p30* outParams = (DestructibleActorParam_0p30*)(this);
	
	// first, shallow copy the entire class
	physx::PxMemCopy(outParams, inParams, sizeof(DestructibleActorParam_0p30));
