...
using namespace DestructibleAssetParameters_0p22NS;

const char* const DestructibleAssetParameters_0p22Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p22, DestructibleAssetParameters_0p22::ClassAlignment>();

const physx::PxU32 NumParamDefs = 157;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 2, 3, 4, 5, 22, 40, 41, 53, 55, 57, 115, 126, 127, 128, 129, 130, 131, 136, 138,
	139, 141, 143, 144, 145, 146, 147, 149, 151, 153, 6, 7, 8, 9, 13, 17, 18, 19, 20,
	...
	63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 80, 81, 82, 83, 89, 114, 73, 74, 75, 76,
	77, 78, 79, 84, 85, 86, 87, 88, 90, 91, 92, 93, 94, 95, 96, 102, 107, 97, 98, 99,
	100, 101, 103, 104, 105, 106, 108, 109, 110, 111, 112, 113, 116, 117, 118, 119, 120,
	121, 122, 123, 124, 125, 132, 133, 134, 135, 137, 140, 142, 148, 150, 152, 154, 155,
	156,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->destructibleParameters), CHILDREN(76), 21 }, // destructibleParameters
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->flags), CHILDREN(97), 7 }, // destructibleParameters.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->dynamicChunksGroupsMask), CHILDREN(104), 5 }, // destructibleParameters.dynamicChunksGroupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->runtimeFracture), CHILDREN(109), 9 }, // destructibleParameters.runtimeFracture
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->glass), CHILDREN(118), 5 }, // destructibleParameters.runtimeFracture.glass
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->voronoi), CHILDREN(123), 4 }, // destructibleParameters.runtimeFracture.voronoi
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->attachment), CHILDREN(127), 6 }, // destructibleParameters.runtimeFracture.attachment
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->depthParameters), CHILDREN(133), 1 }, // depthParameters
	{ TYPE_STRUCT, false, 1 * sizeof(DestructibleDepthParameters_Type), CHILDREN(134), 9 }, // depthParameters[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->chunkInstanceInfo), CHILDREN(143), 1 }, // chunkInstanceInfo
	{ TYPE_STRUCT, false, 1 * sizeof(InstanceInfo_Type), CHILDREN(144), 3 }, // chunkInstanceInfo[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->staticMaterialNames), CHILDREN(147), 1 }, // staticMaterialNames
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overlapsAtDepth), CHILDREN(148), 1 }, // overlapsAtDepth
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // overlapsAtDepth[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->firstChunkAtDepth), CHILDREN(149), 1 }, // firstChunkAtDepth
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->actorTransforms), CHILDREN(150), 1 }, // actorTransforms
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // actorTransforms[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshAssets), CHILDREN(151), 1 }, // scatterMeshAssets
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // scatterMeshAssets[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshIndices), CHILDREN(152), 1 }, // scatterMeshIndices
	{ TYPE_U8, false, 1 * sizeof(physx::PxU8), NULL, 0 }, // scatterMeshIndices[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshTransforms), CHILDREN(153), 1 }, // scatterMeshTransforms
	{ TYPE_STRUCT, false, 1 * sizeof(M34_Type), CHILDREN(154), 2 }, // scatterMeshTransforms[]
...
bool DestructibleAssetParameters_0p22::mBuiltFlag = false;
NxParameterized::MutexType DestructibleAssetParameters_0p22::mBuiltFlagMutex;
...
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleAssetParameters_0p22FactoryInst);
...
void DestructibleAssetParameters_0p22::destroy()
{
	...
	this->~DestructibleAssetParameters_0p22();
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p22::getParameterDefinitionTree(void) const
{
	DestructibleAssetParameters_0p22* tmpParam = const_cast<DestructibleAssetParameters_0p22*>(this);
...
NxParameterized::ErrorType DestructibleAssetParameters_0p22::getParameterHandle(const char* long_name, Handle& handle) const
{
...
void DestructibleAssetParameters_0p22::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleAssetParameters_0p22::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleAssetParameters_0p22::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=48, longName="chunks[].flags"
	{
		...
		ParamDefTable[48].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=53, longName="chunkConvexHulls"
	{
		...
		ParamDefTable[53].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=54, longName="chunkConvexHulls[]"
	{
		...
		HintTable[1].init("longDescription", "Convex hull data for each chunk.  This is not cooked convex hull data\n					used for PhysX collision.  These hulls are used to (a) create cooked PhysX convex hulls, and (b)\n					for APEX scene queries.", true);
		HintTable[2].init("shortDescription", "Convex hull data for each chunk", true);
		ParamDefTable[54].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=90, longName="destructibleParameters.runtimeFracture.RuntimeFractureType"
	{
		...
		ParamDefTable[90].setEnumVals((const char**)EnumVals, 2);
	...
	// Initialize DefinitionImpl node: nodeIndex=91, longName="destructibleParameters.runtimeFracture.sheetFracture"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=92, longName="destructibleParameters.runtimeFracture.depthLimit"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=93, longName="destructibleParameters.runtimeFracture.destroyIfAtDepthLimit"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=94, longName="destructibleParameters.runtimeFracture.minConvexSize"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=95, longName="destructibleParameters.runtimeFracture.impulseScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=96, longName="destructibleParameters.runtimeFracture.glass"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=97, longName="destructibleParameters.runtimeFracture.glass.numSectors"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=98, longName="destructibleParameters.runtimeFracture.glass.sectorRand"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=99, longName="destructibleParameters.runtimeFracture.glass.firstSegmentSize"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=100, longName="destructibleParameters.runtimeFracture.glass.segmentScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=101, longName="destructibleParameters.runtimeFracture.glass.segmentRand"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=102, longName="destructibleParameters.runtimeFracture.voronoi"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=103, longName="destructibleParameters.runtimeFracture.voronoi.dimensions"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=104, longName="destructibleParameters.runtimeFracture.voronoi.numCells"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=105, longName="destructibleParameters.runtimeFracture.voronoi.biasExp"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=106, longName="destructibleParameters.runtimeFracture.voronoi.maxDist"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=107, longName="destructibleParameters.runtimeFracture.attachment"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=108, longName="destructibleParameters.runtimeFracture.attachment.posX"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=109, longName="destructibleParameters.runtimeFracture.attachment.negX"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=110, longName="destructibleParameters.runtimeFracture.attachment.posY"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=111, longName="destructibleParameters.runtimeFracture.attachment.negY"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=112, longName="destructibleParameters.runtimeFracture.attachment.posZ"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=113, longName="destructibleParameters.runtimeFracture.attachment.negZ"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=114, longName="destructibleParameters.supportStrength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=115, longName="depthParameters"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=116, longName="depthParameters[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=117, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=118, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE_VALUE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=119, longName="depthParameters[].IGNORE_POSE_UPDATES"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=120, longName="depthParameters[].IGNORE_RAYCAST_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=121, longName="depthParameters[].IGNORE_CONTACT_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=122, longName="depthParameters[].USER_FLAG_0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=123, longName="depthParameters[].USER_FLAG_1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=124, longName="depthParameters[].USER_FLAG_2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=125, longName="depthParameters[].USER_FLAG_3"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=126, longName="crumbleEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=127, longName="dustEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=128, longName="collisionData"
	{
		...
		ParamDefTable[128].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=129, longName="renderMeshAsset"
	{
		...
		ParamDefTable[129].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=130, longName="initialDestructibleActorAllowanceForInstancing"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=131, longName="chunkInstanceInfo"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=132, longName="chunkInstanceInfo[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=133, longName="chunkInstanceInfo[].partIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=134, longName="chunkInstanceInfo[].chunkPositionOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=135, longName="chunkInstanceInfo[].chunkUVOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=136, longName="staticMaterialNames"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=137, longName="staticMaterialNames[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=138, longName="neighborPadding"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=139, longName="overlapsAtDepth"
	{
		...
		ParamDefTable[139].setRefVariantVals((const char**)RefVariantVals, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=140, longName="overlapsAtDepth[]"
	{
		...
		static const char* const RefVariantVals[] = { "CachedOverlaps" };
		ParamDefTable[140].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=141, longName="firstChunkAtDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=142, longName="firstChunkAtDepth[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=143, longName="supportDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=144, longName="formExtendedStructures"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=145, longName="useAssetDefinedSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=146, longName="useWorldSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=147, longName="actorTransforms"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=148, longName="actorTransforms[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=149, longName="scatterMeshAssets"
	{
		...
		static const char* const RefVariantVals[] = { "RenderMeshAssetParameters" };
		ParamDefTable[149].setRefVariantVals((const char**)RefVariantVals, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=150, longName="scatterMeshAssets[]"
	{
		...
		HintTable[1].init("longDescription", "The included scatter mesh asset.", true);
		HintTable[2].init("shortDescription", "The included scatter mesh assets", true);
		ParamDefTable[150].setHints((const NxParameterized::Hint**)HintPtrTable, 3);

#endif /* NX_PARAMETERIZED_HIDE_DESCRIPTIONS */


		static const char* const RefVariantVals[] = { "RenderMeshAssetParameters" };
		ParamDefTable[150].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=151, longName="scatterMeshIndices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=152, longName="scatterMeshIndices[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=153, longName="scatterMeshTransforms"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=154, longName="scatterMeshTransforms[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=155, longName="scatterMeshTransforms[].matrix"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=156, longName="scatterMeshTransforms[].vector"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[11] = PDEF_PTR(115);
		Children[12] = PDEF_PTR(126);
		Children[13] = PDEF_PTR(127);
		Children[14] = PDEF_PTR(128);
		Children[15] = PDEF_PTR(129);
		Children[16] = PDEF_PTR(130);
		Children[17] = PDEF_PTR(131);
		Children[18] = PDEF_PTR(136);
		Children[19] = PDEF_PTR(138);
		Children[20] = PDEF_PTR(139);
		Children[21] = PDEF_PTR(141);
		Children[22] = PDEF_PTR(143);
		Children[23] = PDEF_PTR(144);
		Children[24] = PDEF_PTR(145);
		Children[25] = PDEF_PTR(146);
		Children[26] = PDEF_PTR(147);
		Children[27] = PDEF_PTR(149);
		Children[28] = PDEF_PTR(151);
		Children[29] = PDEF_PTR(153);
	...
	// SetChildren for: nodeIndex=57, longName="destructibleParameters"
	{
		...
		Children[20] = PDEF_PTR(114);

		ParamDefTable[57].setChildren(Children, 21);
	}
	...
	// SetChildren for: nodeIndex=89, longName="destructibleParameters.runtimeFracture"
	{
		...
		Children[7] = PDEF_PTR(102);
		Children[8] = PDEF_PTR(107);

		ParamDefTable[89].setChildren(Children, 9);
	}

	// SetChildren for: nodeIndex=96, longName="destructibleParameters.runtimeFracture.glass"
	{
		static Definition* Children[5];
		...
		ParamDefTable[96].setChildren(Children, 5);
	}

	// SetChildren for: nodeIndex=102, longName="destructibleParameters.runtimeFracture.voronoi"
	{
		...
		ParamDefTable[102].setChildren(Children, 4);
	}

	// SetChildren for: nodeIndex=107, longName="destructibleParameters.runtimeFracture.attachment"
	{
		...
		ParamDefTable[107].setChildren(Children, 6);
	}

	// SetChildren for: nodeIndex=115, longName="depthParameters"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(116);

		ParamDefTable[115].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=116, longName="depthParameters[]"
	{
		static Definition* Children[9];
		Children[0] = PDEF_PTR(117);
		Children[1] = PDEF_PTR(118);
		Children[2] = PDEF_PTR(119);
		Children[3] = PDEF_PTR(120);
		Children[4] = PDEF_PTR(121);
		Children[5] = PDEF_PTR(122);
		Children[6] = PDEF_PTR(123);
		Children[7] = PDEF_PTR(124);
		Children[8] = PDEF_PTR(125);

		ParamDefTable[116].setChildren(Children, 9);
	}

	// SetChildren for: nodeIndex=131, longName="chunkInstanceInfo"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(132);

		ParamDefTable[131].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=132, longName="chunkInstanceInfo[]"
	{
		static Definition* Children[3];
		...
		ParamDefTable[132].setChildren(Children, 3);
	}

	// SetChildren for: nodeIndex=136, longName="staticMaterialNames"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=139, longName="overlapsAtDepth"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(140);

		ParamDefTable[139].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=141, longName="firstChunkAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=147, longName="actorTransforms"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(148);

		ParamDefTable[147].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=149, longName="scatterMeshAssets"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(150);

		ParamDefTable[149].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=151, longName="scatterMeshIndices"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(152);

		ParamDefTable[151].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=153, longName="scatterMeshTransforms"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(154);

		ParamDefTable[153].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=154, longName="scatterMeshTransforms[]"
	{
		static Definition* Children[2];
		Children[0] = PDEF_PTR(155);
		Children[1] = PDEF_PTR(156);

		ParamDefTable[154].setChildren(Children, 2);
	}
