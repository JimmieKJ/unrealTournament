...
const char* const SurfaceTraceSetParameters_0p0Factory::vptr =
    NxParameterized::getVptr<SurfaceTraceSetParameters_0p0, SurfaceTraceSetParameters_0p0::ClassAlignment>();
...
NxParameterized::MutexType SurfaceTraceSetParameters_0p0::mBuiltFlagMutex;

SurfaceTraceSetParameters_0p0::SurfaceTraceSetParameters_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SurfaceTraceSetParameters_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SurfaceTraceSetParameters_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SurfaceTraceSetParameters_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SurfaceTraceSetParameters_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SurfaceTraceSetParameters_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
