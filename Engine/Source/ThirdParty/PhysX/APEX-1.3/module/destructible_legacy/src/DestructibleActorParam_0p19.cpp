...
const char* const DestructibleActorParam_0p19Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p19, DestructibleActorParam_0p19::ClassAlignment>();

const physx::PxU32 NumParamDefs = 255;
...
NxParameterized::MutexType DestructibleActorParam_0p19::mBuiltFlagMutex;

DestructibleActorParam_0p19::DestructibleActorParam_0p19(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p19::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p19::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p19::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p19::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleActorParam_0p19::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleActorParam_0p19::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
