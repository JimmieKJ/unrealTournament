...
using namespace DestructibleAssetParameters_0p19NS;

const char* const DestructibleAssetParameters_0p19Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p19, DestructibleAssetParameters_0p19::ClassAlignment>();

const physx::PxU32 NumParamDefs = 131;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 2, 3, 4, 5, 22, 40, 41, 53, 55, 57, 89, 100, 101, 102, 103, 104, 105, 110, 112,
	113, 115, 117, 118, 119, 120, 121, 123, 125, 127, 6, 7, 8, 9, 13, 17, 18, 19, 20,
	...
	63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 80, 81, 82, 83, 73, 74, 75, 76, 77, 78, 79,
	84, 85, 86, 87, 88, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 106, 107, 108, 109, 111,
	114, 116, 122, 124, 126, 128, 129, 130,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->destructibleParameters), CHILDREN(76), 19 }, // destructibleParameters
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->flags), CHILDREN(95), 7 }, // destructibleParameters.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->dynamicChunksGroupsMask), CHILDREN(102), 5 }, // destructibleParameters.dynamicChunksGroupsMask
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->depthParameters), CHILDREN(107), 1 }, // depthParameters
	{ TYPE_STRUCT, false, 1 * sizeof(DestructibleDepthParameters_Type), CHILDREN(108), 9 }, // depthParameters[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->chunkInstanceInfo), CHILDREN(117), 1 }, // chunkInstanceInfo
	{ TYPE_STRUCT, false, 1 * sizeof(InstanceInfo_Type), CHILDREN(118), 3 }, // chunkInstanceInfo[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->staticMaterialNames), CHILDREN(121), 1 }, // staticMaterialNames
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overlapsAtDepth), CHILDREN(122), 1 }, // overlapsAtDepth
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // overlapsAtDepth[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->firstChunkAtDepth), CHILDREN(123), 1 }, // firstChunkAtDepth
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->actorTransforms), CHILDREN(124), 1 }, // actorTransforms
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // actorTransforms[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshAssets), CHILDREN(125), 1 }, // scatterMeshAssets
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // scatterMeshAssets[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshIndices), CHILDREN(126), 1 }, // scatterMeshIndices
	{ TYPE_U8, false, 1 * sizeof(physx::PxU8), NULL, 0 }, // scatterMeshIndices[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshTransforms), CHILDREN(127), 1 }, // scatterMeshTransforms
	{ TYPE_STRUCT, false, 1 * sizeof(M34_Type), CHILDREN(128), 2 }, // scatterMeshTransforms[]
...
bool DestructibleAssetParameters_0p19::mBuiltFlag = false;
NxParameterized::MutexType DestructibleAssetParameters_0p19::mBuiltFlagMutex;

DestructibleAssetParameters_0p19::DestructibleAssetParameters_0p19(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleAssetParameters_0p19FactoryInst);
...
DestructibleAssetParameters_0p19::~DestructibleAssetParameters_0p19()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void DestructibleAssetParameters_0p19::destroy()
{
	...
	this->~DestructibleAssetParameters_0p19();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p19::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p19::getParameterDefinitionTree(void) const
{
	DestructibleAssetParameters_0p19* tmpParam = const_cast<DestructibleAssetParameters_0p19*>(this);
...
NxParameterized::ErrorType DestructibleAssetParameters_0p19::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p19::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p19::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleAssetParameters_0p19::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleAssetParameters_0p19::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleAssetParameters_0p19::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=89, longName="depthParameters"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=90, longName="depthParameters[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=91, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=92, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE_VALUE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=93, longName="depthParameters[].IGNORE_POSE_UPDATES"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=94, longName="depthParameters[].IGNORE_RAYCAST_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=95, longName="depthParameters[].IGNORE_CONTACT_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=96, longName="depthParameters[].USER_FLAG_0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=97, longName="depthParameters[].USER_FLAG_1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=98, longName="depthParameters[].USER_FLAG_2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=99, longName="depthParameters[].USER_FLAG_3"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=100, longName="crumbleEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=101, longName="dustEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=102, longName="collisionData"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[102].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[102].setHints((const NxParameterized::Hint**)HintPtrTable, 3);

#endif /* NX_PARAMETERIZED_HIDE_DESCRIPTIONS */


		static const char* const RefVariantVals[] = { "DestructibleAssetCollisionDataSet" };
		ParamDefTable[102].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=103, longName="renderMeshAsset"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[103].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[103].setHints((const NxParameterized::Hint**)HintPtrTable, 3);

#endif /* NX_PARAMETERIZED_HIDE_DESCRIPTIONS */


		static const char* const RefVariantVals[] = { "RenderMeshAssetParameters" };
		ParamDefTable[103].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=104, longName="initialDestructibleActorAllowanceForInstancing"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=105, longName="chunkInstanceInfo"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=106, longName="chunkInstanceInfo[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=107, longName="chunkInstanceInfo[].partIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=108, longName="chunkInstanceInfo[].chunkPositionOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=109, longName="chunkInstanceInfo[].chunkUVOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=110, longName="staticMaterialNames"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=111, longName="staticMaterialNames[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=112, longName="neighborPadding"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=113, longName="overlapsAtDepth"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[113].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[113].setHints((const NxParameterized::Hint**)HintPtrTable, 3);

#endif /* NX_PARAMETERIZED_HIDE_DESCRIPTIONS */


		static const char* const RefVariantVals[] = { "CachedOverlaps" };
		ParamDefTable[113].setRefVariantVals((const char**)RefVariantVals, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=114, longName="overlapsAtDepth[]"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[114].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		HintTable[1].init("longDescription", "The chunk overlaps (adjacencies) at each depth of the hierarchy.", true);
		HintTable[2].init("shortDescription", "The chunk overlaps at each depth of the hierarchy", true);
		ParamDefTable[114].setHints((const NxParameterized::Hint**)HintPtrTable, 3);

#endif /* NX_PARAMETERIZED_HIDE_DESCRIPTIONS */


		static const char* const RefVariantVals[] = { "CachedOverlaps" };
		ParamDefTable[114].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=115, longName="firstChunkAtDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=116, longName="firstChunkAtDepth[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=117, longName="supportDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=118, longName="formExtendedStructures"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=119, longName="useAssetDefinedSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=120, longName="useWorldSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=121, longName="actorTransforms"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=122, longName="actorTransforms[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=123, longName="scatterMeshAssets"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=124, longName="scatterMeshAssets[]"
	{
		...
		static const char* const RefVariantVals[] = { "RenderMeshAssetParameters" };
		ParamDefTable[124].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=125, longName="scatterMeshIndices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=126, longName="scatterMeshIndices[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=127, longName="scatterMeshTransforms"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=128, longName="scatterMeshTransforms[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=129, longName="scatterMeshTransforms[].matrix"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=130, longName="scatterMeshTransforms[].vector"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[18] = PDEF_PTR(110);
		Children[19] = PDEF_PTR(112);
		Children[20] = PDEF_PTR(113);
		Children[21] = PDEF_PTR(115);
		Children[22] = PDEF_PTR(117);
		Children[23] = PDEF_PTR(118);
		Children[24] = PDEF_PTR(119);
		Children[25] = PDEF_PTR(120);
		Children[26] = PDEF_PTR(121);
		Children[27] = PDEF_PTR(123);
		Children[28] = PDEF_PTR(125);
		Children[29] = PDEF_PTR(127);
	...
	// SetChildren for: nodeIndex=57, longName="destructibleParameters"
	{
		...
		ParamDefTable[57].setChildren(Children, 19);
	}
	...
	// SetChildren for: nodeIndex=89, longName="depthParameters"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(90);

		ParamDefTable[89].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=90, longName="depthParameters[]"
	{
		static Definition* Children[9];
		Children[0] = PDEF_PTR(91);
		Children[1] = PDEF_PTR(92);
		Children[2] = PDEF_PTR(93);
		Children[3] = PDEF_PTR(94);
		Children[4] = PDEF_PTR(95);
		Children[5] = PDEF_PTR(96);
		Children[6] = PDEF_PTR(97);
		Children[7] = PDEF_PTR(98);
		Children[8] = PDEF_PTR(99);

		ParamDefTable[90].setChildren(Children, 9);
	}

	// SetChildren for: nodeIndex=105, longName="chunkInstanceInfo"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(106);

		ParamDefTable[105].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=106, longName="chunkInstanceInfo[]"
	{
		static Definition* Children[3];
		...
		ParamDefTable[106].setChildren(Children, 3);
	}

	// SetChildren for: nodeIndex=110, longName="staticMaterialNames"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(111);

		ParamDefTable[110].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=113, longName="overlapsAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=115, longName="firstChunkAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=121, longName="actorTransforms"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(122);

		ParamDefTable[121].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=123, longName="scatterMeshAssets"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(124);

		ParamDefTable[123].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=125, longName="scatterMeshIndices"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=127, longName="scatterMeshTransforms"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(128);

		ParamDefTable[127].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=128, longName="scatterMeshTransforms[]"
	{
		static Definition* Children[2];
		Children[0] = PDEF_PTR(129);
		Children[1] = PDEF_PTR(130);

		ParamDefTable[128].setChildren(Children, 2);
	}

	mBuiltFlag = true;

}
void DestructibleAssetParameters_0p19::initStrings(void)
{
...
void DestructibleAssetParameters_0p19::initDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p19::initDefaults(void)
{
...
void DestructibleAssetParameters_0p19::initReferences(void)
{
	collisionData = NULL;
...
void DestructibleAssetParameters_0p19::freeDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p19::freeStrings(void)
{
...
void DestructibleAssetParameters_0p19::freeReferences(void)
{
