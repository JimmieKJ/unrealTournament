...
const char* const DestructibleActorParam_0p1Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p1, DestructibleActorParam_0p1::ClassAlignment>();

const physx::PxU32 NumParamDefs = 141;
...
NxParameterized::MutexType DestructibleActorParam_0p1::mBuiltFlagMutex;

DestructibleActorParam_0p1::DestructibleActorParam_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
