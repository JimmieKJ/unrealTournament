...
using namespace DestructibleAssetParameters_0p21NS;

const char* const DestructibleAssetParameters_0p21Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p21, DestructibleAssetParameters_0p21::ClassAlignment>();

const physx::PxU32 NumParamDefs = 151;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 2, 3, 4, 5, 22, 40, 41, 53, 55, 57, 109, 120, 121, 122, 123, 124, 125, 130, 132,
	133, 135, 137, 138, 139, 140, 141, 143, 145, 147, 6, 7, 8, 9, 13, 17, 18, 19, 20,
	...
	63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 80, 81, 82, 83, 89, 108, 73, 74, 75, 76,
	77, 78, 79, 84, 85, 86, 87, 88, 90, 91, 92, 93, 94, 95, 101, 96, 97, 98, 99, 100,
	102, 103, 104, 105, 106, 107, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 126,
	127, 128, 129, 131, 134, 136, 142, 144, 146, 148, 149, 150,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->runtimeFracture), CHILDREN(109), 7 }, // destructibleParameters.runtimeFracture
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->glass), CHILDREN(116), 5 }, // destructibleParameters.runtimeFracture.glass
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->attachment), CHILDREN(121), 6 }, // destructibleParameters.runtimeFracture.attachment
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->depthParameters), CHILDREN(127), 1 }, // depthParameters
	{ TYPE_STRUCT, false, 1 * sizeof(DestructibleDepthParameters_Type), CHILDREN(128), 9 }, // depthParameters[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->chunkInstanceInfo), CHILDREN(137), 1 }, // chunkInstanceInfo
	{ TYPE_STRUCT, false, 1 * sizeof(InstanceInfo_Type), CHILDREN(138), 3 }, // chunkInstanceInfo[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->staticMaterialNames), CHILDREN(141), 1 }, // staticMaterialNames
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overlapsAtDepth), CHILDREN(142), 1 }, // overlapsAtDepth
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // overlapsAtDepth[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->firstChunkAtDepth), CHILDREN(143), 1 }, // firstChunkAtDepth
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->actorTransforms), CHILDREN(144), 1 }, // actorTransforms
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // actorTransforms[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshAssets), CHILDREN(145), 1 }, // scatterMeshAssets
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // scatterMeshAssets[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshIndices), CHILDREN(146), 1 }, // scatterMeshIndices
	{ TYPE_U8, false, 1 * sizeof(physx::PxU8), NULL, 0 }, // scatterMeshIndices[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshTransforms), CHILDREN(147), 1 }, // scatterMeshTransforms
	{ TYPE_STRUCT, false, 1 * sizeof(M34_Type), CHILDREN(148), 2 }, // scatterMeshTransforms[]
...
bool DestructibleAssetParameters_0p21::mBuiltFlag = false;
NxParameterized::MutexType DestructibleAssetParameters_0p21::mBuiltFlagMutex;

DestructibleAssetParameters_0p21::DestructibleAssetParameters_0p21(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleAssetParameters_0p21FactoryInst);
...
DestructibleAssetParameters_0p21::~DestructibleAssetParameters_0p21()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void DestructibleAssetParameters_0p21::destroy()
{
	...
	this->~DestructibleAssetParameters_0p21();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p21::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p21::getParameterDefinitionTree(void) const
{
	DestructibleAssetParameters_0p21* tmpParam = const_cast<DestructibleAssetParameters_0p21*>(this);
...
NxParameterized::ErrorType DestructibleAssetParameters_0p21::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p21::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p21::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleAssetParameters_0p21::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleAssetParameters_0p21::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleAssetParameters_0p21::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=108, longName="destructibleParameters.supportStrength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=110, longName="depthParameters[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=111, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=112, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE_VALUE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=113, longName="depthParameters[].IGNORE_POSE_UPDATES"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=114, longName="depthParameters[].IGNORE_RAYCAST_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=115, longName="depthParameters[].IGNORE_CONTACT_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=116, longName="depthParameters[].USER_FLAG_0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=117, longName="depthParameters[].USER_FLAG_1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=118, longName="depthParameters[].USER_FLAG_2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=119, longName="depthParameters[].USER_FLAG_3"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=120, longName="crumbleEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=121, longName="dustEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=122, longName="collisionData"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=123, longName="renderMeshAsset"
	{
		...
		ParamDefTable[123].setRefVariantVals((const char**)RefVariantVals, 1);



	}

	// Initialize DefinitionImpl node: nodeIndex=124, longName="initialDestructibleActorAllowanceForInstancing"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=126, longName="chunkInstanceInfo[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=127, longName="chunkInstanceInfo[].partIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=128, longName="chunkInstanceInfo[].chunkPositionOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=129, longName="chunkInstanceInfo[].chunkUVOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=131, longName="staticMaterialNames[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=132, longName="neighborPadding"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=134, longName="overlapsAtDepth[]"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[134].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		HintTable[1].init("longDescription", "The chunk overlaps (adjacencies) at each depth of the hierarchy.", true);
		HintTable[2].init("shortDescription", "The chunk overlaps at each depth of the hierarchy", true);
		ParamDefTable[134].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=136, longName="firstChunkAtDepth[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=137, longName="supportDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=138, longName="formExtendedStructures"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=139, longName="useAssetDefinedSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=140, longName="useWorldSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=142, longName="actorTransforms[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=144, longName="scatterMeshAssets[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=146, longName="scatterMeshIndices[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=148, longName="scatterMeshTransforms[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=149, longName="scatterMeshTransforms[].matrix"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=150, longName="scatterMeshTransforms[].vector"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[12] = PDEF_PTR(120);
		Children[13] = PDEF_PTR(121);
		Children[14] = PDEF_PTR(122);
		Children[15] = PDEF_PTR(123);
		Children[16] = PDEF_PTR(124);
		Children[17] = PDEF_PTR(125);
		Children[18] = PDEF_PTR(130);
		Children[19] = PDEF_PTR(132);
		Children[20] = PDEF_PTR(133);
		Children[21] = PDEF_PTR(135);
		Children[22] = PDEF_PTR(137);
		Children[23] = PDEF_PTR(138);
		Children[24] = PDEF_PTR(139);
		Children[25] = PDEF_PTR(140);
		Children[26] = PDEF_PTR(141);
		Children[27] = PDEF_PTR(143);
		Children[28] = PDEF_PTR(145);
		Children[29] = PDEF_PTR(147);
	...
	// SetChildren for: nodeIndex=110, longName="depthParameters[]"
	{
		...
		ParamDefTable[110].setChildren(Children, 9);
	}
	...
	// SetChildren for: nodeIndex=125, longName="chunkInstanceInfo"
	{
		...
		ParamDefTable[125].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=126, longName="chunkInstanceInfo[]"
	{
		static Definition* Children[3];
		...
		ParamDefTable[126].setChildren(Children, 3);
	}

	// SetChildren for: nodeIndex=130, longName="staticMaterialNames"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(131);

		ParamDefTable[130].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=133, longName="overlapsAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=135, longName="firstChunkAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=141, longName="actorTransforms"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=143, longName="scatterMeshAssets"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=145, longName="scatterMeshIndices"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=148, longName="scatterMeshTransforms[]"
	{
		static Definition* Children[2];
		Children[0] = PDEF_PTR(149);
		Children[1] = PDEF_PTR(150);

		ParamDefTable[148].setChildren(Children, 2);
	}

	mBuiltFlag = true;

}
void DestructibleAssetParameters_0p21::initStrings(void)
{
...
void DestructibleAssetParameters_0p21::initDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p21::initDefaults(void)
{
...
void DestructibleAssetParameters_0p21::initReferences(void)
{
	collisionData = NULL;
...
void DestructibleAssetParameters_0p21::freeDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p21::freeStrings(void)
{
...
void DestructibleAssetParameters_0p21::freeReferences(void)
{
