...
const char* const DestructibleActorParam_0p16Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p16, DestructibleActorParam_0p16::ClassAlignment>();

const physx::PxU32 NumParamDefs = 244;
...
NxParameterized::MutexType DestructibleActorParam_0p16::mBuiltFlagMutex;

DestructibleActorParam_0p16::DestructibleActorParam_0p16(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p16::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p16::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p16::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p16::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p16::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p16::initDefaults(void)
{
	...
	defaultBehaviorGroup.minimumDamageRadius = physx::PxF32(0);
	defaultBehaviorGroup.damageRadiusMultiplier = physx::PxF32(1);
	defaultBehaviorGroup.damageFalloffExponent = physx::PxF32(1);
