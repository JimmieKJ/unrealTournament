...
const char* const DestructibleActorParam_0p13Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p13, DestructibleActorParam_0p13::ClassAlignment>();

const physx::PxU32 NumParamDefs = 213;
...
NxParameterized::MutexType DestructibleActorParam_0p13::mBuiltFlagMutex;

DestructibleActorParam_0p13::DestructibleActorParam_0p13(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p13::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p13::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p13::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p13::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p13::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p13::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=209, longName="structureSettings"
	{
		...
		ParamDefTable[209].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
