...
const char* const DestructibleAssetParameters_0p5Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p5, DestructibleAssetParameters_0p5::ClassAlignment>();
...
NxParameterized::MutexType DestructibleAssetParameters_0p5::mBuiltFlagMutex;

DestructibleAssetParameters_0p5::DestructibleAssetParameters_0p5(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p5::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p5::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p5::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p5::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p5::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
