...
const char* const DestructibleActorParam_0p0Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p0, DestructibleActorParam_0p0::ClassAlignment>();

const physx::PxU32 NumParamDefs = 140;
...
NxParameterized::MutexType DestructibleActorParam_0p0::mBuiltFlagMutex;

DestructibleActorParam_0p0::DestructibleActorParam_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
