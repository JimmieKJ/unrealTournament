...
using namespace DestructibleAssetParameters_0p24NS;

const char* const DestructibleAssetParameters_0p24Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p24, DestructibleAssetParameters_0p24::ClassAlignment>();

const physx::PxU32 NumParamDefs = 161;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 2, 3, 4, 5, 23, 42, 43, 55, 57, 59, 119, 130, 131, 132, 133, 134, 135, 140, 142,
	143, 145, 147, 148, 149, 150, 151, 153, 155, 157, 6, 7, 8, 9, 13, 17, 18, 19, 20,
	...
	75, 76, 77, 78, 79, 80, 81, 86, 87, 88, 89, 90, 92, 93, 94, 95, 96, 97, 98, 104,
	109, 99, 100, 101, 102, 103, 105, 106, 107, 108, 110, 111, 112, 113, 114, 115, 120,
	121, 122, 123, 124, 125, 126, 127, 128, 129, 136, 137, 138, 139, 141, 144, 146, 152,
	154, 156, 158, 159, 160,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->destructibleParameters), CHILDREN(78), 23 }, // destructibleParameters
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->flags), CHILDREN(101), 7 }, // destructibleParameters.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->dynamicChunksGroupsMask), CHILDREN(108), 5 }, // destructibleParameters.dynamicChunksGroupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->runtimeFracture), CHILDREN(113), 9 }, // destructibleParameters.runtimeFracture
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->glass), CHILDREN(122), 5 }, // destructibleParameters.runtimeFracture.glass
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->voronoi), CHILDREN(127), 4 }, // destructibleParameters.runtimeFracture.voronoi
	...
	{ TYPE_STRUCT, false, (size_t)(&((RuntimeFracture_Type*)0)->attachment), CHILDREN(131), 6 }, // destructibleParameters.runtimeFracture.attachment
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->depthParameters), CHILDREN(137), 1 }, // depthParameters
	{ TYPE_STRUCT, false, 1 * sizeof(DestructibleDepthParameters_Type), CHILDREN(138), 9 }, // depthParameters[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->chunkInstanceInfo), CHILDREN(147), 1 }, // chunkInstanceInfo
	{ TYPE_STRUCT, false, 1 * sizeof(InstanceInfo_Type), CHILDREN(148), 3 }, // chunkInstanceInfo[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->staticMaterialNames), CHILDREN(151), 1 }, // staticMaterialNames
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overlapsAtDepth), CHILDREN(152), 1 }, // overlapsAtDepth
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // overlapsAtDepth[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->firstChunkAtDepth), CHILDREN(153), 1 }, // firstChunkAtDepth
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->actorTransforms), CHILDREN(154), 1 }, // actorTransforms
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // actorTransforms[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshAssets), CHILDREN(155), 1 }, // scatterMeshAssets
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // scatterMeshAssets[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshIndices), CHILDREN(156), 1 }, // scatterMeshIndices
	{ TYPE_U8, false, 1 * sizeof(physx::PxU8), NULL, 0 }, // scatterMeshIndices[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->scatterMeshTransforms), CHILDREN(157), 1 }, // scatterMeshTransforms
	{ TYPE_STRUCT, false, 1 * sizeof(M34_Type), CHILDREN(158), 2 }, // scatterMeshTransforms[]
...
bool DestructibleAssetParameters_0p24::mBuiltFlag = false;
NxParameterized::MutexType DestructibleAssetParameters_0p24::mBuiltFlagMutex;

DestructibleAssetParameters_0p24::DestructibleAssetParameters_0p24(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleAssetParameters_0p24FactoryInst);
...
DestructibleAssetParameters_0p24::~DestructibleAssetParameters_0p24()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void DestructibleAssetParameters_0p24::destroy()
{
	...
	this->~DestructibleAssetParameters_0p24();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p24::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p24::getParameterDefinitionTree(void) const
{
	DestructibleAssetParameters_0p24* tmpParam = const_cast<DestructibleAssetParameters_0p24*>(this);
...
NxParameterized::ErrorType DestructibleAssetParameters_0p24::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p24::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p24::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleAssetParameters_0p24::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleAssetParameters_0p24::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleAssetParameters_0p24::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=119, longName="depthParameters"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=121, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=122, longName="depthParameters[].OVERRIDE_IMPACT_DAMAGE_VALUE"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=123, longName="depthParameters[].IGNORE_POSE_UPDATES"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=124, longName="depthParameters[].IGNORE_RAYCAST_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=125, longName="depthParameters[].IGNORE_CONTACT_CALLBACKS"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=126, longName="depthParameters[].USER_FLAG_0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=127, longName="depthParameters[].USER_FLAG_1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=128, longName="depthParameters[].USER_FLAG_2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=129, longName="depthParameters[].USER_FLAG_3"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=130, longName="crumbleEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=131, longName="dustEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=132, longName="collisionData"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[132].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[132].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=133, longName="renderMeshAsset"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[133].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[133].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=134, longName="initialDestructibleActorAllowanceForInstancing"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=135, longName="chunkInstanceInfo"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=137, longName="chunkInstanceInfo[].partIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=138, longName="chunkInstanceInfo[].chunkPositionOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=139, longName="chunkInstanceInfo[].chunkUVOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=140, longName="staticMaterialNames"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=142, longName="neighborPadding"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=143, longName="overlapsAtDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=145, longName="firstChunkAtDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=147, longName="supportDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=148, longName="formExtendedStructures"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=149, longName="useAssetDefinedSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=150, longName="useWorldSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=151, longName="actorTransforms"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=153, longName="scatterMeshAssets"
	{
		...
		static const char* const RefVariantVals[] = { "RenderMeshAssetParameters" };
		ParamDefTable[153].setRefVariantVals((const char**)RefVariantVals, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=155, longName="scatterMeshIndices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=157, longName="scatterMeshTransforms"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=159, longName="scatterMeshTransforms[].matrix"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=160, longName="scatterMeshTransforms[].vector"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[12] = PDEF_PTR(130);
		Children[13] = PDEF_PTR(131);
		Children[14] = PDEF_PTR(132);
		Children[15] = PDEF_PTR(133);
		Children[16] = PDEF_PTR(134);
		Children[17] = PDEF_PTR(135);
		Children[18] = PDEF_PTR(140);
		Children[19] = PDEF_PTR(142);
		Children[20] = PDEF_PTR(143);
		Children[21] = PDEF_PTR(145);
		Children[22] = PDEF_PTR(147);
		Children[23] = PDEF_PTR(148);
		Children[24] = PDEF_PTR(149);
		Children[25] = PDEF_PTR(150);
		Children[26] = PDEF_PTR(151);
		Children[27] = PDEF_PTR(153);
		Children[28] = PDEF_PTR(155);
		Children[29] = PDEF_PTR(157);
	...
	// SetChildren for: nodeIndex=59, longName="destructibleParameters"
	{
		...
		ParamDefTable[59].setChildren(Children, 23);
	}
	...
	// SetChildren for: nodeIndex=119, longName="depthParameters"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=120, longName="depthParameters[]"
	{
		...
		Children[8] = PDEF_PTR(129);

		ParamDefTable[120].setChildren(Children, 9);
	}

	// SetChildren for: nodeIndex=135, longName="chunkInstanceInfo"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(136);

		ParamDefTable[135].setChildren(Children, 1);
	}
	...
	// SetChildren for: nodeIndex=136, longName="chunkInstanceInfo[]"
	{
		...
		ParamDefTable[136].setChildren(Children, 3);
	}

	// SetChildren for: nodeIndex=140, longName="staticMaterialNames"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=143, longName="overlapsAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=145, longName="firstChunkAtDepth"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(146);

		ParamDefTable[145].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=151, longName="actorTransforms"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=153, longName="scatterMeshAssets"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=155, longName="scatterMeshIndices"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=157, longName="scatterMeshTransforms"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(158);

		ParamDefTable[157].setChildren(Children, 1);
	}
	...
	// SetChildren for: nodeIndex=158, longName="scatterMeshTransforms[]"
	{
		...
		ParamDefTable[158].setChildren(Children, 2);
	}

	mBuiltFlag = true;

}
void DestructibleAssetParameters_0p24::initStrings(void)
{
...
void DestructibleAssetParameters_0p24::initDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p24::initDefaults(void)
{
...
void DestructibleAssetParameters_0p24::initReferences(void)
{
	collisionData = NULL;
...
void DestructibleAssetParameters_0p24::freeDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p24::freeStrings(void)
{
...
void DestructibleAssetParameters_0p24::freeReferences(void)
{
