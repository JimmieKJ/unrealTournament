...
const char* const DestructibleActorState_0p0Factory::vptr =
    NxParameterized::getVptr<DestructibleActorState_0p0, DestructibleActorState_0p0::ClassAlignment>();

const physx::PxU32 NumParamDefs = 47;
...
NxParameterized::MutexType DestructibleActorState_0p0::mBuiltFlagMutex;

DestructibleActorState_0p0::DestructibleActorState_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorState_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorState_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorState_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorState_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorState_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
