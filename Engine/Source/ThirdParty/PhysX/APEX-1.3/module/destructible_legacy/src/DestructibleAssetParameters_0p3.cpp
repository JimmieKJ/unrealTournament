...
const char* const DestructibleAssetParameters_0p3Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p3, DestructibleAssetParameters_0p3::ClassAlignment>();
...
NxParameterized::MutexType DestructibleAssetParameters_0p3::mBuiltFlagMutex;

DestructibleAssetParameters_0p3::DestructibleAssetParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
