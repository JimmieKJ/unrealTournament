...
const char* const DestructibleActorState_0p1Factory::vptr =
    NxParameterized::getVptr<DestructibleActorState_0p1, DestructibleActorState_0p1::ClassAlignment>();

const physx::PxU32 NumParamDefs = 48;
...
NxParameterized::MutexType DestructibleActorState_0p1::mBuiltFlagMutex;

DestructibleActorState_0p1::DestructibleActorState_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorState_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorState_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorState_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorState_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorState_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorState_0p1::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=47, longName="actorChunks"
	{
		...
		ParamDefTable[47].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
