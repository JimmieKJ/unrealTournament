...
using namespace DestructibleActorParam_0p25NS;

const char* const DestructibleActorParam_0p25Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p25, DestructibleActorParam_0p25::ClassAlignment>();

const physx::PxU32 NumParamDefs = 285;
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	126, 155, 172, 195, 221, 234, 238, 261, 18, 20, 24, 25, 26, 27, 28, 29, 30, 31, 32,
	...
	241, 242, 246, 250, 251, 252, 253, 254, 260, 243, 244, 245, 247, 248, 249, 255, 256,
	257, 258, 259, 262, 263, 264, 265, 266, 270, 274, 275, 276, 277, 278, 284, 267, 268,
	269, 271, 272, 273, 279, 280, 281, 282, 283,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->defaultBehaviorGroup), CHILDREN(239), 11 }, // defaultBehaviorGroup
	...
	{ TYPE_STRUCT, false, (size_t)(&((BehaviorGroup_Type*)0)->damageSpread), CHILDREN(250), 3 }, // defaultBehaviorGroup.damageSpread
	...
	{ TYPE_STRUCT, false, (size_t)(&((BehaviorGroup_Type*)0)->damageColorSpread), CHILDREN(253), 3 }, // defaultBehaviorGroup.damageColorSpread
	...
	{ TYPE_STRUCT, false, (size_t)(&((BehaviorGroup_Type*)0)->groupsMask), CHILDREN(256), 5 }, // defaultBehaviorGroup.groupsMask
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->behaviorGroups), CHILDREN(261), 1 }, // behaviorGroups
	{ TYPE_STRUCT, false, 1 * sizeof(BehaviorGroup_Type), CHILDREN(262), 11 }, // behaviorGroups[]
	...
	{ TYPE_STRUCT, false, (size_t)(&((BehaviorGroup_Type*)0)->damageSpread), CHILDREN(273), 3 }, // behaviorGroups[].damageSpread
	...
	{ TYPE_STRUCT, false, (size_t)(&((BehaviorGroup_Type*)0)->damageColorSpread), CHILDREN(276), 3 }, // behaviorGroups[].damageColorSpread
	...
	{ TYPE_STRUCT, false, (size_t)(&((BehaviorGroup_Type*)0)->groupsMask), CHILDREN(279), 5 }, // behaviorGroups[].groupsMask
...
bool DestructibleActorParam_0p25::mBuiltFlag = false;
NxParameterized::MutexType DestructibleActorParam_0p25::mBuiltFlagMutex;

DestructibleActorParam_0p25::DestructibleActorParam_0p25(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleActorParam_0p25FactoryInst);
...
DestructibleActorParam_0p25::~DestructibleActorParam_0p25()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void DestructibleActorParam_0p25::destroy()
{
	...
	this->~DestructibleActorParam_0p25();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* DestructibleActorParam_0p25::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p25::getParameterDefinitionTree(void) const
{
	DestructibleActorParam_0p25* tmpParam = const_cast<DestructibleActorParam_0p25*>(this);
...
NxParameterized::ErrorType DestructibleActorParam_0p25::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p25::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p25::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleActorParam_0p25::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleActorParam_0p25::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p25::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=254, longName="defaultBehaviorGroup.groupsMask"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=255, longName="defaultBehaviorGroup.groupsMask.useGroupsMask"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=256, longName="defaultBehaviorGroup.groupsMask.bits0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=257, longName="defaultBehaviorGroup.groupsMask.bits1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=258, longName="defaultBehaviorGroup.groupsMask.bits2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=259, longName="defaultBehaviorGroup.groupsMask.bits3"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=260, longName="defaultBehaviorGroup.userData"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=261, longName="behaviorGroups"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=263, longName="behaviorGroups[].name"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=264, longName="behaviorGroups[].damageThreshold"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=265, longName="behaviorGroups[].damageToRadius"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=266, longName="behaviorGroups[].damageSpread"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=267, longName="behaviorGroups[].damageSpread.minimumRadius"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=268, longName="behaviorGroups[].damageSpread.radiusMultiplier"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=269, longName="behaviorGroups[].damageSpread.falloffExponent"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=270, longName="behaviorGroups[].damageColorSpread"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=271, longName="behaviorGroups[].damageColorSpread.minimumRadius"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=272, longName="behaviorGroups[].damageColorSpread.radiusMultiplier"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=273, longName="behaviorGroups[].damageColorSpread.falloffExponent"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=274, longName="behaviorGroups[].damageColorChange"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=275, longName="behaviorGroups[].materialStrength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=276, longName="behaviorGroups[].density"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=277, longName="behaviorGroups[].fadeOut"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=278, longName="behaviorGroups[].groupsMask"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=279, longName="behaviorGroups[].groupsMask.useGroupsMask"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=280, longName="behaviorGroups[].groupsMask.bits0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=281, longName="behaviorGroups[].groupsMask.bits1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=282, longName="behaviorGroups[].groupsMask.bits2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=283, longName="behaviorGroups[].groupsMask.bits3"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=284, longName="behaviorGroups[].userData"
	{
	...
	// SetChildren for: nodeIndex=238, longName="defaultBehaviorGroup"
	{
		...
		ParamDefTable[238].setChildren(Children, 11);
	}
	...
	// SetChildren for: nodeIndex=254, longName="defaultBehaviorGroup.groupsMask"
	{
		static Definition* Children[5];
		...
		Children[4] = PDEF_PTR(259);

		ParamDefTable[254].setChildren(Children, 5);
	}

	// SetChildren for: nodeIndex=261, longName="behaviorGroups"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(262);

		ParamDefTable[261].setChildren(Children, 1);
	}
	...
	// SetChildren for: nodeIndex=262, longName="behaviorGroups[]"
	{
		...
		Children[3] = PDEF_PTR(266);
		Children[4] = PDEF_PTR(270);
		Children[5] = PDEF_PTR(274);
		Children[6] = PDEF_PTR(275);
		Children[7] = PDEF_PTR(276);
		Children[8] = PDEF_PTR(277);
		Children[9] = PDEF_PTR(278);
		Children[10] = PDEF_PTR(284);

		ParamDefTable[262].setChildren(Children, 11);
	}

	// SetChildren for: nodeIndex=266, longName="behaviorGroups[].damageSpread"
	{
		static Definition* Children[3];
		...
		ParamDefTable[266].setChildren(Children, 3);
	}

	// SetChildren for: nodeIndex=270, longName="behaviorGroups[].damageColorSpread"
	{
		static Definition* Children[3];
	...
	// SetChildren for: nodeIndex=278, longName="behaviorGroups[].groupsMask"
	{
		static Definition* Children[5];
		Children[0] = PDEF_PTR(279);
		Children[1] = PDEF_PTR(280);
		Children[2] = PDEF_PTR(281);
		Children[3] = PDEF_PTR(282);
		Children[4] = PDEF_PTR(283);

		ParamDefTable[278].setChildren(Children, 5);
	}

	mBuiltFlag = true;

}
void DestructibleActorParam_0p25::initStrings(void)
{
...
void DestructibleActorParam_0p25::initDynamicArrays(void)
{
...
void DestructibleActorParam_0p25::initDefaults(void)
{
...
void DestructibleActorParam_0p25::initReferences(void)
{
}

void DestructibleActorParam_0p25::freeDynamicArrays(void)
{
...
void DestructibleActorParam_0p25::freeStrings(void)
{
...
void DestructibleActorParam_0p25::freeReferences(void)
{
}

NxParameterized::ErrorType DestructibleActorParam_0p25::copy(const NxParameterized::Interface &other)
{
	...
	const DestructibleActorParam_0p25* inParams = (const DestructibleActorParam_0p25*)(&other);
	DestructibleActorParam_0p25* outParams = (DestructibleActorParam_0p25*)(this);
	
	// first, shallow copy the entire class
	physx::PxMemCopy(outParams, inParams, sizeof(DestructibleActorParam_0p25));
