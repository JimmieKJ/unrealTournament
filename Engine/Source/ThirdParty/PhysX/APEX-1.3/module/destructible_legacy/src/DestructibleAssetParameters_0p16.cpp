...
using namespace DestructibleAssetParameters_0p16NS;

const char* const DestructibleAssetParameters_0p16Factory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters_0p16, DestructibleAssetParameters_0p16::ClassAlignment>();

const physx::PxU32 NumParamDefs = 118;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 2, 3, 4, 5, 21, 38, 39, 49, 51, 53, 84, 95, 96, 97, 98, 99, 100, 105, 107, 108,
	110, 112, 113, 114, 115, 116, 6, 7, 8, 9, 13, 17, 18, 19, 20, 10, 11, 12, 14, 15,
	...
	68, 76, 77, 78, 69, 70, 71, 72, 73, 74, 75, 79, 80, 81, 82, 83, 85, 86, 87, 88, 89,
	90, 91, 92, 93, 94, 101, 102, 103, 104, 106, 109, 111, 117,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->destructibleParameters), CHILDREN(69), 18 }, // destructibleParameters
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->flags), CHILDREN(87), 7 }, // destructibleParameters.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((DestructibleParameters_Type*)0)->dynamicChunksGroupsMask), CHILDREN(94), 5 }, // destructibleParameters.dynamicChunksGroupsMask
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->depthParameters), CHILDREN(99), 1 }, // depthParameters
	{ TYPE_STRUCT, false, 1 * sizeof(DestructibleDepthParameters_Type), CHILDREN(100), 9 }, // depthParameters[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->chunkInstanceInfo), CHILDREN(109), 1 }, // chunkInstanceInfo
	{ TYPE_STRUCT, false, 1 * sizeof(InstanceInfo_Type), CHILDREN(110), 3 }, // chunkInstanceInfo[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->staticMaterialNames), CHILDREN(113), 1 }, // staticMaterialNames
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overlapsAtDepth), CHILDREN(114), 1 }, // overlapsAtDepth
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // overlapsAtDepth[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->firstChunkAtDepth), CHILDREN(115), 1 }, // firstChunkAtDepth
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->actorTransforms), CHILDREN(116), 1 }, // actorTransforms
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // actorTransforms[]
};


bool DestructibleAssetParameters_0p16::mBuiltFlag = false;
NxParameterized::MutexType DestructibleAssetParameters_0p16::mBuiltFlagMutex;

DestructibleAssetParameters_0p16::DestructibleAssetParameters_0p16(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleAssetParameters_0p16FactoryInst);
...
DestructibleAssetParameters_0p16::~DestructibleAssetParameters_0p16()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void DestructibleAssetParameters_0p16::destroy()
{
	...
	this->~DestructibleAssetParameters_0p16();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p16::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters_0p16::getParameterDefinitionTree(void) const
{
	DestructibleAssetParameters_0p16* tmpParam = const_cast<DestructibleAssetParameters_0p16*>(this);
...
NxParameterized::ErrorType DestructibleAssetParameters_0p16::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters_0p16::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters_0p16::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleAssetParameters_0p16::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleAssetParameters_0p16::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleAssetParameters_0p16::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=77, longName="destructibleParameters.dynamicChunkDominanceGroup"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=78, longName="destructibleParameters.dynamicChunksGroupsMask"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=79, longName="destructibleParameters.dynamicChunksGroupsMask.useGroupsMask"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=80, longName="destructibleParameters.dynamicChunksGroupsMask.bits0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=81, longName="destructibleParameters.dynamicChunksGroupsMask.bits1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=82, longName="destructibleParameters.dynamicChunksGroupsMask.bits2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=83, longName="destructibleParameters.dynamicChunksGroupsMask.bits3"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=95, longName="crumbleEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=96, longName="dustEmitterName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=97, longName="collisionData"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=98, longName="renderMeshAsset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=99, longName="initialDestructibleActorAllowanceForInstancing"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=100, longName="chunkInstanceInfo"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=102, longName="chunkInstanceInfo[].partIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=103, longName="chunkInstanceInfo[].chunkPositionOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=104, longName="chunkInstanceInfo[].chunkUVOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=105, longName="staticMaterialNames"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=107, longName="neighborPadding"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=108, longName="overlapsAtDepth"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[108].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
		...
		ParamDefTable[108].setHints((const NxParameterized::Hint**)HintPtrTable, 3);

#endif /* NX_PARAMETERIZED_HIDE_DESCRIPTIONS */


		static const char* const RefVariantVals[] = { "CachedOverlaps" };
		ParamDefTable[108].setRefVariantVals((const char**)RefVariantVals, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=110, longName="firstChunkAtDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=112, longName="supportDepth"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=113, longName="formExtendedStructures"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=114, longName="useAssetDefinedSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=115, longName="useWorldSupport"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=116, longName="actorTransforms"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[11] = PDEF_PTR(84);
		Children[12] = PDEF_PTR(95);
		Children[13] = PDEF_PTR(96);
		Children[14] = PDEF_PTR(97);
		Children[15] = PDEF_PTR(98);
		Children[16] = PDEF_PTR(99);
		Children[17] = PDEF_PTR(100);
		Children[18] = PDEF_PTR(105);
		Children[19] = PDEF_PTR(107);
		Children[20] = PDEF_PTR(108);
		Children[21] = PDEF_PTR(110);
		Children[22] = PDEF_PTR(112);
		Children[23] = PDEF_PTR(113);
		Children[24] = PDEF_PTR(114);
		Children[25] = PDEF_PTR(115);
		Children[26] = PDEF_PTR(116);
	...
	// SetChildren for: nodeIndex=53, longName="destructibleParameters"
	{
		...
		ParamDefTable[53].setChildren(Children, 18);
	}
	...
	// SetChildren for: nodeIndex=78, longName="destructibleParameters.dynamicChunksGroupsMask"
	{
		static Definition* Children[5];
		Children[0] = PDEF_PTR(79);
		Children[1] = PDEF_PTR(80);
		Children[2] = PDEF_PTR(81);
		Children[3] = PDEF_PTR(82);
		Children[4] = PDEF_PTR(83);

		ParamDefTable[78].setChildren(Children, 5);
	}
	...
	// SetChildren for: nodeIndex=100, longName="chunkInstanceInfo"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(101);

		ParamDefTable[100].setChildren(Children, 1);
	}
	...
	// SetChildren for: nodeIndex=101, longName="chunkInstanceInfo[]"
	{
		...
		ParamDefTable[101].setChildren(Children, 3);
	}

	// SetChildren for: nodeIndex=105, longName="staticMaterialNames"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=108, longName="overlapsAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=110, longName="firstChunkAtDepth"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=116, longName="actorTransforms"
	{
		static Definition* Children[1];
		Children[0] = PDEF_PTR(117);

		ParamDefTable[116].setChildren(Children, 1);
	}

	mBuiltFlag = true;

}
void DestructibleAssetParameters_0p16::initStrings(void)
{
...
void DestructibleAssetParameters_0p16::initDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p16::initDefaults(void)
{
...
void DestructibleAssetParameters_0p16::initReferences(void)
{
	collisionData = NULL;
...
void DestructibleAssetParameters_0p16::freeDynamicArrays(void)
{
...
void DestructibleAssetParameters_0p16::freeStrings(void)
{
...
void DestructibleAssetParameters_0p16::freeReferences(void)
{
