...
const char* const CachedOverlaps_0p0Factory::vptr =
    NxParameterized::getVptr<CachedOverlaps_0p0, CachedOverlaps_0p0::ClassAlignment>();
...
NxParameterized::MutexType CachedOverlaps_0p0::mBuiltFlagMutex;

CachedOverlaps_0p0::CachedOverlaps_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* CachedOverlaps_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* CachedOverlaps_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType CachedOverlaps_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType CachedOverlaps_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void CachedOverlaps_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
