...
using namespace DestructibleActorParam_0p9NS;

const char* const DestructibleActorParam_0p9Factory::vptr =
    NxParameterized::getVptr<DestructibleActorParam_0p9, DestructibleActorParam_0p9::ClassAlignment>();
...
bool DestructibleActorParam_0p9::mBuiltFlag = false;
NxParameterized::MutexType DestructibleActorParam_0p9::mBuiltFlagMutex;

DestructibleActorParam_0p9::DestructibleActorParam_0p9(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &DestructibleActorParam_0p9FactoryInst);
...
DestructibleActorParam_0p9::~DestructibleActorParam_0p9()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void DestructibleActorParam_0p9::destroy()
{
	...
	this->~DestructibleActorParam_0p9();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* DestructibleActorParam_0p9::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam_0p9::getParameterDefinitionTree(void) const
{
	DestructibleActorParam_0p9* tmpParam = const_cast<DestructibleActorParam_0p9*>(this);
...
NxParameterized::ErrorType DestructibleActorParam_0p9::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam_0p9::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam_0p9::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<DestructibleActorParam_0p9::ParametersStruct*>(&parameters()), handle, offset);
}
...
void DestructibleActorParam_0p9::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void DestructibleActorParam_0p9::buildTree(void)
{
...
void DestructibleActorParam_0p9::initStrings(void)
{
...
void DestructibleActorParam_0p9::initDynamicArrays(void)
{
...
void DestructibleActorParam_0p9::initDefaults(void)
{
...
void DestructibleActorParam_0p9::initReferences(void)
{
}

void DestructibleActorParam_0p9::freeDynamicArrays(void)
{
...
void DestructibleActorParam_0p9::freeStrings(void)
{
...
void DestructibleActorParam_0p9::freeReferences(void)
{
}
