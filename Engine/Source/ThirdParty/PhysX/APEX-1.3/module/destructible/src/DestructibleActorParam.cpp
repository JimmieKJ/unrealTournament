...
const char* const DestructibleActorParamFactory::vptr =
    NxParameterized::getVptr<DestructibleActorParam, DestructibleActorParam::ClassAlignment>();
...
NxParameterized::MutexType DestructibleActorParam::mBuiltFlagMutex;

DestructibleActorParam::DestructibleActorParam(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorParam::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorParam::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorParam::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorParam::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorParam::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
NxParameterized::ErrorType DestructibleActorParam::copy(const NxParameterized::Interface &other)
{
	...
	const DestructibleActorParam* inParams = (const DestructibleActorParam*)(&other);
	DestructibleActorParam* outParams = (DestructibleActorParam*)(this);
	
	// first, shallow copy the entire class
	physx::PxMemCopy(outParams, inParams, sizeof(DestructibleActorParam));
