...
const char* const DestructibleActorStateFactory::vptr =
    NxParameterized::getVptr<DestructibleActorState, DestructibleActorState::ClassAlignment>();
...
NxParameterized::MutexType DestructibleActorState::mBuiltFlagMutex;

DestructibleActorState::DestructibleActorState(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleActorState::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleActorState::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleActorState::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleActorState::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleActorState::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
