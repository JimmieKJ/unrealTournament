...
const char* const SurfaceTraceSetParametersFactory::vptr =
    NxParameterized::getVptr<SurfaceTraceSetParameters, SurfaceTraceSetParameters::ClassAlignment>();
...
NxParameterized::MutexType SurfaceTraceSetParameters::mBuiltFlagMutex;

SurfaceTraceSetParameters::SurfaceTraceSetParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SurfaceTraceSetParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SurfaceTraceSetParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SurfaceTraceSetParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SurfaceTraceSetParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SurfaceTraceSetParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
