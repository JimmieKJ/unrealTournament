...
const char* const DestructibleAssetParametersFactory::vptr =
    NxParameterized::getVptr<DestructibleAssetParameters, DestructibleAssetParameters::ClassAlignment>();
...
NxParameterized::MutexType DestructibleAssetParameters::mBuiltFlagMutex;

DestructibleAssetParameters::DestructibleAssetParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* DestructibleAssetParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType DestructibleAssetParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void DestructibleAssetParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
