...
struct Chunk_Type
{
	physx::PxU8 state;
	physx::PxU8 flags;
	physx::PxU32 islandID;
	physx::PxF32 damage;
	physx::PxVec4 localSphere;
	physx::PxVec3 localOffset;
	physx::PxI32 visibleAncestorIndex;
	physx::PxU32 shapesCount;
...
static const physx::PxU32 checksum[] = { 0x1f4e04ad, 0x95dc5558, 0x4dae15a1, 0x46caf98e, };

} // namespace DestructibleActorChunksNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorChunks : public NxParameterized::NxParameters, public DestructibleActorChunksNS::ParametersStruct
{
public:
	DestructibleActorChunks(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class DestructibleActorChunksFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorChunks::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorChunks");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorChunks)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorChunks)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorChunks::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorChunks::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorChunks");
			return 0;
		}
