...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DestructibleActorState : public NxParameterized::NxParameters, public DestructibleActorStateNS::ParametersStruct
{
public:
	DestructibleActorState(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class DestructibleActorStateFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, DestructibleActorState::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorState");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DestructibleActorState)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DestructibleActorState)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DestructibleActorState::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DestructibleActorState::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DestructibleActorState");
			return 0;
		}
