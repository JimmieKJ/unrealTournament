...
#ifndef NX_FRACTURE_TOOLS_STRUCTS_H
#define NX_FRACTURE_TOOLS_STRUCTS_H
...
*/
struct NxMeshProcessingParameters
{
	/**
...
struct NxSliceParameters
{
	...
	*/
	...
	/** Sets all NxNoiseParameters to their defaults:
		order = XYZ;
...
struct NxCutoutParameters
{
	...
	*/
	NxNoiseParameters	backfaceNoise;
...
/**
	NxFractureCutoutDesc

	Descriptor for cutout-mode (chippable) fracturing.
*/
struct NxFractureCutoutDesc
{
	...
	*/
	...
	NxCutoutParameters cutoutParameters[DirectionCount];
	...
	*/
	...
	NxCutoutParameters userDefinedCutoutParameters;
	...
	*/
	...
	/**
		...
		The cutout function must be provided with a NxFractureSliceDesc as well to describe
...
/**
	NxFractureVoronoiDesc

	Descriptor for Voronoi decomposition fracturing.
*/
struct NxFractureVoronoiDesc
{
	/**
