...
const char* const ClothingActorParam_0p9Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p9, ClothingActorParam_0p9::ClassAlignment>();
...
NxParameterized::MutexType ClothingActorParam_0p9::mBuiltFlagMutex;

ClothingActorParam_0p9::ClothingActorParam_0p9(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p9::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p9::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p9::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p9::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p9::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingActorParam_0p9::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
