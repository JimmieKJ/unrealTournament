...
using namespace ClothingMaterialLibraryParameters_0p7NS;

const char* const ClothingMaterialLibraryParameters_0p7Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p7, ClothingMaterialLibraryParameters_0p7::ClassAlignment>();

const physx::PxU32 NumParamDefs = 34;
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, 1 * sizeof(ClothingMaterial_Type), CHILDREN(2), 23 }, // materials[]
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->verticalStiffnessScaling), CHILDREN(25), 2 }, // materials[].verticalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->horizontalStiffnessScaling), CHILDREN(27), 2 }, // materials[].horizontalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->bendingStiffnessScaling), CHILDREN(29), 2 }, // materials[].bendingStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->shearingStiffnessScaling), CHILDREN(31), 2 }, // materials[].shearingStiffnessScaling
...
bool ClothingMaterialLibraryParameters_0p7::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p7::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p7::ClothingMaterialLibraryParameters_0p7(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p7FactoryInst);
...
ClothingMaterialLibraryParameters_0p7::~ClothingMaterialLibraryParameters_0p7()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p7::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p7();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p7::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p7::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p7* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p7*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p7::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p7::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p7::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p7::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p7::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p7::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="materials[].solverIterations"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="materials[].solverFrequency"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=29, longName="materials[].gravityScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=30, longName="materials[].inertiaScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="materials[].hardStretchLimitation"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=32, longName="materials[].maxDistanceBias"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=33, longName="materials[].hierarchicalSolverIterations"
	{
	...
	// SetChildren for: nodeIndex=2, longName="materials[]"
	{
		...
		ParamDefTable[2].setChildren(Children, 23);
	}
...
void ClothingMaterialLibraryParameters_0p7::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p7::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p7::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p7::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p7::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p7::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p7::freeReferences(void)
{
}
