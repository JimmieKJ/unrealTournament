...
const char* const ClothingMaterialLibraryParameters_0p10Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p10, ClothingMaterialLibraryParameters_0p10::ClassAlignment>();
...
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p10::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p10::ClothingMaterialLibraryParameters_0p10(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p10::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p10::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p10::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p10::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p10::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
