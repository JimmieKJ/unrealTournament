...
using namespace ClothingActorParam_0p2NS;

const char* const ClothingActorParam_0p2Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p2, ClothingActorParam_0p2::ClassAlignment>();

const physx::PxU32 NumParamDefs = 66;
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	4, 5, 6, 7, 8, 17, 18, 19, 20, 22, 23, 25, 26, 29, 31, 32, 33, 38, 39, 40, 34, 35,
	36, 37, 42, 48, 49, 54, 55, 56, 43, 44, 45, 46, 47, 50, 51, 52, 53, 58, 59, 63, 65,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(22), 5 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(27), 4 }, // lodWeights
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->windParams), CHILDREN(31), 2 }, // windParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->maxDistanceScale), CHILDREN(33), 2 }, // maxDistanceScale
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneMatrices), CHILDREN(35), 1 }, // boneMatrices
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // boneMatrices[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->clothDescTemplate), CHILDREN(36), 6 }, // clothDescTemplate
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothDescTemplate_Type*)0)->groupsMask), CHILDREN(42), 4 }, // clothDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->shapeDescTemplate), CHILDREN(46), 6 }, // shapeDescTemplate
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->flags), CHILDREN(52), 5 }, // shapeDescTemplate.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->groupsMask), CHILDREN(57), 4 }, // shapeDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->actorDescTemplate), CHILDREN(61), 2 }, // actorDescTemplate
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphDisplacements), CHILDREN(63), 1 }, // morphDisplacements
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphDisplacements[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphPhysicalMeshNewPositions), CHILDREN(64), 1 }, // morphPhysicalMeshNewPositions
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphPhysicalMeshNewPositions[]
};


bool ClothingActorParam_0p2::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p2::mBuiltFlagMutex;

ClothingActorParam_0p2::ClothingActorParam_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p2FactoryInst);
...
ClothingActorParam_0p2::~ClothingActorParam_0p2()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p2::destroy()
{
	...
	this->~ClothingActorParam_0p2();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p2::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p2* tmpParam = const_cast<ClothingActorParam_0p2*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p2::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p2::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingActorParam_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p2::buildTree(void)
{
...
void ClothingActorParam_0p2::initStrings(void)
{
}

void ClothingActorParam_0p2::initDynamicArrays(void)
{
...
void ClothingActorParam_0p2::initDefaults(void)
{
...
void ClothingActorParam_0p2::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p2::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p2::freeStrings(void)
{
}

void ClothingActorParam_0p2::freeReferences(void)
{
	if (runtimeCooked)
	{
