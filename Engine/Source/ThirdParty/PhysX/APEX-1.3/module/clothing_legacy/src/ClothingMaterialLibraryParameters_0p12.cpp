...
using namespace ClothingMaterialLibraryParameters_0p12NS;

const char* const ClothingMaterialLibraryParameters_0p12Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p12, ClothingMaterialLibraryParameters_0p12::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	36, 37, 38, 39, 40, 41, 42, 13, 14, 15, 17, 18, 19, 21, 22, 23, 25, 26, 27,
};
...
bool ClothingMaterialLibraryParameters_0p12::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p12::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p12::ClothingMaterialLibraryParameters_0p12(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p12FactoryInst);
...
ClothingMaterialLibraryParameters_0p12::~ClothingMaterialLibraryParameters_0p12()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p12::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p12();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p12::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p12::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p12* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p12*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p12::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p12::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p12::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p12::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p12::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p12::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=39, longName="materials[].maxDistanceBias"
	{
		...
		ParamDefTable[39].setHints((const NxParameterized::Hint**)HintPtrTable, 4);
...
void ClothingMaterialLibraryParameters_0p12::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p12::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p12::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p12::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p12::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p12::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p12::freeReferences(void)
{
}
