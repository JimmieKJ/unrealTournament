...
using namespace ClothingPhysicalMeshParameters_0p2NS;

const char* const ClothingPhysicalMeshParameters_0p2Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p2, ClothingPhysicalMeshParameters_0p2::ClassAlignment>();

const physx::PxU32 NumParamDefs = 78;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 29, 36, 38, 39, 45, 53, 59, 60, 61, 69, 75, 76, 77, 2, 3, 4, 5, 7, 9, 11, 13,
	18, 20, 22, 24, 25, 26, 27, 28, 6, 8, 10, 12, 14, 15, 16, 17, 19, 21, 23, 30, 31,
	32, 33, 34, 35, 37, 40, 41, 42, 43, 44, 46, 47, 48, 49, 50, 51, 52, 54, 55, 56, 57,
	58, 62, 63, 64, 65, 66, 67, 68, 70, 71, 72, 73, 74,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->physicalMesh), CHILDREN(14), 16 }, // physicalMesh
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->vertices), CHILDREN(30), 1 }, // physicalMesh.vertices
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.vertices[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->normals), CHILDREN(31), 1 }, // physicalMesh.normals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.normals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->skinningNormals), CHILDREN(32), 1 }, // physicalMesh.skinningNormals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.skinningNormals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->vertexFlags), CHILDREN(33), 1 }, // physicalMesh.vertexFlags
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // physicalMesh.vertexFlags[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->indices), CHILDREN(40), 1 }, // physicalMesh.indices
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->submeshes), CHILDREN(41), 1 }, // submeshes
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalSubmesh_Type), CHILDREN(42), 5 }, // submeshes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->deformableCookedData), CHILDREN(47), 1 }, // deformableCookedData
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicalLods), CHILDREN(48), 1 }, // physicalLods
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalLod_Type), CHILDREN(49), 4 }, // physicalLods[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpB), CHILDREN(53), 1 }, // transitionUpB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(54), 6 }, // transitionUpB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpC), CHILDREN(60), 1 }, // transitionUpC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(61), 4 }, // transitionUpC[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownB), CHILDREN(65), 1 }, // transitionDownB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(66), 6 }, // transitionDownB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownC), CHILDREN(72), 1 }, // transitionDownC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(73), 4 }, // transitionDownC[]
...
bool ClothingPhysicalMeshParameters_0p2::mBuiltFlag = false;
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p2::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p2::ClothingPhysicalMeshParameters_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingPhysicalMeshParameters_0p2FactoryInst);
...
ClothingPhysicalMeshParameters_0p2::~ClothingPhysicalMeshParameters_0p2()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingPhysicalMeshParameters_0p2::destroy()
{
	...
	this->~ClothingPhysicalMeshParameters_0p2();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p2::getParameterDefinitionTree(void) const
{
	ClothingPhysicalMeshParameters_0p2* tmpParam = const_cast<ClothingPhysicalMeshParameters_0p2*>(this);
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p2::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p2::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingPhysicalMeshParameters_0p2::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="physicalMesh.flipNormals"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="submeshes[].numIndices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=32, longName="submeshes[].numVertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=33, longName="submeshes[].cookedDataOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="submeshes[].cookedDataLength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="submeshes[].nxDeformableMesh"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="deformableCookedData[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="deformableCookedDataVersion"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="physicalLods[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=41, longName="physicalLods[].costWithoutIterations"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=42, longName="physicalLods[].submeshId"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=43, longName="physicalLods[].solverIterationScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=44, longName="physicalLods[].maxDistanceReduction"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=46, longName="transitionUpB[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=47, longName="transitionUpB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=48, longName="transitionUpB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=49, longName="transitionUpB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=50, longName="transitionUpB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=51, longName="transitionUpB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=52, longName="transitionUpB[].submeshIndex"
	{
		...
		ParamDefTable[52].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=54, longName="transitionUpC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=55, longName="transitionUpC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=56, longName="transitionUpC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=57, longName="transitionUpC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=58, longName="transitionUpC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=59, longName="transitionUpThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=60, longName="transitionUpOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=63, longName="transitionDownB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=64, longName="transitionDownB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=65, longName="transitionDownB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=66, longName="transitionDownB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=67, longName="transitionDownB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=68, longName="transitionDownB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=70, longName="transitionDownC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=71, longName="transitionDownC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=72, longName="transitionDownC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=73, longName="transitionDownC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=74, longName="transitionDownC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=75, longName="transitionDownThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=76, longName="transitionDownOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=77, longName="referenceCount"
	{
	...
	// SetChildren for: nodeIndex=1, longName="physicalMesh"
	{
		...
		ParamDefTable[1].setChildren(Children, 16);
	}
	...
	// SetChildren for: nodeIndex=30, longName="submeshes[]"
	{
		...
		ParamDefTable[30].setChildren(Children, 5);
	}

	// SetChildren for: nodeIndex=36, longName="deformableCookedData"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=40, longName="physicalLods[]"
	{
		...
		ParamDefTable[40].setChildren(Children, 4);
	}
	...
	// SetChildren for: nodeIndex=45, longName="transitionUpB"
	{
		...
		ParamDefTable[45].setChildren(Children, 1);
	}

	// SetChildren for: nodeIndex=46, longName="transitionUpB[]"
	{
		...
		Children[5] = PDEF_PTR(52);

		ParamDefTable[46].setChildren(Children, 6);
	}
	...
	// SetChildren for: nodeIndex=54, longName="transitionUpC[]"
	{
		static Definition* Children[4];
	...
	// SetChildren for: nodeIndex=62, longName="transitionDownB[]"
	{
		...
		ParamDefTable[62].setChildren(Children, 6);
	}
	...
	// SetChildren for: nodeIndex=70, longName="transitionDownC[]"
	{
		static Definition* Children[4];
		...
		ParamDefTable[70].setChildren(Children, 4);
	}

	mBuiltFlag = true;

}
void ClothingPhysicalMeshParameters_0p2::initStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p2::initDynamicArrays(void)
{
	...
	physicalMesh.vertexFlags.elementSize = sizeof(physx::PxU32);
...
void ClothingPhysicalMeshParameters_0p2::initDefaults(void)
{
	...
	deformableCookedDataVersion = physx::PxU32(0);
...
void ClothingPhysicalMeshParameters_0p2::initReferences(void)
{
}

void ClothingPhysicalMeshParameters_0p2::freeDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p2::freeStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p2::freeReferences(void)
{
}
