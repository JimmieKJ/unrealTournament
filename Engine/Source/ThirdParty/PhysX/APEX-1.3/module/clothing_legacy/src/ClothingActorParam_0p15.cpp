...
const char* const ClothingActorParam_0p15Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p15, ClothingActorParam_0p15::ClassAlignment>();
...
NxParameterized::MutexType ClothingActorParam_0p15::mBuiltFlagMutex;

ClothingActorParam_0p15::ClothingActorParam_0p15(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p15::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p15::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p15::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p15::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p15::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
