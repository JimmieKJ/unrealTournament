...
const char* const ClothingCookedPhysX3Param_0p0Factory::vptr =
    NxParameterized::getVptr<ClothingCookedPhysX3Param_0p0, ClothingCookedPhysX3Param_0p0::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // deformableFibers[]
...
NxParameterized::MutexType ClothingCookedPhysX3Param_0p0::mBuiltFlagMutex;

ClothingCookedPhysX3Param_0p0::ClothingCookedPhysX3Param_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingCookedPhysX3Param_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingCookedPhysX3Param_0p0::initDynamicArrays(void)
{
	...
	deformableFibers.elementSize = sizeof(physx::PxU32);
