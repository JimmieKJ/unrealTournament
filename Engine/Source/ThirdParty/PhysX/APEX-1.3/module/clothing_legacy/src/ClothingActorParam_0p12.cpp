...
using namespace ClothingActorParam_0p12NS;

const char* const ClothingActorParam_0p12Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p12, ClothingActorParam_0p12::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	65, 67, 68, 69, 70, 71, 72, 74, 75, 4, 5, 6, 7, 16, 17, 18, 19, 21, 22, 24, 25, 28,
	30, 31, 32, 37, 38, 39, 33, 34, 35, 36, 41, 47, 48, 53, 54, 55, 42, 43, 44, 45, 46,
	49, 50, 51, 52, 57, 58, 62, 64, 66, 73,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(31), 4 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(35), 4 }, // lodWeights
...
bool ClothingActorParam_0p12::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p12::mBuiltFlagMutex;

ClothingActorParam_0p12::ClothingActorParam_0p12(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p12FactoryInst);
...
ClothingActorParam_0p12::~ClothingActorParam_0p12()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p12::destroy()
{
	...
	this->~ClothingActorParam_0p12();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p12::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p12::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p12* tmpParam = const_cast<ClothingActorParam_0p12*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p12::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p12::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p12::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p12::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingActorParam_0p12::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p12::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=75, longName="freezeByLOD"
	{
...
void ClothingActorParam_0p12::initStrings(void)
{
	simulationBackend.isAllocated = false;
	simulationBackend.buf = (const char*)"PhysX";
}

void ClothingActorParam_0p12::initDynamicArrays(void)
{
...
void ClothingActorParam_0p12::initDefaults(void)
{
...
void ClothingActorParam_0p12::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p12::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p12::freeStrings(void)
{
...
void ClothingActorParam_0p12::freeReferences(void)
{
	if (runtimeCooked)
	{
