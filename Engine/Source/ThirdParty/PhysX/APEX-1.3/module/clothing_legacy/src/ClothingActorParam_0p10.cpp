...
using namespace ClothingActorParam_0p10NS;

const char* const ClothingActorParam_0p10Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p10, ClothingActorParam_0p10::ClassAlignment>();

const physx::PxU32 NumParamDefs = 73;
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	65, 66, 67, 68, 69, 70, 72, 4, 5, 6, 7, 16, 17, 18, 19, 21, 22, 24, 25, 28, 30, 31,
	32, 37, 38, 39, 33, 34, 35, 36, 41, 47, 48, 53, 54, 55, 42, 43, 44, 45, 46, 49, 50,
	51, 52, 57, 58, 62, 64, 71,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(29), 4 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(33), 4 }, // lodWeights
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->windParams), CHILDREN(37), 2 }, // windParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->maxDistanceScale), CHILDREN(39), 2 }, // maxDistanceScale
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneMatrices), CHILDREN(41), 1 }, // boneMatrices
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // boneMatrices[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->clothDescTemplate), CHILDREN(42), 6 }, // clothDescTemplate
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothDescTemplate_Type*)0)->groupsMask), CHILDREN(48), 4 }, // clothDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->shapeDescTemplate), CHILDREN(52), 6 }, // shapeDescTemplate
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->flags), CHILDREN(58), 5 }, // shapeDescTemplate.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->groupsMask), CHILDREN(63), 4 }, // shapeDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->actorDescTemplate), CHILDREN(67), 2 }, // actorDescTemplate
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphDisplacements), CHILDREN(69), 1 }, // morphDisplacements
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphDisplacements[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphPhysicalMeshNewPositions), CHILDREN(70), 1 }, // morphPhysicalMeshNewPositions
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overrideMaterialNames), CHILDREN(71), 1 }, // overrideMaterialNames
...
bool ClothingActorParam_0p10::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p10::mBuiltFlagMutex;

ClothingActorParam_0p10::ClothingActorParam_0p10(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p10FactoryInst);
...
ClothingActorParam_0p10::~ClothingActorParam_0p10()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p10::destroy()
{
	...
	this->~ClothingActorParam_0p10();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p10::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p10::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p10* tmpParam = const_cast<ClothingActorParam_0p10*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p10::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p10::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p10::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p10::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingActorParam_0p10::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p10::buildTree(void)
{
...
void ClothingActorParam_0p10::initStrings(void)
{
	simulationBackend.isAllocated = false;
	simulationBackend.buf = (const char*)"PhysX";
}

void ClothingActorParam_0p10::initDynamicArrays(void)
{
...
void ClothingActorParam_0p10::initDefaults(void)
{
...
void ClothingActorParam_0p10::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p10::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p10::freeStrings(void)
{
...
void ClothingActorParam_0p10::freeReferences(void)
{
	if (runtimeCooked)
	{
