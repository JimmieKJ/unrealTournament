...
using namespace ClothingGraphicalLodParameters_0p3NS;

const char* const ClothingGraphicalLodParameters_0p3Factory::vptr =
    NxParameterized::getVptr<ClothingGraphicalLodParameters_0p3, ClothingGraphicalLodParameters_0p3::ClassAlignment>();
...
{
	1, 3, 4, 5, 6, 7, 9, 17, 23, 24, 25, 31, 32, 2, 8, 10, 11, 12, 13, 14, 15, 16, 18,
	19, 20, 21, 22, 26, 27, 28, 29, 30, 33, 34, 35, 36, 37, 38,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRING, false, 1 * sizeof(NxParameterized::DummyStringStruct), NULL, 0 }, // platforms[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->skinClothMapC), CHILDREN(22), 1 }, // skinClothMapC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(23), 4 }, // skinClothMapC[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->tetraMap), CHILDREN(27), 1 }, // tetraMap
	{ TYPE_STRUCT, false, 1 * sizeof(TetraLink_Type), CHILDREN(28), 4 }, // tetraMap[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicsSubmeshPartitioning), CHILDREN(32), 1 }, // physicsSubmeshPartitioning
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicsSubmeshPartitioning_Type), CHILDREN(33), 5 }, // physicsSubmeshPartitioning[]
	{ TYPE_U32, false, (size_t)(&((PhysicsSubmeshPartitioning_Type*)0)->graphicalSubmesh), NULL, 0 }, // physicsSubmeshPartitioning[].graphicalSubmesh
	{ TYPE_U32, false, (size_t)(&((PhysicsSubmeshPartitioning_Type*)0)->physicalSubmesh), NULL, 0 }, // physicsSubmeshPartitioning[].physicalSubmesh
	{ TYPE_U32, false, (size_t)(&((PhysicsSubmeshPartitioning_Type*)0)->numSimulatedVertices), NULL, 0 }, // physicsSubmeshPartitioning[].numSimulatedVertices
	{ TYPE_U32, false, (size_t)(&((PhysicsSubmeshPartitioning_Type*)0)->numSimulatedVerticesAdditional), NULL, 0 }, // physicsSubmeshPartitioning[].numSimulatedVerticesAdditional
	{ TYPE_U32, false, (size_t)(&((PhysicsSubmeshPartitioning_Type*)0)->numSimulatedIndices), NULL, 0 }, // physicsSubmeshPartitioning[].numSimulatedIndices
};


bool ClothingGraphicalLodParameters_0p3::mBuiltFlag = false;
NxParameterized::MutexType ClothingGraphicalLodParameters_0p3::mBuiltFlagMutex;

ClothingGraphicalLodParameters_0p3::ClothingGraphicalLodParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingGraphicalLodParameters_0p3FactoryInst);
...
ClothingGraphicalLodParameters_0p3::~ClothingGraphicalLodParameters_0p3()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingGraphicalLodParameters_0p3::destroy()
{
	...
	this->~ClothingGraphicalLodParameters_0p3();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p3::getParameterDefinitionTree(void) const
{
	ClothingGraphicalLodParameters_0p3* tmpParam = const_cast<ClothingGraphicalLodParameters_0p3*>(this);
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingGraphicalLodParameters_0p3::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingGraphicalLodParameters_0p3::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingGraphicalLodParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingGraphicalLodParameters_0p3::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="renderMeshAssetSorting"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=32, longName="physicsSubmeshPartitioning"
	{
		NxParameterized::DefinitionImpl* ParamDef = &ParamDefTable[32];
		ParamDef->init("physicsSubmeshPartitioning", TYPE_ARRAY, NULL, true);
	...
	// Initialize DefinitionImpl node: nodeIndex=33, longName="physicsSubmeshPartitioning[]"
	{
		NxParameterized::DefinitionImpl* ParamDef = &ParamDefTable[33];
		ParamDef->init("physicsSubmeshPartitioning", TYPE_STRUCT, "PhysicsSubmeshPartitioning", true);
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="physicsSubmeshPartitioning[].graphicalSubmesh"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="physicsSubmeshPartitioning[].physicalSubmesh"
	{
		NxParameterized::DefinitionImpl* ParamDef = &ParamDefTable[35];
		ParamDef->init("physicalSubmesh", TYPE_U32, NULL, true);
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="physicsSubmeshPartitioning[].numSimulatedVertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="physicsSubmeshPartitioning[].numSimulatedVerticesAdditional"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="physicsSubmeshPartitioning[].numSimulatedIndices"
	{
	...
	// SetChildren for: nodeIndex=32, longName="physicsSubmeshPartitioning"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=33, longName="physicsSubmeshPartitioning[]"
	{
		...
		ParamDefTable[33].setChildren(Children, 5);
	}

	mBuiltFlag = true;

}
void ClothingGraphicalLodParameters_0p3::initStrings(void)
{
}

void ClothingGraphicalLodParameters_0p3::initDynamicArrays(void)
{
	platforms.buf = NULL;
	platforms.isAllocated = true;
	platforms.elementSize = sizeof(NxParameterized::DummyStringStruct);
	...
	physicsSubmeshPartitioning.buf = NULL;
	physicsSubmeshPartitioning.isAllocated = true;
	physicsSubmeshPartitioning.elementSize = sizeof(PhysicsSubmeshPartitioning_Type);
	physicsSubmeshPartitioning.arraySizes[0] = 0;
}

void ClothingGraphicalLodParameters_0p3::initDefaults(void)
{
	...
	renderMeshAssetSorting = physx::PxU32(0);
...
void ClothingGraphicalLodParameters_0p3::initReferences(void)
{
	renderMeshAsset = NULL;

}

void ClothingGraphicalLodParameters_0p3::freeDynamicArrays(void)
{
	...
	if (physicsSubmeshPartitioning.isAllocated && physicsSubmeshPartitioning.buf)
	{
		mParameterizedTraits->free(physicsSubmeshPartitioning.buf);
	}
}

void ClothingGraphicalLodParameters_0p3::freeStrings(void)
{
...
void ClothingGraphicalLodParameters_0p3::freeReferences(void)
{
	if (renderMeshAsset)
	{
