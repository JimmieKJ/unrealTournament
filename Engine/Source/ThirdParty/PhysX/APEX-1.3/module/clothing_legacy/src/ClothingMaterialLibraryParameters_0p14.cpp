...
using namespace ClothingMaterialLibraryParameters_0p14NS;

const char* const ClothingMaterialLibraryParameters_0p14Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p14, ClothingMaterialLibraryParameters_0p14::ClassAlignment>();
...
bool ClothingMaterialLibraryParameters_0p14::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p14::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p14::ClothingMaterialLibraryParameters_0p14(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p14FactoryInst);
...
ClothingMaterialLibraryParameters_0p14::~ClothingMaterialLibraryParameters_0p14()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p14::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p14();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p14::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p14::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p14* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p14*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p14::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p14::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p14::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p14::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p14::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p14::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=13, longName="materials[].verticalStiffnessScaling.stretchRange"
	{
		...
		static HintImpl HintTable[1];
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("min", physx::PxF64(1.0), true);
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="materials[].inertiaScale"
	{
		...
		ParamDefTable[36].setHints((const NxParameterized::Hint**)HintPtrTable, 4);
...
void ClothingMaterialLibraryParameters_0p14::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p14::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p14::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p14::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p14::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p14::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p14::freeReferences(void)
{
}
