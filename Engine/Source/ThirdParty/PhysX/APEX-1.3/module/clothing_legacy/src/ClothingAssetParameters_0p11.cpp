...
using namespace ClothingAssetParameters_0p11NS;

const char* const ClothingAssetParameters_0p11Factory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters_0p11, ClothingAssetParameters_0p11::ClassAlignment>();
...
bool ClothingAssetParameters_0p11::mBuiltFlag = false;
NxParameterized::MutexType ClothingAssetParameters_0p11::mBuiltFlagMutex;

ClothingAssetParameters_0p11::ClothingAssetParameters_0p11(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingAssetParameters_0p11FactoryInst);
...
ClothingAssetParameters_0p11::~ClothingAssetParameters_0p11()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingAssetParameters_0p11::destroy()
{
	...
	this->~ClothingAssetParameters_0p11();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p11::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p11::getParameterDefinitionTree(void) const
{
	ClothingAssetParameters_0p11* tmpParam = const_cast<ClothingAssetParameters_0p11*>(this);
...
NxParameterized::ErrorType ClothingAssetParameters_0p11::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p11::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters_0p11::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingAssetParameters_0p11::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingAssetParameters_0p11::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingAssetParameters_0p11::buildTree(void)
{
...
void ClothingAssetParameters_0p11::initStrings(void)
{
	toolString.isAllocated = true;
	toolString.buf = NULL;
}

void ClothingAssetParameters_0p11::initDynamicArrays(void)
{
...
void ClothingAssetParameters_0p11::initDefaults(void)
{
...
void ClothingAssetParameters_0p11::initReferences(void)
{
	materialLibrary = NULL;

}

void ClothingAssetParameters_0p11::freeDynamicArrays(void)
{
...
void ClothingAssetParameters_0p11::freeStrings(void)
{
...
void ClothingAssetParameters_0p11::freeReferences(void)
{
