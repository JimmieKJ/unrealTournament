...
using namespace ClothingAssetParameters_0p3NS;

const char* const ClothingAssetParameters_0p3Factory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters_0p3, ClothingAssetParameters_0p3::ClassAlignment>();
...
{
	1, 3, 5, 6, 7, 8, 9, 10, 11, 12, 13, 22, 23, 24, 32, 34, 38, 39, 40, 2, 4, 14, 15,
	16, 17, 18, 19, 20, 21, 25, 26, 27, 28, 29, 30, 31, 33, 35, 36, 37,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->cookedData), CHILDREN(37), 1 }, // cookedData
	{ TYPE_STRUCT, false, 1 * sizeof(CookedEntry_Type), CHILDREN(38), 2 }, // cookedData[]
...
bool ClothingAssetParameters_0p3::mBuiltFlag = false;
NxParameterized::MutexType ClothingAssetParameters_0p3::mBuiltFlagMutex;

ClothingAssetParameters_0p3::ClothingAssetParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingAssetParameters_0p3FactoryInst);
...
ClothingAssetParameters_0p3::~ClothingAssetParameters_0p3()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingAssetParameters_0p3::destroy()
{
	...
	this->~ClothingAssetParameters_0p3();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p3::getParameterDefinitionTree(void) const
{
	ClothingAssetParameters_0p3* tmpParam = const_cast<ClothingAssetParameters_0p3*>(this);
...
NxParameterized::ErrorType ClothingAssetParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters_0p3::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingAssetParameters_0p3::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingAssetParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingAssetParameters_0p3::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="cookedData"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="cookedData[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="cookedData[].scale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="cookedData[].cookedData"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="boundingBox"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=39, longName="materialLibrary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="materialIndex"
	{
	...
	// SetChildren for: nodeIndex=34, longName="cookedData"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=35, longName="cookedData[]"
	{
		static Definition* Children[2];
		Children[0] = PDEF_PTR(36);
		Children[1] = PDEF_PTR(37);

		ParamDefTable[35].setChildren(Children, 2);
	}

	mBuiltFlag = true;

}
void ClothingAssetParameters_0p3::initStrings(void)
{
}

void ClothingAssetParameters_0p3::initDynamicArrays(void)
{
...
void ClothingAssetParameters_0p3::initDefaults(void)
{
...
void ClothingAssetParameters_0p3::initReferences(void)
{
	materialLibrary = NULL;

}

void ClothingAssetParameters_0p3::freeDynamicArrays(void)
{
...
void ClothingAssetParameters_0p3::freeStrings(void)
{
...
void ClothingAssetParameters_0p3::freeReferences(void)
{
