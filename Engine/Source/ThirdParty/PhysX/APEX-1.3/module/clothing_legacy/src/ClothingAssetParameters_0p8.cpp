...
const char* const ClothingAssetParameters_0p8Factory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters_0p8, ClothingAssetParameters_0p8::ClassAlignment>();

const physx::PxU32 NumParamDefs = 53;
...
NxParameterized::MutexType ClothingAssetParameters_0p8::mBuiltFlagMutex;

ClothingAssetParameters_0p8::ClothingAssetParameters_0p8(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p8::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p8::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p8::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p8::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters_0p8::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
