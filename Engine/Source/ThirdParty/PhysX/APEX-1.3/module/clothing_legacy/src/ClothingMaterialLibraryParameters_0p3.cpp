...
using namespace ClothingMaterialLibraryParameters_0p3NS;

const char* const ClothingMaterialLibraryParameters_0p3Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p3, ClothingMaterialLibraryParameters_0p3::ClassAlignment>();
...
{
	1, 2, 3, 4, 5, 6, 7, 8, 9, 12, 15, 18, 19, 20, 21, 22, 23, 24, 25, 26, 10, 11, 13,
	14, 16, 17,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, 1 * sizeof(ClothingMaterial_Type), CHILDREN(2), 18 }, // materials[]
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->stretchingLimit), CHILDREN(20), 2 }, // materials[].stretchingLimit
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->bendingLimit), CHILDREN(22), 2 }, // materials[].bendingLimit
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->shearingLimit), CHILDREN(24), 2 }, // materials[].shearingLimit
...
bool ClothingMaterialLibraryParameters_0p3::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p3::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p3::ClothingMaterialLibraryParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p3FactoryInst);
...
ClothingMaterialLibraryParameters_0p3::~ClothingMaterialLibraryParameters_0p3()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p3::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p3();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p3::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p3* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p3*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p3::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p3::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p3::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=23, longName="materials[].inertiaScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=24, longName="materials[].hardStretchLimitation"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=25, longName="materials[].maxDistanceBias"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=26, longName="materials[].hierarchicalSolverIterations"
	{
	...
	// SetChildren for: nodeIndex=2, longName="materials[]"
	{
		...
		ParamDefTable[2].setChildren(Children, 18);
	}
...
void ClothingMaterialLibraryParameters_0p3::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p3::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p3::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p3::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p3::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p3::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p3::freeReferences(void)
{
}
