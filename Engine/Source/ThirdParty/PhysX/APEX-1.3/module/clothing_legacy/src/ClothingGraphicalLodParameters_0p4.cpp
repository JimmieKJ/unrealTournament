...
using namespace ClothingGraphicalLodParameters_0p4NS;

const char* const ClothingGraphicalLodParameters_0p4Factory::vptr =
    NxParameterized::getVptr<ClothingGraphicalLodParameters_0p4, ClothingGraphicalLodParameters_0p4::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	19, 20, 21, 22, 23, 24, 25, 29, 30, 31, 32, 33, 36, 37, 38, 39, 40, 41,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicsSubmeshPartitioning), CHILDREN(35), 1 }, // physicsSubmeshPartitioning
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicsSubmeshPartitioning_Type), CHILDREN(36), 5 }, // physicsSubmeshPartitioning[]
...
bool ClothingGraphicalLodParameters_0p4::mBuiltFlag = false;
NxParameterized::MutexType ClothingGraphicalLodParameters_0p4::mBuiltFlagMutex;

ClothingGraphicalLodParameters_0p4::ClothingGraphicalLodParameters_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingGraphicalLodParameters_0p4FactoryInst);
...
ClothingGraphicalLodParameters_0p4::~ClothingGraphicalLodParameters_0p4()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingGraphicalLodParameters_0p4::destroy()
{
	...
	this->~ClothingGraphicalLodParameters_0p4();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p4::getParameterDefinitionTree(void) const
{
	ClothingGraphicalLodParameters_0p4* tmpParam = const_cast<ClothingGraphicalLodParameters_0p4*>(this);
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingGraphicalLodParameters_0p4::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingGraphicalLodParameters_0p4::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingGraphicalLodParameters_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingGraphicalLodParameters_0p4::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="physicsSubmeshPartitioning"
	{
		...
		static HintImpl HintTable[1];
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "Physics submesh partitioning", true);
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="physicsSubmeshPartitioning[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="physicsSubmeshPartitioning[].graphicalSubmesh"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="physicsSubmeshPartitioning[].physicalSubmesh"
	{
		...
		static HintImpl HintTable[1];
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "Physical submesh", true);
	...
	// Initialize DefinitionImpl node: nodeIndex=39, longName="physicsSubmeshPartitioning[].numSimulatedVertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="physicsSubmeshPartitioning[].numSimulatedVerticesAdditional"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=41, longName="physicsSubmeshPartitioning[].numSimulatedIndices"
	{
	...
	// SetChildren for: nodeIndex=35, longName="physicsSubmeshPartitioning"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=36, longName="physicsSubmeshPartitioning[]"
	{
		...
		ParamDefTable[36].setChildren(Children, 5);
	}

	mBuiltFlag = true;

}
void ClothingGraphicalLodParameters_0p4::initStrings(void)
{
}

void ClothingGraphicalLodParameters_0p4::initDynamicArrays(void)
{
	platforms.buf = NULL;
...
void ClothingGraphicalLodParameters_0p4::initDefaults(void)
{
...
void ClothingGraphicalLodParameters_0p4::initReferences(void)
{
	renderMeshAsset = NULL;

}

void ClothingGraphicalLodParameters_0p4::freeDynamicArrays(void)
{
...
void ClothingGraphicalLodParameters_0p4::freeStrings(void)
{
...
void ClothingGraphicalLodParameters_0p4::freeReferences(void)
{
	if (renderMeshAsset)
	{
