...
using namespace ClothingPhysicalMeshParameters_0p10NS;

const char* const ClothingPhysicalMeshParameters_0p10Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p10, ClothingPhysicalMeshParameters_0p10::ClassAlignment>();

const physx::PxU32 NumParamDefs = 82;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 32, 37, 43, 51, 60, 61, 62, 70, 79, 80, 81, 2, 3, 4, 5, 7, 9, 11, 16, 18, 20,
	22, 23, 24, 26, 27, 28, 29, 30, 31, 6, 8, 10, 12, 13, 14, 15, 17, 19, 21, 25, 33,
	34, 35, 36, 38, 39, 40, 41, 42, 44, 45, 46, 47, 48, 49, 50, 52, 53, 54, 55, 56, 57,
	58, 59, 63, 64, 65, 66, 67, 68, 69, 71, 72, 73, 74, 75, 76, 77, 78,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->physicalMesh), CHILDREN(12), 19 }, // physicalMesh
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->vertices), CHILDREN(31), 1 }, // physicalMesh.vertices
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.vertices[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->normals), CHILDREN(32), 1 }, // physicalMesh.normals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.normals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->skinningNormals), CHILDREN(33), 1 }, // physicalMesh.skinningNormals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.skinningNormals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->constrainCoefficients), CHILDREN(34), 1 }, // physicalMesh.constrainCoefficients
	{ TYPE_STRUCT, false, 1 * sizeof(ConstrainCoefficient_Type), CHILDREN(35), 3 }, // physicalMesh.constrainCoefficients[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->boneIndices), CHILDREN(38), 1 }, // physicalMesh.boneIndices
	{ TYPE_U16, false, 1 * sizeof(physx::PxU16), NULL, 0 }, // physicalMesh.boneIndices[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->boneWeights), CHILDREN(39), 1 }, // physicalMesh.boneWeights
	{ TYPE_F32, false, 1 * sizeof(physx::PxF32), NULL, 0 }, // physicalMesh.boneWeights[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->optimizationData), CHILDREN(40), 1 }, // physicalMesh.optimizationData
	{ TYPE_U8, false, 1 * sizeof(physx::PxU8), NULL, 0 }, // physicalMesh.optimizationData[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->indices), CHILDREN(41), 1 }, // physicalMesh.indices
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // physicalMesh.indices[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->submeshes), CHILDREN(42), 1 }, // submeshes
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalSubmesh_Type), CHILDREN(43), 3 }, // submeshes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUp), CHILDREN(58), 1 }, // transitionUp
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapD_Type), CHILDREN(59), 7 }, // transitionUp[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownB), CHILDREN(66), 1 }, // transitionDownB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(67), 6 }, // transitionDownB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDown), CHILDREN(73), 1 }, // transitionDown
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapD_Type), CHILDREN(74), 7 }, // transitionDown[]
...
bool ClothingPhysicalMeshParameters_0p10::mBuiltFlag = false;
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p10::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p10::ClothingPhysicalMeshParameters_0p10(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingPhysicalMeshParameters_0p10FactoryInst);
...
ClothingPhysicalMeshParameters_0p10::~ClothingPhysicalMeshParameters_0p10()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingPhysicalMeshParameters_0p10::destroy()
{
	...
	this->~ClothingPhysicalMeshParameters_0p10();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p10::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p10::getParameterDefinitionTree(void) const
{
	ClothingPhysicalMeshParameters_0p10* tmpParam = const_cast<ClothingPhysicalMeshParameters_0p10*>(this);
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p10::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p10::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p10::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p10::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p10::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingPhysicalMeshParameters_0p10::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=5, longName="physicalMesh.vertices"
	{
		...
		ParamDefTable[5].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=7, longName="physicalMesh.normals"
	{
		...
		ParamDefTable[7].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=9, longName="physicalMesh.skinningNormals"
	{
		...
		ParamDefTable[9].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=11, longName="physicalMesh.constrainCoefficients"
	{
		...
		ParamDefTable[11].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=16, longName="physicalMesh.boneIndices"
	{
		...
		ParamDefTable[16].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=18, longName="physicalMesh.boneWeights"
	{
		...
		ParamDefTable[18].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=20, longName="physicalMesh.optimizationData"
	{
		...
		ParamDefTable[20].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=23, longName="physicalMesh.isClosed"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=24, longName="physicalMesh.indices"
	{
		...
		ParamDefTable[24].setAlignment(16);

		ParamDef->setArraySize(-1);
	}

	// Initialize DefinitionImpl node: nodeIndex=25, longName="physicalMesh.indices[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=26, longName="physicalMesh.maximumMaxDistance"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="physicalMesh.physicalMeshSorting"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="physicalMesh.shortestEdgeLength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=29, longName="physicalMesh.averageEdgeLength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=30, longName="physicalMesh.isTetrahedralMesh"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="physicalMesh.flipNormals"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=32, longName="submeshes"
	{
		...
		ParamDefTable[32].setAlignment(16);

		ParamDef->setArraySize(-1);
	}

	// Initialize DefinitionImpl node: nodeIndex=33, longName="submeshes[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="submeshes[].numIndices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="submeshes[].numVertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="submeshes[].numMaxDistance0Vertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="physicalLods"
	{
		...
		ParamDefTable[37].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=51, longName="transitionUp"
	{
		...
		ParamDefTable[51].setAlignment(16);

		ParamDef->setArraySize(-1);
	}

	// Initialize DefinitionImpl node: nodeIndex=52, longName="transitionUp[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=53, longName="transitionUp[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=54, longName="transitionUp[].vertexIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=55, longName="transitionUp[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=56, longName="transitionUp[].vertexIndex1"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=57, longName="transitionUp[].tangentBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=58, longName="transitionUp[].vertexIndex2"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=59, longName="transitionUp[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=60, longName="transitionUpThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=61, longName="transitionUpOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=62, longName="transitionDownB"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=63, longName="transitionDownB[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=64, longName="transitionDownB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=65, longName="transitionDownB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=66, longName="transitionDownB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=67, longName="transitionDownB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=68, longName="transitionDownB[].tetraIndex"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "Selects which of the 6 implicit tetrahedrons is used for the mapping.", true);
		ParamDefTable[68].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=69, longName="transitionDownB[].submeshIndex"
	{
		...
		HintTable[1].init("longDescription", "This is only needed during the authoring stage and thus does not need to be serialized.", true);
		HintTable[2].init("shortDescription", "Index into which Physical Submesh/LoD this element of the mapping belongs to.", true);
		ParamDefTable[69].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=70, longName="transitionDown"
	{
		...
		ParamDefTable[70].setAlignment(16);

		ParamDef->setArraySize(-1);
	}

	// Initialize DefinitionImpl node: nodeIndex=71, longName="transitionDown[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=72, longName="transitionDown[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=73, longName="transitionDown[].vertexIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=74, longName="transitionDown[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=75, longName="transitionDown[].vertexIndex1"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "Vertex index of the physics triangle.", true);
		ParamDefTable[75].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=76, longName="transitionDown[].tangentBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=77, longName="transitionDown[].vertexIndex2"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "Vertex index of the physics triangle.", true);
		ParamDefTable[77].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=78, longName="transitionDown[].vertexIndexPlusOffset"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "The vertex index in the graphical mesh (the target index).", true);
		ParamDefTable[78].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
	...
	// Initialize DefinitionImpl node: nodeIndex=79, longName="transitionDownThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=80, longName="transitionDownOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=81, longName="referenceCount"
	{
		...
		ParamDefTable[81].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[9] = PDEF_PTR(79);
		Children[10] = PDEF_PTR(80);
		Children[11] = PDEF_PTR(81);
	...
	// SetChildren for: nodeIndex=1, longName="physicalMesh"
	{
		...
		ParamDefTable[1].setChildren(Children, 19);
	}
	...
	// SetChildren for: nodeIndex=24, longName="physicalMesh.indices"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=32, longName="submeshes"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=33, longName="submeshes[]"
	{
		static Definition* Children[3];
	...
	// SetChildren for: nodeIndex=51, longName="transitionUp"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=52, longName="transitionUp[]"
	{
		...
		ParamDefTable[52].setChildren(Children, 7);
	}

	// SetChildren for: nodeIndex=62, longName="transitionDownB"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=63, longName="transitionDownB[]"
	{
		static Definition* Children[6];
		...
		ParamDefTable[63].setChildren(Children, 6);
	}

	// SetChildren for: nodeIndex=70, longName="transitionDown"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=71, longName="transitionDown[]"
	{
		static Definition* Children[7];
		Children[0] = PDEF_PTR(72);
		Children[1] = PDEF_PTR(73);
		Children[2] = PDEF_PTR(74);
		Children[3] = PDEF_PTR(75);
		Children[4] = PDEF_PTR(76);
		Children[5] = PDEF_PTR(77);
		Children[6] = PDEF_PTR(78);

		ParamDefTable[71].setChildren(Children, 7);
	}

	mBuiltFlag = true;

}
void ClothingPhysicalMeshParameters_0p10::initStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p10::initDynamicArrays(void)
{
	...
	physicalMesh.optimizationData.elementSize = sizeof(physx::PxU8);
	physicalMesh.optimizationData.arraySizes[0] = 0;
	physicalMesh.indices.buf = NULL;
	physicalMesh.indices.isAllocated = true;
	physicalMesh.indices.elementSize = sizeof(physx::PxU32);
...
void ClothingPhysicalMeshParameters_0p10::initDefaults(void)
{

	freeStrings();
	freeReferences();
	freeDynamicArrays();
	physicalMesh.numVertices = physx::PxU32(0);
	physicalMesh.numIndices = physx::PxU32(0);
	physicalMesh.numBonesPerVertex = physx::PxU32(0);
	physicalMesh.hasNegativeBackstop = bool(false);
	physicalMesh.isClosed = bool(false);
	physicalMesh.maximumMaxDistance = physx::PxF32(0);
	physicalMesh.physicalMeshSorting = physx::PxU32(0);
	physicalMesh.shortestEdgeLength = physx::PxF32(0);
	physicalMesh.averageEdgeLength = physx::PxF32(0);
	physicalMesh.isTetrahedralMesh = bool(false);
	physicalMesh.flipNormals = bool(false);
	transitionUpThickness = physx::PxF32(0);
	transitionUpOffset = physx::PxF32(0);
	transitionDownThickness = physx::PxF32(0);
	transitionDownOffset = physx::PxF32(0);
	referenceCount = physx::PxU32(0);
...
void ClothingPhysicalMeshParameters_0p10::initReferences(void)
{
}

void ClothingPhysicalMeshParameters_0p10::freeDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p10::freeStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p10::freeReferences(void)
{
}
