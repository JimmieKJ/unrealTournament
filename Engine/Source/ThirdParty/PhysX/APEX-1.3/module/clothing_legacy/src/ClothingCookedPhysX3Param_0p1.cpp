...
const char* const ClothingCookedPhysX3Param_0p1Factory::vptr =
    NxParameterized::getVptr<ClothingCookedPhysX3Param_0p1, ClothingCookedPhysX3Param_0p1::ClassAlignment>();
...
NxParameterized::MutexType ClothingCookedPhysX3Param_0p1::mBuiltFlagMutex;

ClothingCookedPhysX3Param_0p1::ClothingCookedPhysX3Param_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingCookedPhysX3Param_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
