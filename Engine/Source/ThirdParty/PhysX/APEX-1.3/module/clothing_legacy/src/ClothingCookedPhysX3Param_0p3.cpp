...
const char* const ClothingCookedPhysX3Param_0p3Factory::vptr =
    NxParameterized::getVptr<ClothingCookedPhysX3Param_0p3, ClothingCookedPhysX3Param_0p3::ClassAlignment>();
...
NxParameterized::MutexType ClothingCookedPhysX3Param_0p3::mBuiltFlagMutex;

ClothingCookedPhysX3Param_0p3::ClothingCookedPhysX3Param_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingCookedPhysX3Param_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
