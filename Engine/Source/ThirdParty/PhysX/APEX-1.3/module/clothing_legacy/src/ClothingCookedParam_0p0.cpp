...
const char* const ClothingCookedParam_0p0Factory::vptr =
    NxParameterized::getVptr<ClothingCookedParam_0p0, ClothingCookedParam_0p0::ClassAlignment>();
...
NxParameterized::MutexType ClothingCookedParam_0p0::mBuiltFlagMutex;

ClothingCookedParam_0p0::ClothingCookedParam_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingCookedParam_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingCookedParam_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingCookedParam_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingCookedParam_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingCookedParam_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
