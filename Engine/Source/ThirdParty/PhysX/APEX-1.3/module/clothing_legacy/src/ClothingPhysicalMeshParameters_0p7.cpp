...
using namespace ClothingPhysicalMeshParameters_0p7NS;

const char* const ClothingPhysicalMeshParameters_0p7Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p7, ClothingPhysicalMeshParameters_0p7::ClassAlignment>();
...
bool ClothingPhysicalMeshParameters_0p7::mBuiltFlag = false;
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p7::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p7::ClothingPhysicalMeshParameters_0p7(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingPhysicalMeshParameters_0p7FactoryInst);
...
ClothingPhysicalMeshParameters_0p7::~ClothingPhysicalMeshParameters_0p7()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingPhysicalMeshParameters_0p7::destroy()
{
	...
	this->~ClothingPhysicalMeshParameters_0p7();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p7::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p7::getParameterDefinitionTree(void) const
{
	ClothingPhysicalMeshParameters_0p7* tmpParam = const_cast<ClothingPhysicalMeshParameters_0p7*>(this);
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p7::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p7::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p7::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p7::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p7::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingPhysicalMeshParameters_0p7::buildTree(void)
{
...
void ClothingPhysicalMeshParameters_0p7::initStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p7::initDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p7::initDefaults(void)
{
...
void ClothingPhysicalMeshParameters_0p7::initReferences(void)
{
}

void ClothingPhysicalMeshParameters_0p7::freeDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p7::freeStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p7::freeReferences(void)
{
}
