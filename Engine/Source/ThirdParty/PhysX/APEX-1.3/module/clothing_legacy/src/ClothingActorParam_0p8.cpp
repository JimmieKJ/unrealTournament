...
using namespace ClothingActorParam_0p8NS;

const char* const ClothingActorParam_0p8Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p8, ClothingActorParam_0p8::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	65, 66, 67, 68, 69, 4, 5, 6, 7, 16, 17, 18, 19, 21, 22, 24, 25, 28, 30, 31, 32, 37,
	38, 39, 33, 34, 35, 36, 41, 47, 48, 53, 54, 55, 42, 43, 44, 45, 46, 49, 50, 51, 52,
	57, 58, 62, 64,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(27), 4 }, // flags
...
bool ClothingActorParam_0p8::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p8::mBuiltFlagMutex;

ClothingActorParam_0p8::ClothingActorParam_0p8(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p8FactoryInst);
...
ClothingActorParam_0p8::~ClothingActorParam_0p8()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p8::destroy()
{
	...
	this->~ClothingActorParam_0p8();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p8::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p8::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p8* tmpParam = const_cast<ClothingActorParam_0p8*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p8::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p8::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p8::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p8::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingActorParam_0p8::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p8::buildTree(void)
{
...
void ClothingActorParam_0p8::initStrings(void)
{
}

void ClothingActorParam_0p8::initDynamicArrays(void)
{
...
void ClothingActorParam_0p8::initDefaults(void)
{
...
void ClothingActorParam_0p8::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p8::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p8::freeStrings(void)
{
}

void ClothingActorParam_0p8::freeReferences(void)
{
	if (runtimeCooked)
	{
