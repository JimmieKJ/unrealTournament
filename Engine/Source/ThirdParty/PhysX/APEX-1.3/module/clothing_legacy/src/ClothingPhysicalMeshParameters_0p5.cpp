...
using namespace ClothingPhysicalMeshParameters_0p5NS;

const char* const ClothingPhysicalMeshParameters_0p5Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p5, ClothingPhysicalMeshParameters_0p5::ClassAlignment>();

const physx::PxU32 NumParamDefs = 71;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 27, 32, 38, 46, 52, 53, 54, 62, 68, 69, 70, 2, 3, 4, 5, 7, 9, 11, 16, 18, 20,
	22, 23, 24, 25, 26, 6, 8, 10, 12, 13, 14, 15, 17, 19, 21, 28, 29, 30, 31, 33, 34,
	35, 36, 37, 39, 40, 41, 42, 43, 44, 45, 47, 48, 49, 50, 51, 55, 56, 57, 58, 59, 60,
	61, 63, 64, 65, 66, 67,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalSubmesh_Type), CHILDREN(38), 3 }, // submeshes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicalLods), CHILDREN(41), 1 }, // physicalLods
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalLod_Type), CHILDREN(42), 4 }, // physicalLods[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpB), CHILDREN(46), 1 }, // transitionUpB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(47), 6 }, // transitionUpB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpC), CHILDREN(53), 1 }, // transitionUpC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(54), 4 }, // transitionUpC[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownC), CHILDREN(65), 1 }, // transitionDownC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(66), 4 }, // transitionDownC[]
...
bool ClothingPhysicalMeshParameters_0p5::mBuiltFlag = false;
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p5::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p5::ClothingPhysicalMeshParameters_0p5(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingPhysicalMeshParameters_0p5FactoryInst);
...
ClothingPhysicalMeshParameters_0p5::~ClothingPhysicalMeshParameters_0p5()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingPhysicalMeshParameters_0p5::destroy()
{
	...
	this->~ClothingPhysicalMeshParameters_0p5();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p5::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p5::getParameterDefinitionTree(void) const
{
	ClothingPhysicalMeshParameters_0p5* tmpParam = const_cast<ClothingPhysicalMeshParameters_0p5*>(this);
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p5::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p5::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p5::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p5::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p5::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingPhysicalMeshParameters_0p5::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="submeshes[].numMaxDistance0Vertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=33, longName="physicalLods[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="physicalLods[].costWithoutIterations"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="physicalLods[].submeshId"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="physicalLods[].solverIterationScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="physicalLods[].maxDistanceReduction"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=39, longName="transitionUpB[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="transitionUpB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=41, longName="transitionUpB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=42, longName="transitionUpB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=43, longName="transitionUpB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=44, longName="transitionUpB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=45, longName="transitionUpB[].submeshIndex"
	{
		...
		ParamDefTable[45].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=47, longName="transitionUpC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=48, longName="transitionUpC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=49, longName="transitionUpC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=50, longName="transitionUpC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=51, longName="transitionUpC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=61, longName="transitionDownB[].submeshIndex"
	{
		...
		HintTable[1].init("longDescription", "This is only needed during the authoring stage and thus does not need to be serialized.", true);
		HintTable[2].init("shortDescription", "Index into which Physical Submesh/LoD this element of the mapping belongs to.", true);
		ParamDefTable[61].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=63, longName="transitionDownC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=64, longName="transitionDownC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=65, longName="transitionDownC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=66, longName="transitionDownC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=67, longName="transitionDownC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=68, longName="transitionDownThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=69, longName="transitionDownOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=70, longName="referenceCount"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[7] = PDEF_PTR(54);
		Children[8] = PDEF_PTR(62);
		Children[9] = PDEF_PTR(68);
		Children[10] = PDEF_PTR(69);
		Children[11] = PDEF_PTR(70);
	...
	// SetChildren for: nodeIndex=33, longName="physicalLods[]"
	{
	...
	// SetChildren for: nodeIndex=39, longName="transitionUpB[]"
	{
	...
	// SetChildren for: nodeIndex=47, longName="transitionUpC[]"
	{
		static Definition* Children[4];
		...
		ParamDefTable[47].setChildren(Children, 4);
	}
	...
	// SetChildren for: nodeIndex=63, longName="transitionDownC[]"
	{
		static Definition* Children[4];
		...
		ParamDefTable[63].setChildren(Children, 4);
	}

	mBuiltFlag = true;

}
void ClothingPhysicalMeshParameters_0p5::initStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p5::initDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p5::initDefaults(void)
{
...
void ClothingPhysicalMeshParameters_0p5::initReferences(void)
{
}

void ClothingPhysicalMeshParameters_0p5::freeDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p5::freeStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p5::freeReferences(void)
{
}
