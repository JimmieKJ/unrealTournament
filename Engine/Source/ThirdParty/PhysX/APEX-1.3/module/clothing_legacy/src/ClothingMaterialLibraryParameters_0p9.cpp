...
using namespace ClothingMaterialLibraryParameters_0p9NS;

const char* const ClothingMaterialLibraryParameters_0p9Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p9, ClothingMaterialLibraryParameters_0p9::ClassAlignment>();
...
bool ClothingMaterialLibraryParameters_0p9::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p9::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p9::ClothingMaterialLibraryParameters_0p9(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p9FactoryInst);
...
ClothingMaterialLibraryParameters_0p9::~ClothingMaterialLibraryParameters_0p9()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p9::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p9();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p9::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p9::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p9* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p9*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p9::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p9::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p9::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p9::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p9::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p9::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=25, longName="materials[].internalDamping"
	{
...
void ClothingMaterialLibraryParameters_0p9::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p9::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p9::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p9::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p9::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p9::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p9::freeReferences(void)
{
}
