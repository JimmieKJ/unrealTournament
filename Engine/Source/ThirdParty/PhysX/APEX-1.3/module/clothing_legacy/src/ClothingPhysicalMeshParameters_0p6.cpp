...
const char* const ClothingPhysicalMeshParameters_0p6Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p6, ClothingPhysicalMeshParameters_0p6::ClassAlignment>();
...
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p6::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p6::ClothingPhysicalMeshParameters_0p6(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p6::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p6::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p6::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p6::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p6::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
