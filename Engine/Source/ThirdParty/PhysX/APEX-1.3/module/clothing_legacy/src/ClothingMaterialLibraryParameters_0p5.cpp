...
using namespace ClothingMaterialLibraryParameters_0p5NS;

const char* const ClothingMaterialLibraryParameters_0p5Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p5, ClothingMaterialLibraryParameters_0p5::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, 1 * sizeof(ClothingMaterial_Type), CHILDREN(2), 21 }, // materials[]
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->verticalStiffnessScaling), CHILDREN(23), 2 }, // materials[].verticalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->horizontalStiffnessScaling), CHILDREN(25), 2 }, // materials[].horizontalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->bendingStiffnessScaling), CHILDREN(27), 2 }, // materials[].bendingStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->shearingStiffnessScaling), CHILDREN(29), 2 }, // materials[].shearingStiffnessScaling
...
bool ClothingMaterialLibraryParameters_0p5::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p5::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p5::ClothingMaterialLibraryParameters_0p5(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p5FactoryInst);
...
ClothingMaterialLibraryParameters_0p5::~ClothingMaterialLibraryParameters_0p5()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p5::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p5();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p5::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p5::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p5* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p5*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p5::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p5::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p5::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p5::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p5::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p5::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="materials[].gravityScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="materials[].inertiaScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=29, longName="materials[].hardStretchLimitation"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=30, longName="materials[].maxDistanceBias"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="materials[].hierarchicalSolverIterations"
	{
	...
	// SetChildren for: nodeIndex=2, longName="materials[]"
	{
		...
		ParamDefTable[2].setChildren(Children, 21);
	}
...
void ClothingMaterialLibraryParameters_0p5::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p5::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p5::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p5::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p5::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p5::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p5::freeReferences(void)
{
}
