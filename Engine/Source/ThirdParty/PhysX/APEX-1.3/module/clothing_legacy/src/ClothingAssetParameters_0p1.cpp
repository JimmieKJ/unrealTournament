...
const char* const ClothingAssetParameters_0p1Factory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters_0p1, ClothingAssetParameters_0p1::ClassAlignment>();
...
NxParameterized::MutexType ClothingAssetParameters_0p1::mBuiltFlagMutex;

ClothingAssetParameters_0p1::ClothingAssetParameters_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
