...
const char* const ClothingMaterialLibraryParameters_0p1Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p1, ClothingMaterialLibraryParameters_0p1::ClassAlignment>();
...
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p1::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p1::ClothingMaterialLibraryParameters_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
