...
const char* const ClothingGraphicalLodParameters_0p2Factory::vptr =
    NxParameterized::getVptr<ClothingGraphicalLodParameters_0p2, ClothingGraphicalLodParameters_0p2::ClassAlignment>();
...
NxParameterized::MutexType ClothingGraphicalLodParameters_0p2::mBuiltFlagMutex;

ClothingGraphicalLodParameters_0p2::ClothingGraphicalLodParameters_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingGraphicalLodParameters_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
