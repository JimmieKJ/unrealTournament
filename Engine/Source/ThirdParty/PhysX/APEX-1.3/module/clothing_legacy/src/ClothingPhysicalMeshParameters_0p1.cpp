...
const char* const ClothingPhysicalMeshParameters_0p1Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p1, ClothingPhysicalMeshParameters_0p1::ClassAlignment>();
...
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p1::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p1::ClothingPhysicalMeshParameters_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
