...
using namespace ClothingPhysicalMeshParameters_0p4NS;

const char* const ClothingPhysicalMeshParameters_0p4Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p4, ClothingPhysicalMeshParameters_0p4::ClassAlignment>();
...
{
	1, 27, 31, 37, 45, 51, 52, 53, 61, 67, 68, 69, 2, 3, 4, 5, 7, 9, 11, 16, 18, 20,
	22, 23, 24, 25, 26, 6, 8, 10, 12, 13, 14, 15, 17, 19, 21, 28, 29, 30, 32, 33, 34,
	35, 36, 38, 39, 40, 41, 42, 43, 44, 46, 47, 48, 49, 50, 54, 55, 56, 57, 58, 59, 60,
	62, 63, 64, 65, 66,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->physicalMesh), CHILDREN(12), 15 }, // physicalMesh
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->vertices), CHILDREN(27), 1 }, // physicalMesh.vertices
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.vertices[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->normals), CHILDREN(28), 1 }, // physicalMesh.normals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.normals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->skinningNormals), CHILDREN(29), 1 }, // physicalMesh.skinningNormals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.skinningNormals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->constrainCoefficients), CHILDREN(30), 1 }, // physicalMesh.constrainCoefficients
	{ TYPE_STRUCT, false, 1 * sizeof(ConstrainCoefficient_Type), CHILDREN(31), 3 }, // physicalMesh.constrainCoefficients[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->boneIndices), CHILDREN(34), 1 }, // physicalMesh.boneIndices
	{ TYPE_U16, false, 1 * sizeof(physx::PxU16), NULL, 0 }, // physicalMesh.boneIndices[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->boneWeights), CHILDREN(35), 1 }, // physicalMesh.boneWeights
	{ TYPE_F32, false, 1 * sizeof(physx::PxF32), NULL, 0 }, // physicalMesh.boneWeights[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->indices), CHILDREN(36), 1 }, // physicalMesh.indices
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->submeshes), CHILDREN(37), 1 }, // submeshes
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalSubmesh_Type), CHILDREN(38), 2 }, // submeshes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicalLods), CHILDREN(40), 1 }, // physicalLods
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalLod_Type), CHILDREN(41), 4 }, // physicalLods[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpB), CHILDREN(45), 1 }, // transitionUpB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(46), 6 }, // transitionUpB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpC), CHILDREN(52), 1 }, // transitionUpC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(53), 4 }, // transitionUpC[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownB), CHILDREN(57), 1 }, // transitionDownB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(58), 6 }, // transitionDownB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownC), CHILDREN(64), 1 }, // transitionDownC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(65), 4 }, // transitionDownC[]
...
bool ClothingPhysicalMeshParameters_0p4::mBuiltFlag = false;
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p4::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p4::ClothingPhysicalMeshParameters_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingPhysicalMeshParameters_0p4FactoryInst);
...
ClothingPhysicalMeshParameters_0p4::~ClothingPhysicalMeshParameters_0p4()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingPhysicalMeshParameters_0p4::destroy()
{
	...
	this->~ClothingPhysicalMeshParameters_0p4();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p4::getParameterDefinitionTree(void) const
{
	ClothingPhysicalMeshParameters_0p4* tmpParam = const_cast<ClothingPhysicalMeshParameters_0p4*>(this);
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p4::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p4::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingPhysicalMeshParameters_0p4::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=20, longName="physicalMesh.indices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=21, longName="physicalMesh.indices[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=22, longName="physicalMesh.maximumMaxDistance"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=23, longName="physicalMesh.shortestEdgeLength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=24, longName="physicalMesh.averageEdgeLength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=25, longName="physicalMesh.isTetrahedralMesh"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=26, longName="physicalMesh.flipNormals"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="submeshes"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=29, longName="submeshes[].numIndices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=30, longName="submeshes[].numVertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="physicalLods"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=32, longName="physicalLods[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=33, longName="physicalLods[].costWithoutIterations"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="physicalLods[].submeshId"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="physicalLods[].solverIterationScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="physicalLods[].maxDistanceReduction"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="transitionUpB"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="transitionUpB[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=39, longName="transitionUpB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="transitionUpB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=41, longName="transitionUpB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=42, longName="transitionUpB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=43, longName="transitionUpB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=44, longName="transitionUpB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=45, longName="transitionUpC"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=46, longName="transitionUpC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=47, longName="transitionUpC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=48, longName="transitionUpC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=49, longName="transitionUpC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=50, longName="transitionUpC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=51, longName="transitionUpThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=52, longName="transitionUpOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=53, longName="transitionDownB"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=55, longName="transitionDownB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=56, longName="transitionDownB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=57, longName="transitionDownB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=58, longName="transitionDownB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=59, longName="transitionDownB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=60, longName="transitionDownB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=61, longName="transitionDownC"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=62, longName="transitionDownC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=63, longName="transitionDownC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=64, longName="transitionDownC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=65, longName="transitionDownC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=66, longName="transitionDownC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=67, longName="transitionDownThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=68, longName="transitionDownOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=69, longName="referenceCount"
	{
	...
	// SetChildren for: nodeIndex=20, longName="physicalMesh.indices"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=27, longName="submeshes"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=31, longName="physicalLods"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=32, longName="physicalLods[]"
	{
	...
	// SetChildren for: nodeIndex=37, longName="transitionUpB"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=38, longName="transitionUpB[]"
	{
	...
	// SetChildren for: nodeIndex=45, longName="transitionUpC"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=46, longName="transitionUpC[]"
	{
		static Definition* Children[4];
	...
	// SetChildren for: nodeIndex=53, longName="transitionDownB"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=54, longName="transitionDownB[]"
	{
		...
		ParamDefTable[54].setChildren(Children, 6);
	}

	// SetChildren for: nodeIndex=61, longName="transitionDownC"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=62, longName="transitionDownC[]"
	{
		static Definition* Children[4];
		...
		ParamDefTable[62].setChildren(Children, 4);
	}

	mBuiltFlag = true;

}
void ClothingPhysicalMeshParameters_0p4::initStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p4::initDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p4::initDefaults(void)
{
...
void ClothingPhysicalMeshParameters_0p4::initReferences(void)
{
}

void ClothingPhysicalMeshParameters_0p4::freeDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p4::freeStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p4::freeReferences(void)
{
}
