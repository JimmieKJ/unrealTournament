...
const char* const ClothingActorParam_0p1Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p1, ClothingActorParam_0p1::ClassAlignment>();

const physx::PxU32 NumParamDefs = 64;
...
NxParameterized::MutexType ClothingActorParam_0p1::mBuiltFlagMutex;

ClothingActorParam_0p1::ClothingActorParam_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
