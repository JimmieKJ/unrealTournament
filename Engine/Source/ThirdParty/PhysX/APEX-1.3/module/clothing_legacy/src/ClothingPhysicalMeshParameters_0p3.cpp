...
using namespace ClothingPhysicalMeshParameters_0p3NS;

const char* const ClothingPhysicalMeshParameters_0p3Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p3, ClothingPhysicalMeshParameters_0p3::ClassAlignment>();

const physx::PxU32 NumParamDefs = 72;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 29, 33, 39, 47, 53, 54, 55, 63, 69, 70, 71, 2, 3, 4, 5, 7, 9, 11, 13, 18, 20,
	22, 24, 25, 26, 27, 28, 6, 8, 10, 12, 14, 15, 16, 17, 19, 21, 23, 30, 31, 32, 34,
	35, 36, 37, 38, 40, 41, 42, 43, 44, 45, 46, 48, 49, 50, 51, 52, 56, 57, 58, 59, 60,
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->physicalMesh), CHILDREN(12), 16 }, // physicalMesh
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->vertices), CHILDREN(28), 1 }, // physicalMesh.vertices
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.vertices[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->normals), CHILDREN(29), 1 }, // physicalMesh.normals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.normals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->skinningNormals), CHILDREN(30), 1 }, // physicalMesh.skinningNormals
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // physicalMesh.skinningNormals[]
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->vertexFlags), CHILDREN(31), 1 }, // physicalMesh.vertexFlags
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->indices), CHILDREN(38), 1 }, // physicalMesh.indices
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->submeshes), CHILDREN(39), 1 }, // submeshes
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalSubmesh_Type), CHILDREN(40), 2 }, // submeshes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicalLods), CHILDREN(42), 1 }, // physicalLods
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalLod_Type), CHILDREN(43), 4 }, // physicalLods[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpB), CHILDREN(47), 1 }, // transitionUpB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(48), 6 }, // transitionUpB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpC), CHILDREN(54), 1 }, // transitionUpC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(55), 4 }, // transitionUpC[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownB), CHILDREN(59), 1 }, // transitionDownB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(60), 6 }, // transitionDownB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownC), CHILDREN(66), 1 }, // transitionDownC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(67), 4 }, // transitionDownC[]
...
bool ClothingPhysicalMeshParameters_0p3::mBuiltFlag = false;
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p3::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p3::ClothingPhysicalMeshParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingPhysicalMeshParameters_0p3FactoryInst);
...
ClothingPhysicalMeshParameters_0p3::~ClothingPhysicalMeshParameters_0p3()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingPhysicalMeshParameters_0p3::destroy()
{
	...
	this->~ClothingPhysicalMeshParameters_0p3();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p3::getParameterDefinitionTree(void) const
{
	ClothingPhysicalMeshParameters_0p3* tmpParam = const_cast<ClothingPhysicalMeshParameters_0p3*>(this);
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p3::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p3::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingPhysicalMeshParameters_0p3::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="physicalLods[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="physicalLods[].costWithoutIterations"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="physicalLods[].submeshId"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="physicalLods[].solverIterationScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="physicalLods[].maxDistanceReduction"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="transitionUpB[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=41, longName="transitionUpB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=42, longName="transitionUpB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=43, longName="transitionUpB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=44, longName="transitionUpB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=45, longName="transitionUpB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=46, longName="transitionUpB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=48, longName="transitionUpC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=49, longName="transitionUpC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=50, longName="transitionUpC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=51, longName="transitionUpC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=52, longName="transitionUpC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=53, longName="transitionUpThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=54, longName="transitionUpOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=56, longName="transitionDownB[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=57, longName="transitionDownB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=58, longName="transitionDownB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=59, longName="transitionDownB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=60, longName="transitionDownB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=61, longName="transitionDownB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=62, longName="transitionDownB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=64, longName="transitionDownC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=65, longName="transitionDownC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=66, longName="transitionDownC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=67, longName="transitionDownC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=68, longName="transitionDownC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=69, longName="transitionDownThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=70, longName="transitionDownOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=71, longName="referenceCount"
	{
	...
	// SetChildren for: nodeIndex=34, longName="physicalLods[]"
	{
	...
	// SetChildren for: nodeIndex=40, longName="transitionUpB[]"
	{
	...
	// SetChildren for: nodeIndex=48, longName="transitionUpC[]"
	{
		static Definition* Children[4];
	...
	// SetChildren for: nodeIndex=56, longName="transitionDownB[]"
	{
		static Definition* Children[6];
		...
		ParamDefTable[56].setChildren(Children, 6);
	}
	...
	// SetChildren for: nodeIndex=64, longName="transitionDownC[]"
	{
		static Definition* Children[4];
		...
		ParamDefTable[64].setChildren(Children, 4);
	}

	mBuiltFlag = true;

}
void ClothingPhysicalMeshParameters_0p3::initStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p3::initDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p3::initDefaults(void)
{
...
void ClothingPhysicalMeshParameters_0p3::initReferences(void)
{
}

void ClothingPhysicalMeshParameters_0p3::freeDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p3::freeStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p3::freeReferences(void)
{
}
