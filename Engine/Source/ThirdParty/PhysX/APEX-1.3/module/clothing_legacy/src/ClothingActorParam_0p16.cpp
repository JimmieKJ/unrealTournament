...
using namespace ClothingActorParam_0p16NS;

const char* const ClothingActorParam_0p16Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p16, ClothingActorParam_0p16::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	66, 68, 70, 71, 72, 73, 74, 75, 77, 78, 79, 80, 81, 4, 5, 6, 7, 8, 9, 10, 19, 20,
	21, 22, 24, 25, 27, 28, 31, 33, 34, 35, 40, 41, 42, 36, 37, 38, 39, 44, 50, 51, 56,
	57, 58, 45, 46, 47, 48, 49, 52, 53, 54, 55, 60, 61, 65, 67, 69, 76,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(34), 7 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(41), 4 }, // lodWeights
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->windParams), CHILDREN(45), 2 }, // windParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->maxDistanceScale), CHILDREN(47), 2 }, // maxDistanceScale
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneMatrices), CHILDREN(49), 1 }, // boneMatrices
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // boneMatrices[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->clothDescTemplate), CHILDREN(50), 6 }, // clothDescTemplate
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothDescTemplate_Type*)0)->groupsMask), CHILDREN(56), 4 }, // clothDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->shapeDescTemplate), CHILDREN(60), 6 }, // shapeDescTemplate
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->flags), CHILDREN(66), 5 }, // shapeDescTemplate.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->groupsMask), CHILDREN(71), 4 }, // shapeDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->actorDescTemplate), CHILDREN(75), 2 }, // actorDescTemplate
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphDisplacements), CHILDREN(77), 1 }, // morphDisplacements
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphDisplacements[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphPhysicalMeshNewPositions), CHILDREN(78), 1 }, // morphPhysicalMeshNewPositions
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphPhysicalMeshNewPositions[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphGraphicalMeshNewPositions), CHILDREN(79), 1 }, // morphGraphicalMeshNewPositions
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overrideMaterialNames), CHILDREN(80), 1 }, // overrideMaterialNames
...
bool ClothingActorParam_0p16::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p16::mBuiltFlagMutex;

ClothingActorParam_0p16::ClothingActorParam_0p16(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p16FactoryInst);
...
ClothingActorParam_0p16::~ClothingActorParam_0p16()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p16::destroy()
{
	...
	this->~ClothingActorParam_0p16();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p16::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p16::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p16* tmpParam = const_cast<ClothingActorParam_0p16*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p16::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p16::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p16::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p16::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingActorParam_0p16::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p16::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=78, longName="useStiffSolver"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=79, longName="freezeByLOD"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=80, longName="localSpaceSim"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=81, longName="teleportMode"
	{
...
void ClothingActorParam_0p16::initStrings(void)
{
}

void ClothingActorParam_0p16::initDynamicArrays(void)
{
...
void ClothingActorParam_0p16::initDefaults(void)
{
...
void ClothingActorParam_0p16::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p16::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p16::freeStrings(void)
{
...
void ClothingActorParam_0p16::freeReferences(void)
{
	if (runtimeCooked)
	{
