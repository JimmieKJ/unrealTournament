...
using namespace ClothingActorParam_0p0NS;

const char* const ClothingActorParam_0p0Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p0, ClothingActorParam_0p0::ClassAlignment>();
...
{
	1, 2, 3, 9, 10, 11, 12, 13, 14, 15, 16, 21, 24, 27, 28, 30, 41, 57, 60, 61, 4, 5,
	6, 7, 8, 17, 18, 19, 20, 22, 23, 25, 26, 29, 31, 32, 33, 38, 39, 40, 34, 35, 36,
	37, 42, 48, 49, 54, 55, 56, 43, 44, 45, 46, 47, 50, 51, 52, 53, 58, 59,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(20), 5 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(25), 4 }, // lodWeights
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->windParams), CHILDREN(29), 2 }, // windParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->maxDistanceScale), CHILDREN(31), 2 }, // maxDistanceScale
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneMatrices), CHILDREN(33), 1 }, // boneMatrices
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // boneMatrices[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->clothDescTemplate), CHILDREN(34), 6 }, // clothDescTemplate
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothDescTemplate_Type*)0)->groupsMask), CHILDREN(40), 4 }, // clothDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->shapeDescTemplate), CHILDREN(44), 6 }, // shapeDescTemplate
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->flags), CHILDREN(50), 5 }, // shapeDescTemplate.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->groupsMask), CHILDREN(55), 4 }, // shapeDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->actorDescTemplate), CHILDREN(59), 2 }, // actorDescTemplate
...
bool ClothingActorParam_0p0::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p0::mBuiltFlagMutex;

ClothingActorParam_0p0::ClothingActorParam_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p0FactoryInst);
...
ClothingActorParam_0p0::~ClothingActorParam_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p0::destroy()
{
	...
	this->~ClothingActorParam_0p0();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p0::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p0* tmpParam = const_cast<ClothingActorParam_0p0*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingActorParam_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p0::buildTree(void)
{
...
void ClothingActorParam_0p0::initStrings(void)
{
}

void ClothingActorParam_0p0::initDynamicArrays(void)
{
...
void ClothingActorParam_0p0::initDefaults(void)
{
...
void ClothingActorParam_0p0::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p0::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p0::freeStrings(void)
{
}

void ClothingActorParam_0p0::freeReferences(void)
{
	if (runtimeCooked)
	{
