...
using namespace ClothingGraphicalLodParameters_0p1NS;

const char* const ClothingGraphicalLodParameters_0p1Factory::vptr =
    NxParameterized::getVptr<ClothingGraphicalLodParameters_0p1, ClothingGraphicalLodParameters_0p1::ClassAlignment>();

const physx::PxU32 NumParamDefs = 29;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 2, 3, 4, 5, 7, 15, 21, 22, 23, 6, 8, 9, 10, 11, 12, 13, 14, 16, 17, 18, 19, 20,
	24, 25, 26, 27, 28,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->immediateClothMap), CHILDREN(10), 1 }, // immediateClothMap
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // immediateClothMap[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->skinClothMapB), CHILDREN(11), 1 }, // skinClothMapB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(12), 6 }, // skinClothMapB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->skinClothMapC), CHILDREN(18), 1 }, // skinClothMapC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(19), 4 }, // skinClothMapC[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->tetraMap), CHILDREN(23), 1 }, // tetraMap
	{ TYPE_STRUCT, false, 1 * sizeof(TetraLink_Type), CHILDREN(24), 4 }, // tetraMap[]
...
bool ClothingGraphicalLodParameters_0p1::mBuiltFlag = false;
NxParameterized::MutexType ClothingGraphicalLodParameters_0p1::mBuiltFlagMutex;

ClothingGraphicalLodParameters_0p1::ClothingGraphicalLodParameters_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingGraphicalLodParameters_0p1FactoryInst);
...
ClothingGraphicalLodParameters_0p1::~ClothingGraphicalLodParameters_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingGraphicalLodParameters_0p1::destroy()
{
	...
	this->~ClothingGraphicalLodParameters_0p1();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingGraphicalLodParameters_0p1::getParameterDefinitionTree(void) const
{
	ClothingGraphicalLodParameters_0p1* tmpParam = const_cast<ClothingGraphicalLodParameters_0p1*>(this);
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingGraphicalLodParameters_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingGraphicalLodParameters_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingGraphicalLodParameters_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingGraphicalLodParameters_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingGraphicalLodParameters_0p1::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=4, longName="renderMeshAssetPointer"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=6, longName="immediateClothMap[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=8, longName="skinClothMapB[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=9, longName="skinClothMapB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=10, longName="skinClothMapB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=11, longName="skinClothMapB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=12, longName="skinClothMapB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=13, longName="skinClothMapB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=14, longName="skinClothMapB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=16, longName="skinClothMapC[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=17, longName="skinClothMapC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=18, longName="skinClothMapC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=19, longName="skinClothMapC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=20, longName="skinClothMapC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=21, longName="skinClothMapThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=22, longName="skinClothMapOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=24, longName="tetraMap[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=25, longName="tetraMap[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=26, longName="tetraMap[].tetraIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="tetraMap[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="tetraMap[]._dummyForAlignment"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[9] = PDEF_PTR(23);

		ParamDefTable[0].setChildren(Children, 10);
	}

	// SetChildren for: nodeIndex=5, longName="immediateClothMap"
	{
	...
	// SetChildren for: nodeIndex=8, longName="skinClothMapB[]"
	{
	...
	// SetChildren for: nodeIndex=16, longName="skinClothMapC[]"
	{
	...
	// SetChildren for: nodeIndex=24, longName="tetraMap[]"
	{
		static Definition* Children[4];
		...
		ParamDefTable[24].setChildren(Children, 4);
	}

	mBuiltFlag = true;

}
void ClothingGraphicalLodParameters_0p1::initStrings(void)
{
}

void ClothingGraphicalLodParameters_0p1::initDynamicArrays(void)
{
...
void ClothingGraphicalLodParameters_0p1::initDefaults(void)
{
...
void ClothingGraphicalLodParameters_0p1::initReferences(void)
{
	renderMeshAsset = NULL;

}

void ClothingGraphicalLodParameters_0p1::freeDynamicArrays(void)
{
...
void ClothingGraphicalLodParameters_0p1::freeStrings(void)
{
}

void ClothingGraphicalLodParameters_0p1::freeReferences(void)
{
	if (renderMeshAsset)
	{
