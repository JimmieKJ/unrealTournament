...
using namespace ClothingMaterialLibraryParameters_0p11NS;

const char* const ClothingMaterialLibraryParameters_0p11Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p11, ClothingMaterialLibraryParameters_0p11::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	32, 33, 34, 35, 36, 37, 38, 13, 14, 16, 17, 19, 20, 22, 23,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->verticalStiffnessScaling), CHILDREN(30), 2 }, // materials[].verticalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->horizontalStiffnessScaling), CHILDREN(32), 2 }, // materials[].horizontalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->bendingStiffnessScaling), CHILDREN(34), 2 }, // materials[].bendingStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->shearingStiffnessScaling), CHILDREN(36), 2 }, // materials[].shearingStiffnessScaling
...
bool ClothingMaterialLibraryParameters_0p11::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p11::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p11::ClothingMaterialLibraryParameters_0p11(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p11FactoryInst);
...
ClothingMaterialLibraryParameters_0p11::~ClothingMaterialLibraryParameters_0p11()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p11::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p11();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p11::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p11::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p11* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p11*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p11::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p11::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p11::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p11::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p11::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p11::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=10, longName="materials[].tetherLimit"
	{
		...
		static HintImpl HintTable[2];
		static Hint* HintPtrTable[2] = { &HintTable[0], &HintTable[1], };
		HintTable[0].init("max", physx::PxF64(4.0), true);
	...
	// Initialize DefinitionImpl node: nodeIndex=25, longName="materials[].stiffnessFrequency"
	{
		...
		static HintImpl HintTable[2];
		static Hint* HintPtrTable[2] = { &HintTable[0], &HintTable[1], };
		HintTable[0].init("max", physx::PxF64(500.0), true);
		HintTable[1].init("min", physx::PxF64(10.0), true);
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="materials[].hardStretchLimitation"
	{
		...
		ParamDefTable[34].setHints((const NxParameterized::Hint**)HintPtrTable, 4);
	...
	// Initialize DefinitionImpl node: nodeIndex=37, longName="materials[].selfcollisionThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="materials[].selfcollisionStiffness"
	{
	...
	// SetChildren for: nodeIndex=2, longName="materials[]"
	{
		...
		Children[26] = PDEF_PTR(37);
		Children[27] = PDEF_PTR(38);
...
void ClothingMaterialLibraryParameters_0p11::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p11::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p11::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p11::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p11::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p11::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p11::freeReferences(void)
{
}
