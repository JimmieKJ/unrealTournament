...
using namespace ClothingAssetParameters_0p13NS;

const char* const ClothingAssetParameters_0p13Factory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters_0p13, ClothingAssetParameters_0p13::ClassAlignment>();
...
bool ClothingAssetParameters_0p13::mBuiltFlag = false;
NxParameterized::MutexType ClothingAssetParameters_0p13::mBuiltFlagMutex;

ClothingAssetParameters_0p13::ClothingAssetParameters_0p13(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingAssetParameters_0p13FactoryInst);
...
ClothingAssetParameters_0p13::~ClothingAssetParameters_0p13()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingAssetParameters_0p13::destroy()
{
	...
	this->~ClothingAssetParameters_0p13();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p13::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p13::getParameterDefinitionTree(void) const
{
	ClothingAssetParameters_0p13* tmpParam = const_cast<ClothingAssetParameters_0p13*>(this);
...
NxParameterized::ErrorType ClothingAssetParameters_0p13::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p13::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters_0p13::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingAssetParameters_0p13::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingAssetParameters_0p13::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingAssetParameters_0p13::buildTree(void)
{
...
void ClothingAssetParameters_0p13::initStrings(void)
{
	toolString.isAllocated = true;
	toolString.buf = NULL;
}

void ClothingAssetParameters_0p13::initDynamicArrays(void)
{
...
void ClothingAssetParameters_0p13::initDefaults(void)
{
	...
	interCollisionChannels = physx::PxU32(0);
...
void ClothingAssetParameters_0p13::initReferences(void)
{
	materialLibrary = NULL;

}

void ClothingAssetParameters_0p13::freeDynamicArrays(void)
{
...
void ClothingAssetParameters_0p13::freeStrings(void)
{
...
void ClothingAssetParameters_0p13::freeReferences(void)
{
