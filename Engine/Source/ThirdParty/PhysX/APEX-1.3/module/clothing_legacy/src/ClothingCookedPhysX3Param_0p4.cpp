...
using namespace ClothingCookedPhysX3Param_0p4NS;

const char* const ClothingCookedPhysX3Param_0p4Factory::vptr =
    NxParameterized::getVptr<ClothingCookedPhysX3Param_0p4, ClothingCookedPhysX3Param_0p4::ClassAlignment>();

const physx::PxU32 NumParamDefs = 44;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 2, 3, 4, 6, 8, 10, 12, 14, 22, 27, 29, 31, 33, 35, 37, 38, 39, 43, 5, 7, 9, 11,
	13, 15, 16, 17, 18, 19, 20, 21, 23, 24, 25, 26, 28, 30, 32, 34, 36, 40, 41, 42,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // selfCollisionNormalIndices[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->selfCollisionNormalSetSizes), CHILDREN(23), 1 }, // selfCollisionNormalSetSizes
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // selfCollisionNormalSetSizes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->fabricGPU), CHILDREN(40), 1 }, // fabricGPU
	{ TYPE_STRUCT, false, 1 * sizeof(FabricGPU_Type), CHILDREN(41), 2 }, // fabricGPU[]
...
bool ClothingCookedPhysX3Param_0p4::mBuiltFlag = false;
NxParameterized::MutexType ClothingCookedPhysX3Param_0p4::mBuiltFlagMutex;

ClothingCookedPhysX3Param_0p4::ClothingCookedPhysX3Param_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingCookedPhysX3Param_0p4FactoryInst);
...
ClothingCookedPhysX3Param_0p4::~ClothingCookedPhysX3Param_0p4()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingCookedPhysX3Param_0p4::destroy()
{
	...
	this->~ClothingCookedPhysX3Param_0p4();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingCookedPhysX3Param_0p4::getParameterDefinitionTree(void) const
{
	ClothingCookedPhysX3Param_0p4* tmpParam = const_cast<ClothingCookedPhysX3Param_0p4*>(this);
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingCookedPhysX3Param_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingCookedPhysX3Param_0p4::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingCookedPhysX3Param_0p4::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingCookedPhysX3Param_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingCookedPhysX3Param_0p4::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="fabricGPU[]"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=41, longName="fabricGPU[].fabricGPU"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=42, longName="fabricGPU[].factory"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=43, longName="nextCookedData"
	{
	...
	// SetChildren for: nodeIndex=40, longName="fabricGPU[]"
	{
...
void ClothingCookedPhysX3Param_0p4::initStrings(void)
{
}

void ClothingCookedPhysX3Param_0p4::initDynamicArrays(void)
{
	...
	selfCollisionNormalIndices.elementSize = sizeof(physx::PxU32);
	...
	selfCollisionNormalSetSizes.elementSize = sizeof(physx::PxU32);
...
void ClothingCookedPhysX3Param_0p4::initDefaults(void)
{
...
void ClothingCookedPhysX3Param_0p4::initReferences(void)
{
	nextCookedData = NULL;

}

void ClothingCookedPhysX3Param_0p4::freeDynamicArrays(void)
{
...
void ClothingCookedPhysX3Param_0p4::freeStrings(void)
{
}

void ClothingCookedPhysX3Param_0p4::freeReferences(void)
{
	if (nextCookedData)
	{
