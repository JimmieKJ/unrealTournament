...
using namespace ClothingAssetParameters_0p12NS;

const char* const ClothingAssetParameters_0p12Factory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters_0p12, ClothingAssetParameters_0p12::ClassAlignment>();
...
{
	1, 3, 5, 15, 24, 25, 26, 27, 35, 37, 42, 44, 49, 51, 55, 56, 57, 58, 2, 4, 6, 7,
	8, 9, 10, 11, 12, 13, 14, 16, 17, 18, 19, 20, 21, 22, 23, 28, 29, 30, 31, 32, 33,
	34, 36, 38, 39, 40, 41, 43, 45, 46, 47, 48, 50, 52, 53, 54,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicalMeshes), CHILDREN(18), 1 }, // physicalMeshes
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // physicalMeshes[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->graphicalLods), CHILDREN(19), 1 }, // graphicalLods
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // graphicalLods[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->simulation), CHILDREN(20), 9 }, // simulation
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->bones), CHILDREN(29), 1 }, // bones
	{ TYPE_STRUCT, false, 1 * sizeof(BoneEntry_Type), CHILDREN(30), 7 }, // bones[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneActors), CHILDREN(37), 1 }, // boneActors
	{ TYPE_STRUCT, false, 1 * sizeof(ActorEntry_Type), CHILDREN(38), 6 }, // boneActors[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneVertices), CHILDREN(44), 1 }, // boneVertices
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // boneVertices[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneSpheres), CHILDREN(45), 1 }, // boneSpheres
	{ TYPE_STRUCT, false, 1 * sizeof(BoneSphere_Type), CHILDREN(46), 3 }, // boneSpheres[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneSphereConnections), CHILDREN(49), 1 }, // boneSphereConnections
	{ TYPE_U16, false, 1 * sizeof(physx::PxU16), NULL, 0 }, // boneSphereConnections[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->bonePlanes), CHILDREN(50), 1 }, // bonePlanes
	{ TYPE_STRUCT, false, 1 * sizeof(BonePlane_Type), CHILDREN(51), 3 }, // bonePlanes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->collisionConvexes), CHILDREN(54), 1 }, // collisionConvexes
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // collisionConvexes[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->cookedData), CHILDREN(55), 1 }, // cookedData
	{ TYPE_STRUCT, false, 1 * sizeof(CookedEntry_Type), CHILDREN(56), 2 }, // cookedData[]
...
bool ClothingAssetParameters_0p12::mBuiltFlag = false;
NxParameterized::MutexType ClothingAssetParameters_0p12::mBuiltFlagMutex;

ClothingAssetParameters_0p12::ClothingAssetParameters_0p12(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingAssetParameters_0p12FactoryInst);
...
ClothingAssetParameters_0p12::~ClothingAssetParameters_0p12()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingAssetParameters_0p12::destroy()
{
	...
	this->~ClothingAssetParameters_0p12();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p12::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p12::getParameterDefinitionTree(void) const
{
	ClothingAssetParameters_0p12* tmpParam = const_cast<ClothingAssetParameters_0p12*>(this);
...
NxParameterized::ErrorType ClothingAssetParameters_0p12::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p12::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters_0p12::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingAssetParameters_0p12::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingAssetParameters_0p12::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingAssetParameters_0p12::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=58, longName="toolString"
	{
...
void ClothingAssetParameters_0p12::initStrings(void)
{
	toolString.isAllocated = true;
	toolString.buf = NULL;
}

void ClothingAssetParameters_0p12::initDynamicArrays(void)
{
	...
	collisionConvexes.elementSize = sizeof(physx::PxU32);
...
void ClothingAssetParameters_0p12::initDefaults(void)
{
...
void ClothingAssetParameters_0p12::initReferences(void)
{
	materialLibrary = NULL;

}

void ClothingAssetParameters_0p12::freeDynamicArrays(void)
{
...
void ClothingAssetParameters_0p12::freeStrings(void)
{
...
void ClothingAssetParameters_0p12::freeReferences(void)
{
