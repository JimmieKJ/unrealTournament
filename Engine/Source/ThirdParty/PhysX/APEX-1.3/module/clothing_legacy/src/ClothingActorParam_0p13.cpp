...
using namespace ClothingActorParam_0p13NS;

const char* const ClothingActorParam_0p13Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p13, ClothingActorParam_0p13::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	65, 67, 68, 69, 70, 71, 72, 74, 75, 76, 77, 4, 5, 6, 7, 16, 17, 18, 19, 21, 22, 24,
	25, 28, 30, 31, 32, 37, 38, 39, 33, 34, 35, 36, 41, 47, 48, 53, 54, 55, 42, 43, 44,
	45, 46, 49, 50, 51, 52, 57, 58, 62, 64, 66, 73,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(33), 4 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(37), 4 }, // lodWeights
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->windParams), CHILDREN(41), 2 }, // windParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->maxDistanceScale), CHILDREN(43), 2 }, // maxDistanceScale
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneMatrices), CHILDREN(45), 1 }, // boneMatrices
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // boneMatrices[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->clothDescTemplate), CHILDREN(46), 6 }, // clothDescTemplate
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothDescTemplate_Type*)0)->groupsMask), CHILDREN(52), 4 }, // clothDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->shapeDescTemplate), CHILDREN(56), 6 }, // shapeDescTemplate
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->flags), CHILDREN(62), 5 }, // shapeDescTemplate.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->groupsMask), CHILDREN(67), 4 }, // shapeDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->actorDescTemplate), CHILDREN(71), 2 }, // actorDescTemplate
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphDisplacements), CHILDREN(73), 1 }, // morphDisplacements
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphDisplacements[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphPhysicalMeshNewPositions), CHILDREN(74), 1 }, // morphPhysicalMeshNewPositions
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphPhysicalMeshNewPositions[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphGraphicalMeshNewPositions), CHILDREN(75), 1 }, // morphGraphicalMeshNewPositions
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overrideMaterialNames), CHILDREN(76), 1 }, // overrideMaterialNames
...
bool ClothingActorParam_0p13::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p13::mBuiltFlagMutex;

ClothingActorParam_0p13::ClothingActorParam_0p13(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p13FactoryInst);
...
ClothingActorParam_0p13::~ClothingActorParam_0p13()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p13::destroy()
{
	...
	this->~ClothingActorParam_0p13();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p13::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p13::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p13* tmpParam = const_cast<ClothingActorParam_0p13*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p13::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p13::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p13::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p13::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingActorParam_0p13::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p13::buildTree(void)
{
...
void ClothingActorParam_0p13::initStrings(void)
{
}

void ClothingActorParam_0p13::initDynamicArrays(void)
{
...
void ClothingActorParam_0p13::initDefaults(void)
{
...
void ClothingActorParam_0p13::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p13::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p13::freeStrings(void)
{
...
void ClothingActorParam_0p13::freeReferences(void)
{
	if (runtimeCooked)
	{
