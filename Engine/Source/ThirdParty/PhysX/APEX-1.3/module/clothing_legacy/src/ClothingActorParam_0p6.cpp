...
const char* const ClothingActorParam_0p6Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p6, ClothingActorParam_0p6::ClassAlignment>();
...
NxParameterized::MutexType ClothingActorParam_0p6::mBuiltFlagMutex;

ClothingActorParam_0p6::ClothingActorParam_0p6(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p6::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p6::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p6::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p6::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p6::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
