...
using namespace ClothingActorParam_0p14NS;

const char* const ClothingActorParam_0p14Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p14, ClothingActorParam_0p14::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	65, 67, 68, 69, 70, 71, 72, 74, 75, 76, 77, 78, 4, 5, 6, 7, 16, 17, 18, 19, 21, 22,
	24, 25, 28, 30, 31, 32, 37, 38, 39, 33, 34, 35, 36, 41, 47, 48, 53, 54, 55, 42, 43,
	44, 45, 46, 49, 50, 51, 52, 57, 58, 62, 64, 66, 73,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(34), 4 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(38), 4 }, // lodWeights
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->windParams), CHILDREN(42), 2 }, // windParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->maxDistanceScale), CHILDREN(44), 2 }, // maxDistanceScale
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneMatrices), CHILDREN(46), 1 }, // boneMatrices
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // boneMatrices[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->clothDescTemplate), CHILDREN(47), 6 }, // clothDescTemplate
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothDescTemplate_Type*)0)->groupsMask), CHILDREN(53), 4 }, // clothDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->shapeDescTemplate), CHILDREN(57), 6 }, // shapeDescTemplate
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->flags), CHILDREN(63), 5 }, // shapeDescTemplate.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->groupsMask), CHILDREN(68), 4 }, // shapeDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->actorDescTemplate), CHILDREN(72), 2 }, // actorDescTemplate
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphDisplacements), CHILDREN(74), 1 }, // morphDisplacements
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphDisplacements[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphPhysicalMeshNewPositions), CHILDREN(75), 1 }, // morphPhysicalMeshNewPositions
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphPhysicalMeshNewPositions[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphGraphicalMeshNewPositions), CHILDREN(76), 1 }, // morphGraphicalMeshNewPositions
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overrideMaterialNames), CHILDREN(77), 1 }, // overrideMaterialNames
	{ TYPE_STRING, false, 1 * sizeof(NxParameterized::DummyStringStruct), NULL, 0 }, // overrideMaterialNames[]
...
bool ClothingActorParam_0p14::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p14::mBuiltFlagMutex;

ClothingActorParam_0p14::ClothingActorParam_0p14(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p14FactoryInst);
...
ClothingActorParam_0p14::~ClothingActorParam_0p14()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p14::destroy()
{
	...
	this->~ClothingActorParam_0p14();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p14::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p14::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p14* tmpParam = const_cast<ClothingActorParam_0p14*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p14::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p14::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p14::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p14::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingActorParam_0p14::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p14::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=65, longName="morphGraphicalMeshNewPositions"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=70, longName="pressure"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=71, longName="multiplyGlobalPoseIntoBones"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=72, longName="overrideMaterialNames"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=74, longName="simulationBackend"
	{
		...
		ParamDefTable[74].setEnumVals((const char**)EnumVals, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=75, longName="useStiffSolver"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=76, longName="freezeByLOD"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=77, longName="localSpaceSim"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=78, longName="teleportMode"
	{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		Children[23] = PDEF_PTR(67);
		Children[24] = PDEF_PTR(68);
		Children[25] = PDEF_PTR(69);
		Children[26] = PDEF_PTR(70);
		Children[27] = PDEF_PTR(71);
		Children[28] = PDEF_PTR(72);
		Children[29] = PDEF_PTR(74);
		Children[30] = PDEF_PTR(75);
		Children[31] = PDEF_PTR(76);
		Children[32] = PDEF_PTR(77);
		Children[33] = PDEF_PTR(78);
	...
	// SetChildren for: nodeIndex=65, longName="morphGraphicalMeshNewPositions"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=72, longName="overrideMaterialNames"
	{
		static Definition* Children[1];
...
void ClothingActorParam_0p14::initStrings(void)
{
}

void ClothingActorParam_0p14::initDynamicArrays(void)
{
	...
	overrideMaterialNames.elementSize = sizeof(NxParameterized::DummyStringStruct);
	overrideMaterialNames.arraySizes[0] = 0;
}

void ClothingActorParam_0p14::initDefaults(void)
{
...
void ClothingActorParam_0p14::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p14::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p14::freeStrings(void)
{
...
void ClothingActorParam_0p14::freeReferences(void)
{
	if (runtimeCooked)
	{
