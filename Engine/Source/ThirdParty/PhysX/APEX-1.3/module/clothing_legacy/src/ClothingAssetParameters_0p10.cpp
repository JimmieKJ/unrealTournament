...
using namespace ClothingAssetParameters_0p10NS;

const char* const ClothingAssetParameters_0p10Factory::vptr =
    NxParameterized::getVptr<ClothingAssetParameters_0p10, ClothingAssetParameters_0p10::ClassAlignment>();
...
{
	1, 3, 5, 15, 24, 25, 26, 27, 35, 37, 42, 44, 48, 49, 50, 51, 2, 4, 6, 7, 8, 9, 10,
	11, 12, 13, 14, 16, 17, 18, 19, 20, 21, 22, 23, 28, 29, 30, 31, 32, 33, 34, 36, 38,
	39, 40, 41, 43, 45, 46, 47,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicalMeshes), CHILDREN(16), 1 }, // physicalMeshes
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // physicalMeshes[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->graphicalLods), CHILDREN(17), 1 }, // graphicalLods
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // graphicalLods[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->simulation), CHILDREN(18), 9 }, // simulation
...
bool ClothingAssetParameters_0p10::mBuiltFlag = false;
NxParameterized::MutexType ClothingAssetParameters_0p10::mBuiltFlagMutex;

ClothingAssetParameters_0p10::ClothingAssetParameters_0p10(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingAssetParameters_0p10FactoryInst);
...
ClothingAssetParameters_0p10::~ClothingAssetParameters_0p10()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingAssetParameters_0p10::destroy()
{
	...
	this->~ClothingAssetParameters_0p10();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p10::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingAssetParameters_0p10::getParameterDefinitionTree(void) const
{
	ClothingAssetParameters_0p10* tmpParam = const_cast<ClothingAssetParameters_0p10*>(this);
...
NxParameterized::ErrorType ClothingAssetParameters_0p10::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingAssetParameters_0p10::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingAssetParameters_0p10::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingAssetParameters_0p10::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingAssetParameters_0p10::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingAssetParameters_0p10::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=44, longName="cookedData"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=46, longName="cookedData[].scale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=47, longName="cookedData[].cookedData"
	{
		...
		ParamDefTable[47].setRefVariantVals((const char**)RefVariantVals, 2);



	}

	// Initialize DefinitionImpl node: nodeIndex=48, longName="boundingBox"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=49, longName="materialLibrary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=50, longName="materialIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=51, longName="toolString"
	{
	...
	// SetChildren for: nodeIndex=44, longName="cookedData"
	{
		static Definition* Children[1];
	...
	// SetChildren for: nodeIndex=45, longName="cookedData[]"
	{
		...
		ParamDefTable[45].setChildren(Children, 2);
	}

	mBuiltFlag = true;

}
void ClothingAssetParameters_0p10::initStrings(void)
{
	toolString.isAllocated = true;
	toolString.buf = NULL;
}

void ClothingAssetParameters_0p10::initDynamicArrays(void)
{
...
void ClothingAssetParameters_0p10::initDefaults(void)
{
	...
	simulation.virtualParticleDensity = physx::PxF32(0.0);
...
void ClothingAssetParameters_0p10::initReferences(void)
{
	materialLibrary = NULL;

}

void ClothingAssetParameters_0p10::freeDynamicArrays(void)
{
...
void ClothingAssetParameters_0p10::freeStrings(void)
{
...
void ClothingAssetParameters_0p10::freeReferences(void)
{
