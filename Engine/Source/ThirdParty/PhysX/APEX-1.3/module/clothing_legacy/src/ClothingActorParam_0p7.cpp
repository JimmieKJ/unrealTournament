...
using namespace ClothingActorParam_0p7NS;

const char* const ClothingActorParam_0p7Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p7, ClothingActorParam_0p7::ClassAlignment>();
...
bool ClothingActorParam_0p7::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p7::mBuiltFlagMutex;

ClothingActorParam_0p7::ClothingActorParam_0p7(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p7FactoryInst);
...
ClothingActorParam_0p7::~ClothingActorParam_0p7()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p7::destroy()
{
	...
	this->~ClothingActorParam_0p7();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p7::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p7::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p7* tmpParam = const_cast<ClothingActorParam_0p7*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p7::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p7::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p7::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p7::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingActorParam_0p7::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p7::buildTree(void)
{
...
void ClothingActorParam_0p7::initStrings(void)
{
}

void ClothingActorParam_0p7::initDynamicArrays(void)
{
...
void ClothingActorParam_0p7::initDefaults(void)
{
...
void ClothingActorParam_0p7::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p7::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p7::freeStrings(void)
{
}

void ClothingActorParam_0p7::freeReferences(void)
{
	if (runtimeCooked)
	{
