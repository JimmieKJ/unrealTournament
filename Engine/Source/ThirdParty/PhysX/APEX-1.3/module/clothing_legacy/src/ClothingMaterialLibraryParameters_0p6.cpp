...
using namespace ClothingMaterialLibraryParameters_0p6NS;

const char* const ClothingMaterialLibraryParameters_0p6Factory::vptr =
    NxParameterized::getVptr<ClothingMaterialLibraryParameters_0p6, ClothingMaterialLibraryParameters_0p6::ClassAlignment>();

const physx::PxU32 NumParamDefs = 33;
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, 1 * sizeof(ClothingMaterial_Type), CHILDREN(2), 22 }, // materials[]
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->verticalStiffnessScaling), CHILDREN(24), 2 }, // materials[].verticalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->horizontalStiffnessScaling), CHILDREN(26), 2 }, // materials[].horizontalStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->bendingStiffnessScaling), CHILDREN(28), 2 }, // materials[].bendingStiffnessScaling
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothingMaterial_Type*)0)->shearingStiffnessScaling), CHILDREN(30), 2 }, // materials[].shearingStiffnessScaling
...
bool ClothingMaterialLibraryParameters_0p6::mBuiltFlag = false;
NxParameterized::MutexType ClothingMaterialLibraryParameters_0p6::mBuiltFlagMutex;

ClothingMaterialLibraryParameters_0p6::ClothingMaterialLibraryParameters_0p6(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingMaterialLibraryParameters_0p6FactoryInst);
...
ClothingMaterialLibraryParameters_0p6::~ClothingMaterialLibraryParameters_0p6()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingMaterialLibraryParameters_0p6::destroy()
{
	...
	this->~ClothingMaterialLibraryParameters_0p6();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p6::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingMaterialLibraryParameters_0p6::getParameterDefinitionTree(void) const
{
	ClothingMaterialLibraryParameters_0p6* tmpParam = const_cast<ClothingMaterialLibraryParameters_0p6*>(this);
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p6::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingMaterialLibraryParameters_0p6::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingMaterialLibraryParameters_0p6::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingMaterialLibraryParameters_0p6::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingMaterialLibraryParameters_0p6::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingMaterialLibraryParameters_0p6::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=24, longName="materials[].comDamping"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=25, longName="materials[].friction"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=26, longName="materials[].solverIterations"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="materials[].solverFrequency"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="materials[].gravityScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=29, longName="materials[].inertiaScale"
	{
		...
		ParamDefTable[29].setHints((const NxParameterized::Hint**)HintPtrTable, 4);
	...
	// Initialize DefinitionImpl node: nodeIndex=30, longName="materials[].hardStretchLimitation"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="materials[].maxDistanceBias"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=32, longName="materials[].hierarchicalSolverIterations"
	{
	...
	// SetChildren for: nodeIndex=2, longName="materials[]"
	{
		...
		ParamDefTable[2].setChildren(Children, 22);
	}
...
void ClothingMaterialLibraryParameters_0p6::initStrings(void)
{
}

void ClothingMaterialLibraryParameters_0p6::initDynamicArrays(void)
{
	materials.buf = NULL;
...
void ClothingMaterialLibraryParameters_0p6::initDefaults(void)
{
...
void ClothingMaterialLibraryParameters_0p6::initReferences(void)
{
}

void ClothingMaterialLibraryParameters_0p6::freeDynamicArrays(void)
{
...
void ClothingMaterialLibraryParameters_0p6::freeStrings(void)
{
...
void ClothingMaterialLibraryParameters_0p6::freeReferences(void)
{
}
