...
using namespace ClothingActorParam_0p11NS;

const char* const ClothingActorParam_0p11Factory::vptr =
    NxParameterized::getVptr<ClothingActorParam_0p11, ClothingActorParam_0p11::ClassAlignment>();
...
static const size_t ParamLookupChildrenTable[] =
{
	...
	65, 66, 67, 68, 69, 70, 72, 73, 4, 5, 6, 7, 16, 17, 18, 19, 21, 22, 24, 25, 28, 30,
	31, 32, 37, 38, 39, 33, 34, 35, 36, 41, 47, 48, 53, 54, 55, 42, 43, 44, 45, 46, 49,
	50, 51, 52, 57, 58, 62, 64, 71,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->flags), CHILDREN(30), 4 }, // flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->lodWeights), CHILDREN(34), 4 }, // lodWeights
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->windParams), CHILDREN(38), 2 }, // windParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->maxDistanceScale), CHILDREN(40), 2 }, // maxDistanceScale
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->boneMatrices), CHILDREN(42), 1 }, // boneMatrices
	{ TYPE_MAT44, false, 1 * sizeof(physx::PxMat44), NULL, 0 }, // boneMatrices[]
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->clothDescTemplate), CHILDREN(43), 6 }, // clothDescTemplate
	...
	{ TYPE_STRUCT, false, (size_t)(&((ClothDescTemplate_Type*)0)->groupsMask), CHILDREN(49), 4 }, // clothDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->shapeDescTemplate), CHILDREN(53), 6 }, // shapeDescTemplate
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->flags), CHILDREN(59), 5 }, // shapeDescTemplate.flags
	...
	{ TYPE_STRUCT, false, (size_t)(&((ShapeDescTemplate_Type*)0)->groupsMask), CHILDREN(64), 4 }, // shapeDescTemplate.groupsMask
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->actorDescTemplate), CHILDREN(68), 2 }, // actorDescTemplate
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphDisplacements), CHILDREN(70), 1 }, // morphDisplacements
	{ TYPE_VEC3, false, 1 * sizeof(physx::PxVec3), NULL, 0 }, // morphDisplacements[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->morphPhysicalMeshNewPositions), CHILDREN(71), 1 }, // morphPhysicalMeshNewPositions
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->overrideMaterialNames), CHILDREN(72), 1 }, // overrideMaterialNames
	{ TYPE_STRING, false, 1 * sizeof(NxParameterized::DummyStringStruct), NULL, 0 }, // overrideMaterialNames[]
	{ TYPE_STRING, false, (size_t)(&((ParametersStruct*)0)->simulationBackend), NULL, 0 }, // simulationBackend
	{ TYPE_BOOL, false, (size_t)(&((ParametersStruct*)0)->freezeByLOD), NULL, 0 }, // freezeByLOD
};


bool ClothingActorParam_0p11::mBuiltFlag = false;
NxParameterized::MutexType ClothingActorParam_0p11::mBuiltFlagMutex;

ClothingActorParam_0p11::ClothingActorParam_0p11(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingActorParam_0p11FactoryInst);
...
ClothingActorParam_0p11::~ClothingActorParam_0p11()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingActorParam_0p11::destroy()
{
	...
	this->~ClothingActorParam_0p11();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingActorParam_0p11::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingActorParam_0p11::getParameterDefinitionTree(void) const
{
	ClothingActorParam_0p11* tmpParam = const_cast<ClothingActorParam_0p11*>(this);
...
NxParameterized::ErrorType ClothingActorParam_0p11::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingActorParam_0p11::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingActorParam_0p11::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingActorParam_0p11::ParametersStruct*>(&parameters()), handle, offset);
}
...
void ClothingActorParam_0p11::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingActorParam_0p11::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=72, longName="simulationBackend"
	{
		...
		ParamDef->init("simulationBackend", TYPE_STRING, NULL, true);
		...
		static HintImpl HintTable[1];
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "Select which backend should be used, currently only 'PhysX' is supported.", true);
...
void ClothingActorParam_0p11::initStrings(void)
{
	simulationBackend.isAllocated = false;
	simulationBackend.buf = (const char*)"PhysX";
}

void ClothingActorParam_0p11::initDynamicArrays(void)
{
...
void ClothingActorParam_0p11::initDefaults(void)
{
...
void ClothingActorParam_0p11::initReferences(void)
{
	runtimeCooked = NULL;

}

void ClothingActorParam_0p11::freeDynamicArrays(void)
{
...
void ClothingActorParam_0p11::freeStrings(void)
{
	...
	if (simulationBackend.isAllocated && simulationBackend.buf)
	{
		mParameterizedTraits->strfree((char*)simulationBackend.buf);
	}
}

void ClothingActorParam_0p11::freeReferences(void)
{
	if (runtimeCooked)
	{
