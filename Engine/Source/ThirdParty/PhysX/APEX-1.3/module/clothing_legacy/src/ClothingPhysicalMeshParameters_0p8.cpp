...
using namespace ClothingPhysicalMeshParameters_0p8NS;

const char* const ClothingPhysicalMeshParameters_0p8Factory::vptr =
    NxParameterized::getVptr<ClothingPhysicalMeshParameters_0p8, ClothingPhysicalMeshParameters_0p8::ClassAlignment>();

const physx::PxU32 NumParamDefs = 75;
static NxParameterized::DefinitionImpl* ParamDefTable; // now allocated in buildTree [NumParamDefs];


static const size_t ParamLookupChildrenTable[] =
{
	1, 31, 36, 42, 50, 56, 57, 58, 66, 72, 73, 74, 2, 3, 4, 5, 7, 9, 11, 16, 18, 20,
	22, 23, 24, 26, 27, 28, 29, 30, 6, 8, 10, 12, 13, 14, 15, 17, 19, 21, 25, 32, 33,
	34, 35, 37, 38, 39, 40, 41, 43, 44, 45, 46, 47, 48, 49, 51, 52, 53, 54, 55, 59, 60,
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->physicalMesh), CHILDREN(12), 18 }, // physicalMesh
	...
	{ TYPE_ARRAY, true, (size_t)(&((PhysicalMesh_Type*)0)->optimizationData), CHILDREN(39), 1 }, // physicalMesh.optimizationData
	...
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalSubmesh_Type), CHILDREN(42), 3 }, // submeshes[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->physicalLods), CHILDREN(45), 1 }, // physicalLods
	{ TYPE_STRUCT, false, 1 * sizeof(PhysicalLod_Type), CHILDREN(46), 4 }, // physicalLods[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpB), CHILDREN(50), 1 }, // transitionUpB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(51), 6 }, // transitionUpB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionUpC), CHILDREN(57), 1 }, // transitionUpC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(58), 4 }, // transitionUpC[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownB), CHILDREN(62), 1 }, // transitionDownB
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapB_Type), CHILDREN(63), 6 }, // transitionDownB[]
	...
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->transitionDownC), CHILDREN(69), 1 }, // transitionDownC
	{ TYPE_STRUCT, false, 1 * sizeof(SkinClothMapC_Type), CHILDREN(70), 4 }, // transitionDownC[]
...
bool ClothingPhysicalMeshParameters_0p8::mBuiltFlag = false;
NxParameterized::MutexType ClothingPhysicalMeshParameters_0p8::mBuiltFlagMutex;

ClothingPhysicalMeshParameters_0p8::ClothingPhysicalMeshParameters_0p8(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ClothingPhysicalMeshParameters_0p8FactoryInst);
...
ClothingPhysicalMeshParameters_0p8::~ClothingPhysicalMeshParameters_0p8()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ClothingPhysicalMeshParameters_0p8::destroy()
{
	...
	this->~ClothingPhysicalMeshParameters_0p8();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p8::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ClothingPhysicalMeshParameters_0p8::getParameterDefinitionTree(void) const
{
	ClothingPhysicalMeshParameters_0p8* tmpParam = const_cast<ClothingPhysicalMeshParameters_0p8*>(this);
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p8::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ClothingPhysicalMeshParameters_0p8::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ClothingPhysicalMeshParameters_0p8::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ClothingPhysicalMeshParameters_0p8::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ClothingPhysicalMeshParameters_0p8::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ClothingPhysicalMeshParameters_0p8::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=9, longName="physicalMesh.skinningNormals"
	{
		...
		static HintImpl HintTable[2];
		static Hint* HintPtrTable[2] = { &HintTable[0], &HintTable[1], };
		HintTable[0].init("longDescription", "These are the normals of the original mesh. They reflect what should come out of physics but the output\ncan be distorted because parts of the simulation mesh are turned off, resulting in wrong normal computation.\nThey are needed for the flags.CorrectSimulationNormals actorflag.\n", true);
		HintTable[1].init("shortDescription", "Array of skinning normals", true);
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="physicalMesh.shortestEdgeLength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="physicalMesh.averageEdgeLength"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=29, longName="physicalMesh.isTetrahedralMesh"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=30, longName="physicalMesh.flipNormals"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="submeshes"
	{
		...
		ParamDefTable[31].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=33, longName="submeshes[].numIndices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=34, longName="submeshes[].numVertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=35, longName="submeshes[].numMaxDistance0Vertices"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=36, longName="physicalLods"
	{
		...
		ParamDefTable[36].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=38, longName="physicalLods[].costWithoutIterations"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=39, longName="physicalLods[].submeshId"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=40, longName="physicalLods[].solverIterationScale"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=41, longName="physicalLods[].maxDistanceReduction"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=42, longName="transitionUpB"
	{
		...
		ParamDefTable[42].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=44, longName="transitionUpB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=45, longName="transitionUpB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=46, longName="transitionUpB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=47, longName="transitionUpB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=48, longName="transitionUpB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=49, longName="transitionUpB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=50, longName="transitionUpC"
	{
		...
		ParamDefTable[50].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=52, longName="transitionUpC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=53, longName="transitionUpC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=54, longName="transitionUpC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=55, longName="transitionUpC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=56, longName="transitionUpThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=57, longName="transitionUpOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=58, longName="transitionDownB"
	{
		...
		ParamDefTable[58].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=60, longName="transitionDownB[].vtxTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=61, longName="transitionDownB[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=62, longName="transitionDownB[].nrmTetraBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=63, longName="transitionDownB[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=64, longName="transitionDownB[].tetraIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=65, longName="transitionDownB[].submeshIndex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=66, longName="transitionDownC"
	{
		...
		ParamDefTable[66].setAlignment(16);
	...
	// Initialize DefinitionImpl node: nodeIndex=68, longName="transitionDownC[].vertexBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=69, longName="transitionDownC[].faceIndex0"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=70, longName="transitionDownC[].normalBary"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=71, longName="transitionDownC[].vertexIndexPlusOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=72, longName="transitionDownThickness"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=73, longName="transitionDownOffset"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=74, longName="referenceCount"
	{
	...
	// SetChildren for: nodeIndex=1, longName="physicalMesh"
	{
		...
		ParamDefTable[1].setChildren(Children, 18);
	}
	...
	// SetChildren for: nodeIndex=37, longName="physicalLods[]"
	{
		...
		ParamDefTable[37].setChildren(Children, 4);
	}
	...
	// SetChildren for: nodeIndex=58, longName="transitionDownB"
	{
		...
		ParamDefTable[58].setChildren(Children, 1);
	}
	...
	// SetChildren for: nodeIndex=59, longName="transitionDownB[]"
	{
		...
		ParamDefTable[59].setChildren(Children, 6);
	}
	...
	// SetChildren for: nodeIndex=67, longName="transitionDownC[]"
	{
		...
		ParamDefTable[67].setChildren(Children, 4);
	}

	mBuiltFlag = true;

}
void ClothingPhysicalMeshParameters_0p8::initStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p8::initDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p8::initDefaults(void)
{
...
void ClothingPhysicalMeshParameters_0p8::initReferences(void)
{
}

void ClothingPhysicalMeshParameters_0p8::freeDynamicArrays(void)
{
...
void ClothingPhysicalMeshParameters_0p8::freeStrings(void)
{
}

void ClothingPhysicalMeshParameters_0p8::freeReferences(void)
{
}
