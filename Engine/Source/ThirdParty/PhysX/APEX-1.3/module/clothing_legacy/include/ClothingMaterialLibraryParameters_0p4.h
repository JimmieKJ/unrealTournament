...
static const physx::PxU32 checksum[] = { 0xfc102886, 0x150d1ffb, 0xbf27936d, 0x4dabcfcd, };

} // namespace ClothingMaterialLibraryParameters_0p4NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingMaterialLibraryParameters_0p4 : public NxParameterized::NxParameters, public ClothingMaterialLibraryParameters_0p4NS::ParametersStruct
{
public:
	ClothingMaterialLibraryParameters_0p4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingMaterialLibraryParameters_0p4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingMaterialLibraryParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p4");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingMaterialLibraryParameters_0p4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingMaterialLibraryParameters_0p4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingMaterialLibraryParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p4");
			return 0;
		}
