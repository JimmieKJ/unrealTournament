...
static const physx::PxU32 checksum[] = { 0x6e6c2e8f, 0x92869606, 0xa8605f07, 0x6c4fcaa5, };

} // namespace ClothingMaterialLibraryParameters_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingMaterialLibraryParameters_0p1 : public NxParameterized::NxParameters, public ClothingMaterialLibraryParameters_0p1NS::ParametersStruct
{
public:
	ClothingMaterialLibraryParameters_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingMaterialLibraryParameters_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingMaterialLibraryParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p1");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingMaterialLibraryParameters_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingMaterialLibraryParameters_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingMaterialLibraryParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p1");
			return 0;
		}
