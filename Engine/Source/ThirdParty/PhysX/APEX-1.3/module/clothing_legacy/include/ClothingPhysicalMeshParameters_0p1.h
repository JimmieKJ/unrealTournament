...
static const physx::PxU32 checksum[] = { 0x0e11b41a, 0x0924da76, 0xd2bfd5b4, 0x09b6a1b5, };

} // namespace ClothingPhysicalMeshParameters_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingPhysicalMeshParameters_0p1 : public NxParameterized::NxParameters, public ClothingPhysicalMeshParameters_0p1NS::ParametersStruct
{
public:
	ClothingPhysicalMeshParameters_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingPhysicalMeshParameters_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingPhysicalMeshParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p1");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingPhysicalMeshParameters_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingPhysicalMeshParameters_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingPhysicalMeshParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p1");
			return 0;
		}
