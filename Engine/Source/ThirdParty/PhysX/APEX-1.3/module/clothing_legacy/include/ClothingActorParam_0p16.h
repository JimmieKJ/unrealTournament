...
struct ParametersStruct
{
	...
	bool freezeByLOD;
	bool localSpaceSim;
	physx::PxI32 teleportMode;

};

static const physx::PxU32 checksum[] = { 0x38fffcfa, 0x11f6b80a, 0xd6e75150, 0x68c6a1ba, };

} // namespace ClothingActorParam_0p16NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingActorParam_0p16 : public NxParameterized::NxParameters, public ClothingActorParam_0p16NS::ParametersStruct
{
public:
	ClothingActorParam_0p16(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingActorParam_0p16Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingActorParam_0p16::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p16");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingActorParam_0p16)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingActorParam_0p16)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingActorParam_0p16::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingActorParam_0p16::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p16");
			return 0;
		}
