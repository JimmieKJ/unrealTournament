...
static const physx::PxU32 checksum[] = { 0x047f02b5, 0xb4f816d1, 0xe1eab9e0, 0xcbc4b329, };

} // namespace ClothingActorParam_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingActorParam_0p1 : public NxParameterized::NxParameters, public ClothingActorParam_0p1NS::ParametersStruct
{
public:
	ClothingActorParam_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingActorParam_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingActorParam_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingActorParam_0p1)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingActorParam_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingActorParam_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingActorParam_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p1");
			return 0;
		}
