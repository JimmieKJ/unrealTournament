...
static const physx::PxU32 checksum[] = { 0x2928b37c, 0x0784b8e7, 0x64ad431c, 0x76431329, };

} // namespace ClothingActorParam_0p7NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingActorParam_0p7 : public NxParameterized::NxParameters, public ClothingActorParam_0p7NS::ParametersStruct
{
public:
	ClothingActorParam_0p7(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingActorParam_0p7Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingActorParam_0p7::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p7");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingActorParam_0p7)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingActorParam_0p7)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingActorParam_0p7::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingActorParam_0p7::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p7");
			return 0;
		}
