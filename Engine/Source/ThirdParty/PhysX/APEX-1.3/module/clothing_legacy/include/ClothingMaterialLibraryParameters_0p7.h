...
static const physx::PxU32 checksum[] = { 0x6f2cb784, 0xd6b385b1, 0x0d04cf2d, 0x41c6eaee, };

} // namespace ClothingMaterialLibraryParameters_0p7NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingMaterialLibraryParameters_0p7 : public NxParameterized::NxParameters, public ClothingMaterialLibraryParameters_0p7NS::ParametersStruct
{
public:
	ClothingMaterialLibraryParameters_0p7(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingMaterialLibraryParameters_0p7Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingMaterialLibraryParameters_0p7::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p7");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingMaterialLibraryParameters_0p7)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingMaterialLibraryParameters_0p7::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingMaterialLibraryParameters_0p7::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p7");
			return 0;
		}
