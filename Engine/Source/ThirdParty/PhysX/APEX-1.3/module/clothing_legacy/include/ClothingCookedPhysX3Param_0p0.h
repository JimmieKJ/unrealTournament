...
static const physx::PxU32 checksum[] = { 0x22beeaa3, 0xe15f304d, 0xe1ac2daf, 0x3f6ec0e9, };

} // namespace ClothingCookedPhysX3Param_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingCookedPhysX3Param_0p0 : public NxParameterized::NxParameters, public ClothingCookedPhysX3Param_0p0NS::ParametersStruct
{
public:
	ClothingCookedPhysX3Param_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingCookedPhysX3Param_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingCookedPhysX3Param_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingCookedPhysX3Param_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingCookedPhysX3Param_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingCookedPhysX3Param_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingCookedPhysX3Param_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingCookedPhysX3Param_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingCookedPhysX3Param_0p0");
			return 0;
		}
