...
static const physx::PxU32 checksum[] = { 0x427db3db, 0x3805a7f5, 0xf749b7d2, 0xcec020d2, };

} // namespace ClothingActorParam_0p4NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingActorParam_0p4 : public NxParameterized::NxParameters, public ClothingActorParam_0p4NS::ParametersStruct
{
public:
	ClothingActorParam_0p4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingActorParam_0p4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingActorParam_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p4");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingActorParam_0p4)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingActorParam_0p4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingActorParam_0p4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingActorParam_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p4");
			return 0;
		}
