...
static const physx::PxU32 checksum[] = { 0xd21d519c, 0x9aa2e36e, 0x0eb2eec6, 0xf196b802, };

} // namespace ClothingActorParam_0p8NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingActorParam_0p8 : public NxParameterized::NxParameters, public ClothingActorParam_0p8NS::ParametersStruct
{
public:
	ClothingActorParam_0p8(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingActorParam_0p8Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingActorParam_0p8::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p8");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingActorParam_0p8)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingActorParam_0p8)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingActorParam_0p8::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingActorParam_0p8::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingActorParam_0p8");
			return 0;
		}
