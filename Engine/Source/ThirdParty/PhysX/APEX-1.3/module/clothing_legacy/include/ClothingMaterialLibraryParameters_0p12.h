...
static const physx::PxU32 checksum[] = { 0x75415773, 0xe8084f86, 0x506e53db, 0xd51f5113, };

} // namespace ClothingMaterialLibraryParameters_0p12NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingMaterialLibraryParameters_0p12 : public NxParameterized::NxParameters, public ClothingMaterialLibraryParameters_0p12NS::ParametersStruct
{
public:
	ClothingMaterialLibraryParameters_0p12(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingMaterialLibraryParameters_0p12Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingMaterialLibraryParameters_0p12::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p12");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingMaterialLibraryParameters_0p12)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingMaterialLibraryParameters_0p12::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingMaterialLibraryParameters_0p12::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingMaterialLibraryParameters_0p12");
			return 0;
		}
