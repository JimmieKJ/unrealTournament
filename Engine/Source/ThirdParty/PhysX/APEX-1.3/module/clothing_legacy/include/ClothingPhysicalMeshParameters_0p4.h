...
static const physx::PxU32 checksum[] = { 0x9bfbb498, 0x8a184db8, 0xe1411e37, 0xf508aff3, };

} // namespace ClothingPhysicalMeshParameters_0p4NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingPhysicalMeshParameters_0p4 : public NxParameterized::NxParameters, public ClothingPhysicalMeshParameters_0p4NS::ParametersStruct
{
public:
	ClothingPhysicalMeshParameters_0p4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingPhysicalMeshParameters_0p4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingPhysicalMeshParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p4");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingPhysicalMeshParameters_0p4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingPhysicalMeshParameters_0p4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingPhysicalMeshParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p4");
			return 0;
		}
