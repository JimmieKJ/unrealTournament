...
static const physx::PxU32 checksum[] = { 0xfb9d6cf7, 0x4e92037f, 0xc7a487e6, 0xcc776c9d, };

} // namespace ClothingAssetParameters_0p5NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingAssetParameters_0p5 : public NxParameterized::NxParameters, public ClothingAssetParameters_0p5NS::ParametersStruct
{
public:
	ClothingAssetParameters_0p5(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingAssetParameters_0p5Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingAssetParameters_0p5::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingAssetParameters_0p5");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingAssetParameters_0p5)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingAssetParameters_0p5)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingAssetParameters_0p5::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingAssetParameters_0p5::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingAssetParameters_0p5");
			return 0;
		}
