...
static const physx::PxU32 checksum[] = { 0x52405a64, 0xbedbf4ae, 0xaab8ec54, 0x28862c74, };

} // namespace ClothingPhysicalMeshParameters_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingPhysicalMeshParameters_0p0 : public NxParameterized::NxParameters, public ClothingPhysicalMeshParameters_0p0NS::ParametersStruct
{
public:
	ClothingPhysicalMeshParameters_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingPhysicalMeshParameters_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingPhysicalMeshParameters_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p0");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingPhysicalMeshParameters_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingPhysicalMeshParameters_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingPhysicalMeshParameters_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p0");
			return 0;
		}
