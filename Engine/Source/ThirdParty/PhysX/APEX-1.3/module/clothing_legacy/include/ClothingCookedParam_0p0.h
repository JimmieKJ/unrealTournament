...
static const physx::PxU32 checksum[] = { 0xfcb347aa, 0xb8e47b73, 0xaee36e9f, 0xe906c580, };

} // namespace ClothingCookedParam_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingCookedParam_0p0 : public NxParameterized::NxParameters, public ClothingCookedParam_0p0NS::ParametersStruct
{
public:
	ClothingCookedParam_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingCookedParam_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingCookedParam_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingCookedParam_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingCookedParam_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingCookedParam_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingCookedParam_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingCookedParam_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingCookedParam_0p0");
			return 0;
		}
