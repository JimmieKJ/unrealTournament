...
struct ParametersStruct
{
	...
	physx::PxU32 deformableCookedDataVersion;
...
static const physx::PxU32 checksum[] = { 0xce16109b, 0x915a4ba3, 0xbcb76375, 0x12b10e79, };

} // namespace ClothingPhysicalMeshParameters_0p2NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingPhysicalMeshParameters_0p2 : public NxParameterized::NxParameters, public ClothingPhysicalMeshParameters_0p2NS::ParametersStruct
{
public:
	ClothingPhysicalMeshParameters_0p2(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingPhysicalMeshParameters_0p2Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingPhysicalMeshParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p2");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingPhysicalMeshParameters_0p2)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingPhysicalMeshParameters_0p2::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingPhysicalMeshParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingPhysicalMeshParameters_0p2");
			return 0;
		}
