...
static const physx::PxU32 checksum[] = { 0x6f9c2e10, 0xabbe7d19, 0x039846d7, 0x63232322, };

} // namespace ClothingAssetParameters_0p9NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingAssetParameters_0p9 : public NxParameterized::NxParameters, public ClothingAssetParameters_0p9NS::ParametersStruct
{
public:
	ClothingAssetParameters_0p9(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingAssetParameters_0p9Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingAssetParameters_0p9::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingAssetParameters_0p9");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ClothingAssetParameters_0p9)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingAssetParameters_0p9)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingAssetParameters_0p9::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingAssetParameters_0p9::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingAssetParameters_0p9");
			return 0;
		}
