...
static const physx::PxU32 checksum[] = { 0x41f36544, 0x55c9d3e4, 0xf4daab87, 0xbb7a1957, };

} // namespace ClothingGraphicalLodParameters_0p3NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ClothingGraphicalLodParameters_0p3 : public NxParameterized::NxParameters, public ClothingGraphicalLodParameters_0p3NS::ParametersStruct
{
public:
	ClothingGraphicalLodParameters_0p3(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ClothingGraphicalLodParameters_0p3Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ClothingGraphicalLodParameters_0p3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingGraphicalLodParameters_0p3");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ClothingGraphicalLodParameters_0p3)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ClothingGraphicalLodParameters_0p3::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ClothingGraphicalLodParameters_0p3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ClothingGraphicalLodParameters_0p3");
			return 0;
		}
