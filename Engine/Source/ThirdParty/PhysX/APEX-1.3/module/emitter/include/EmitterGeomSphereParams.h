...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EmitterGeomSphereParams : public NxParameterized::NxParameters, public EmitterGeomSphereParamsNS::ParametersStruct
{
public:
	EmitterGeomSphereParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EmitterGeomSphereParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EmitterGeomSphereParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterGeomSphereParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(EmitterGeomSphereParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, EmitterGeomSphereParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EmitterGeomSphereParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EmitterGeomSphereParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterGeomSphereParams");
			return 0;
		}
