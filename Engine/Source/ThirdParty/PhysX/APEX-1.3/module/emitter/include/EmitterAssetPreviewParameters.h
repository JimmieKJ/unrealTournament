...
static const physx::PxU32 checksum[] = { 0xa94a76b2, 0x60554bab, 0xa0ce510f, 0xda958a1c, };

} // namespace EmitterAssetPreviewParametersNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EmitterAssetPreviewParameters : public NxParameterized::NxParameters, public EmitterAssetPreviewParametersNS::ParametersStruct
{
public:
	EmitterAssetPreviewParameters(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EmitterAssetPreviewParametersFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EmitterAssetPreviewParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterAssetPreviewParameters");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(EmitterAssetPreviewParameters)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, EmitterAssetPreviewParameters)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EmitterAssetPreviewParameters::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EmitterAssetPreviewParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EmitterAssetPreviewParameters");
			return 0;
		}
