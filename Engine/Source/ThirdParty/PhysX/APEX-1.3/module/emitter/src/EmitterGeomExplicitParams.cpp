...
const char* const EmitterGeomExplicitParamsFactory::vptr =
    NxParameterized::getVptr<EmitterGeomExplicitParams, EmitterGeomExplicitParams::ClassAlignment>();
...
NxParameterized::MutexType EmitterGeomExplicitParams::mBuiltFlagMutex;

EmitterGeomExplicitParams::EmitterGeomExplicitParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EmitterGeomExplicitParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EmitterGeomExplicitParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EmitterGeomExplicitParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EmitterGeomExplicitParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EmitterGeomExplicitParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
