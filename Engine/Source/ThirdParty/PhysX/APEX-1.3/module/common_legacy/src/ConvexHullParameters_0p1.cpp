...
const char* const ConvexHullParameters_0p1Factory::vptr =
    NxParameterized::getVptr<ConvexHullParameters_0p1, ConvexHullParameters_0p1::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_F32, false, 1 * sizeof(physx::PxF32), NULL, 0 }, // widths[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->edges), CHILDREN(14), 1 }, // edges
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // edges[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->adjacentFaces), CHILDREN(15), 1 }, // adjacentFaces
	{ TYPE_U32, false, 1 * sizeof(physx::PxU32), NULL, 0 }, // adjacentFaces[]
...
NxParameterized::MutexType ConvexHullParameters_0p1::mBuiltFlagMutex;

ConvexHullParameters_0p1::ConvexHullParameters_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ConvexHullParameters_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ConvexHullParameters_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ConvexHullParameters_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ConvexHullParameters_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ConvexHullParameters_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ConvexHullParameters_0p1::initDynamicArrays(void)
{
	...
	widths.elementSize = sizeof(physx::PxF32);
	widths.arraySizes[0] = 0;
	edges.buf = NULL;
	edges.isAllocated = true;
	edges.elementSize = sizeof(physx::PxU32);
	edges.arraySizes[0] = 0;
	adjacentFaces.buf = NULL;
	adjacentFaces.isAllocated = true;
	adjacentFaces.elementSize = sizeof(physx::PxU32);
...
void ConvexHullParameters_0p1::initDefaults(void)
{
	...
	freeReferences();
	freeDynamicArrays();
	volume = physx::PxF32(0);
	uniqueEdgeDirectionCount = physx::PxU32(0);
	planeCount = physx::PxU32(0);
