...
const char* const ConvexHullParameters_0p0Factory::vptr =
    NxParameterized::getVptr<ConvexHullParameters_0p0, ConvexHullParameters_0p0::ClassAlignment>();
...
NxParameterized::MutexType ConvexHullParameters_0p0::mBuiltFlagMutex;

ConvexHullParameters_0p0::ConvexHullParameters_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ConvexHullParameters_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ConvexHullParameters_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ConvexHullParameters_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ConvexHullParameters_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ConvexHullParameters_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
