...
static __inline__ __device__ double dsub(double a, double b, enum cudaRoundMode mode = cudaRoundNearest)
{
...
#endif /* !defined(__CUDA_ARCH__) || __CUDA_ARCH__ >= 1300 */

#elif defined(__CUDABE__)

#if __CUDA_ARCH__ >= 130
static __forceinline__ double __dsub_rn(double a, double b)
{
  double res;
...
static __forceinline__ double __dsub_rz(double a, double b)
{
  double res;
...
static __forceinline__ double __dsub_ru(double a, double b)
{
  double res;
...
static __forceinline__ double __dsub_rd(double a, double b)
{
  double res;
...
#endif /* defined(__CUDABE__), defined(__cplusplus) && defined(__CUDACC__) */
