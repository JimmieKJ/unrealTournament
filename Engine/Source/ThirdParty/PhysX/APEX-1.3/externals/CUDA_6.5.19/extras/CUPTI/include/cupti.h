...
#if defined(__arm__)
/* The following parameter structures cannot be included on ARM unless
   a header that defines GL_VERSION is included before including them.
   If these are needed then make sure such a header is included already. */
#ifdef GL_VERSION
