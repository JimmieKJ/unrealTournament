...
static const physx::PxU32 checksum[] = { 0x35087bb2, 0x98bdb0fd, 0x22e601f6, 0x79ba85e9, };

} // namespace BufferU16x2NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class BufferU16x2 : public NxParameterized::NxParameters, public BufferU16x2NS::ParametersStruct
{
public:
	BufferU16x2(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class BufferU16x2Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, BufferU16x2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BufferU16x2");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(BufferU16x2)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, BufferU16x2)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, BufferU16x2::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, BufferU16x2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BufferU16x2");
			return 0;
		}
