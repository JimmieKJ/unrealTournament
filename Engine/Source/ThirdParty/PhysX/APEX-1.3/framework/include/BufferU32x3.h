...
static const physx::PxU32 checksum[] = { 0xc0b737db, 0x1cae35c4, 0xe957acc9, 0x68cb2306, };

} // namespace BufferU32x3NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class BufferU32x3 : public NxParameterized::NxParameters, public BufferU32x3NS::ParametersStruct
{
public:
	BufferU32x3(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class BufferU32x3Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, BufferU32x3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BufferU32x3");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(BufferU32x3)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, BufferU32x3)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, BufferU32x3::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, BufferU32x3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BufferU32x3");
			return 0;
		}
