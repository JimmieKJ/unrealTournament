...
static const physx::PxU32 checksum[] = { 0x8e5349d3, 0xbf3dae15, 0x22c57bb9, 0x7c602608, };

} // namespace BufferU32x4NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class BufferU32x4 : public NxParameterized::NxParameters, public BufferU32x4NS::ParametersStruct
{
public:
	BufferU32x4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class BufferU32x4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, BufferU32x4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BufferU32x4");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(BufferU32x4)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, BufferU32x4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, BufferU32x4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, BufferU32x4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BufferU32x4");
			return 0;
		}
