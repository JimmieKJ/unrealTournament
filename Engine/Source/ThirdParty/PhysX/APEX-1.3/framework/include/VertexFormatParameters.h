...
static const physx::PxU32 checksum[] = { 0xa7c1ed95, 0x570ed2b1, 0x55717659, 0x9951d139, };

} // namespace VertexFormatParametersNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class VertexFormatParameters : public NxParameterized::NxParameters, public VertexFormatParametersNS::ParametersStruct
{
public:
	VertexFormatParameters(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class VertexFormatParametersFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, VertexFormatParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VertexFormatParameters");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(VertexFormatParameters)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, VertexFormatParameters)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, VertexFormatParameters::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, VertexFormatParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VertexFormatParameters");
			return 0;
		}
