...
const char* const BufferU16x4Factory::vptr =
    NxParameterized::getVptr<BufferU16x4, BufferU16x4::ClassAlignment>();
...
NxParameterized::MutexType BufferU16x4::mBuiltFlagMutex;

BufferU16x4::BufferU16x4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BufferU16x4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BufferU16x4::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BufferU16x4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BufferU16x4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BufferU16x4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
