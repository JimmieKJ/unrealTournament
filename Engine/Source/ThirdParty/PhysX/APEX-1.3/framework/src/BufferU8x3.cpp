...
const char* const BufferU8x3Factory::vptr =
    NxParameterized::getVptr<BufferU8x3, BufferU8x3::ClassAlignment>();
...
NxParameterized::MutexType BufferU8x3::mBuiltFlagMutex;

BufferU8x3::BufferU8x3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BufferU8x3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BufferU8x3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BufferU8x3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BufferU8x3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BufferU8x3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
