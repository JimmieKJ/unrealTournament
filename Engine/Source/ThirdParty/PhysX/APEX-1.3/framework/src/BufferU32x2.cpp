...
const char* const BufferU32x2Factory::vptr =
    NxParameterized::getVptr<BufferU32x2, BufferU32x2::ClassAlignment>();
...
NxParameterized::MutexType BufferU32x2::mBuiltFlagMutex;

BufferU32x2::BufferU32x2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BufferU32x2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BufferU32x2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BufferU32x2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BufferU32x2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BufferU32x2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
