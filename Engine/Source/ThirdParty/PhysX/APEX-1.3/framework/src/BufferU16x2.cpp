...
using namespace BufferU16x2NS;

const char* const BufferU16x2Factory::vptr =
    NxParameterized::getVptr<BufferU16x2, BufferU16x2::ClassAlignment>();
...
bool BufferU16x2::mBuiltFlag = false;
NxParameterized::MutexType BufferU16x2::mBuiltFlagMutex;

BufferU16x2::BufferU16x2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BufferU16x2FactoryInst);
...
const NxParameterized::DefinitionImpl* BufferU16x2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BufferU16x2::getParameterDefinitionTree(void) const
{
	BufferU16x2* tmpParam = const_cast<BufferU16x2*>(this);
...
NxParameterized::ErrorType BufferU16x2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BufferU16x2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BufferU16x2::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BufferU16x2::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BufferU16x2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BufferU16x2::buildTree(void)
{
...
void BufferU16x2::initStrings(void)
{
}

void BufferU16x2::initDynamicArrays(void)
{
	data.buf = NULL;
...
void BufferU16x2::initDefaults(void)
{
...
void BufferU16x2::initReferences(void)
{
}

void BufferU16x2::freeDynamicArrays(void)
{
...
void BufferU16x2::freeStrings(void)
{
}

void BufferU16x2::freeReferences(void)
{
}
