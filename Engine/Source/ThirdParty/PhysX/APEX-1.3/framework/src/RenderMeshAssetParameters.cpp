...
const char* const RenderMeshAssetParametersFactory::vptr =
    NxParameterized::getVptr<RenderMeshAssetParameters, RenderMeshAssetParameters::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // submeshes[]
	{ TYPE_ARRAY, true, (size_t)(&((ParametersStruct*)0)->materialNames), CHILDREN(8), 1 }, // materialNames
	{ TYPE_STRING, false, 1 * sizeof(NxParameterized::DummyStringStruct), NULL, 0 }, // materialNames[]
...
NxParameterized::MutexType RenderMeshAssetParameters::mBuiltFlagMutex;

RenderMeshAssetParameters::RenderMeshAssetParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RenderMeshAssetParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RenderMeshAssetParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RenderMeshAssetParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RenderMeshAssetParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RenderMeshAssetParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void RenderMeshAssetParameters::initDynamicArrays(void)
{
	...
	submeshes.elementSize = sizeof(NxParameterized::Interface*);
	submeshes.arraySizes[0] = 0;
	materialNames.buf = NULL;
	materialNames.isAllocated = true;
	materialNames.elementSize = sizeof(NxParameterized::DummyStringStruct);
...
void RenderMeshAssetParameters::initDefaults(void)
{
	...
	freeReferences();
	freeDynamicArrays();
	textureUVOrigin = physx::PxU32(0);
	boneCount = physx::PxU32(0);
