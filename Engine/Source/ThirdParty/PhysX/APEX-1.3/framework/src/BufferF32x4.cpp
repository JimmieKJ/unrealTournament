...
using namespace BufferF32x4NS;

const char* const BufferF32x4Factory::vptr =
    NxParameterized::getVptr<BufferF32x4, BufferF32x4::ClassAlignment>();
...
bool BufferF32x4::mBuiltFlag = false;
NxParameterized::MutexType BufferF32x4::mBuiltFlagMutex;

BufferF32x4::BufferF32x4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BufferF32x4FactoryInst);
...
const NxParameterized::DefinitionImpl* BufferF32x4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BufferF32x4::getParameterDefinitionTree(void) const
{
	BufferF32x4* tmpParam = const_cast<BufferF32x4*>(this);
...
NxParameterized::ErrorType BufferF32x4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BufferF32x4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BufferF32x4::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BufferF32x4::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BufferF32x4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BufferF32x4::buildTree(void)
{
...
void BufferF32x4::initStrings(void)
{
}

void BufferF32x4::initDynamicArrays(void)
{
	data.buf = NULL;
...
void BufferF32x4::initDefaults(void)
{
...
void BufferF32x4::initReferences(void)
{
}

void BufferF32x4::freeDynamicArrays(void)
{
...
void BufferF32x4::freeStrings(void)
{
}

void BufferF32x4::freeReferences(void)
{
}
