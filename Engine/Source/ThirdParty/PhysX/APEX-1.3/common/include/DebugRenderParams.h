...
struct ParametersStruct
{
	...
	bool Enable;
	physx::PxF32 Scale;
	physx::PxF32 LodBenefits;
	physx::PxF32 RelativeLodBenefitsScreenPos;
	physx::PxF32 RelativeLodBenefitsThickness;
	physx::PxF32 LodDistanceScale;
	physx::PxF32 RenderNormals;
	physx::PxF32 RenderTangents;
	physx::PxF32 RenderBitangents;
	bool Bounds;
	REF_DynamicArray1D_Type moduleName;

};

static const physx::PxU32 checksum[] = { 0x8bf75555, 0xaddd1e89, 0x70393703, 0xece35209, };

} // namespace DebugRenderParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class DebugRenderParams : public NxParameterized::NxParameters, public DebugRenderParamsNS::ParametersStruct
{
public:
	DebugRenderParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class DebugRenderParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, DebugRenderParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DebugRenderParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(DebugRenderParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, DebugRenderParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, DebugRenderParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, DebugRenderParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class DebugRenderParams");
			return 0;
		}
