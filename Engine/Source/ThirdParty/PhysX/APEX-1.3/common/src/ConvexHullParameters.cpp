...
const char* const ConvexHullParametersFactory::vptr =
    NxParameterized::getVptr<ConvexHullParameters, ConvexHullParameters::ClassAlignment>();
...
NxParameterized::MutexType ConvexHullParameters::mBuiltFlagMutex;

ConvexHullParameters::ConvexHullParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ConvexHullParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ConvexHullParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ConvexHullParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ConvexHullParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ConvexHullParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
