 ...
 */
class INTERNATIONALIZATION_API FLocTextConflicts
{
private:
	...
	struct FConflictContainerKeyFuncs : BaseKeyFuncs<TSharedRef<FConflict>, FString, true>
	{
		static FORCEINLINE const FString& GetSetKey(const TPair<FString, TSharedRef<FConflict>>& Element)
		{
			return Element.Key;
		}
	...
	typedef TMultiMap<FString, TSharedRef<FConflict>, FDefaultSetAllocator, FConflictContainerKeyFuncs> FConflictMap;
 ...
 */
class INTERNATIONALIZATION_API FLocTextHelper
{
public:
	/**
