...
struct ENGINE_API FRootMotionSource
{
	...
	/** 
	 *  True when this RootMotionSource should impart velocity to character velocity on removal
	 *  Only relevant for additive sources since overrides are by nature already part of normal
	 *  character velocity. Defaults to true.
	 */
	UPROPERTY()
	bool bImpartsVelocityOnRemoval;
