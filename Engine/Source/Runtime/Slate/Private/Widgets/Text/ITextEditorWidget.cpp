...
ECursorMoveMethod FMoveCursor::GetMoveMethod( ) const { return Method; }

bool FMoveCursor::IsVerticalMovement( ) const { return DirectionOrPosition.Y != 0.0f; }

bool FMoveCursor::IsHorizontalMovement( ) const { return DirectionOrPosition.X != 0.0f; }

FIntPoint FMoveCursor::GetMoveDirection( ) const { return FIntPoint( DirectionOrPosition.X, DirectionOrPosition.Y ); }

ECursorAction FMoveCursor::GetAction( ) const { return Action; }

FVector2D FMoveCursor::GetLocalPosition( ) const { return DirectionOrPosition; }

ECursorMoveGranularity FMoveCursor::GetGranularity() const { return Granularity; }

float FMoveCursor::GetGeometryScale( ) const { return GeometryScale; }
