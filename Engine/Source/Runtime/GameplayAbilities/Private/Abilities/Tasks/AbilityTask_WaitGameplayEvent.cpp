...
UAbilityTask_WaitGameplayEvent* UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(UObject* WorldContextObject, FGameplayTag Tag, AActor* OptionalExternalTarget, bool OnlyTriggerOnce)
{
	auto MyObj = NewAbilityTask<UAbilityTask_WaitGameplayEvent>(WorldContextObject);
	MyObj->Tag = Tag;
