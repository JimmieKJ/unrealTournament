...
TMap<FD3D12VertexDeclarationKey, FVertexDeclarationRHIRef> GVertexDeclarationCache;
...
FVertexDeclarationRHIRef FD3D12DynamicRHI::RHICreateVertexDeclaration(const FVertexDeclarationElementList& Elements)
{
	...
	if (VertexDeclarationRefPtr == NULL)
	{
		...
		VertexDeclarationRefPtr = &GVertexDeclarationCache.Add(Key, new FD3D12VertexDeclaration(Key.VertexElements));
	}
