 ...
 */ 
#if _MSC_VER > 1800
	#pragma message("Detected compiler newer than Visual Studio 2013, please update min version checking in WindowsPlatformCompilerSetup.h")
#endif


/**
 * We require at least Visual Studio 2012 to compile
 */
static_assert(_MSC_VER >= 1700, "Visual Studio 2012 or newer required.");
