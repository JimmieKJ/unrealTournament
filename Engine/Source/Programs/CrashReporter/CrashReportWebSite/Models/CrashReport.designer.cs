...
namespace Tools.CrashReporter.CrashReportWebSite.Models
{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Buggs_User> _Buggs_Users1;
		
		private EntitySet<Crash> _Crashes;
		
		private EntitySet<Crash> _CrashesFromName;
    ...
    partial void OnUserGroupIdChanged();
		...
		public User()
		{
			...
			this._Buggs_Users1 = new EntitySet<Buggs_User>(new Action<Buggs_User>(this.attach_Buggs_Users1), new Action<Buggs_User>(this.detach_Buggs_Users1));
			this._Crashes = new EntitySet<Crash>(new Action<Crash>(this.attach_Crashes), new Action<Crash>(this.detach_Crashes));
			this._CrashesFromName = new EntitySet<Crash>(new Action<Crash>(this.attach_CrashesFromName), new Action<Crash>(this.detach_CrashesFromName));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Buggs_User1", Storage="_Buggs_Users1", ThisKey="Id", OtherKey="UserNameId")]
		public EntitySet<Buggs_User> Buggs_Users1
		{
			get
			{
				return this._Buggs_Users1;
			}
			set
			{
				this._Buggs_Users1.Assign(value);
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Crash1", Storage="_CrashesFromName", ThisKey="UserName", OtherKey="UserName")]
		public EntitySet<Crash> CrashesFromName
		{
			get
			{
				return this._CrashesFromName;
			}
			set
			{
				this._CrashesFromName.Assign(value);
			}
		}
		...
		private void attach_CrashesFromName(Crash entity)
		{
			this.SendPropertyChanging();
			entity.UserByName = this;
		}
    ...
    partial void OnUserNameIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Buggs_User1", Storage="_User1", ThisKey="UserNameId", OtherKey="Id", IsForeignKey=true)]
		public User User1
		{
			get
			{
			...
			set
			{
							...
							|| (this._User1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Buggs_Users1.Remove(this);
					}
					this._User1.Entity = value;
					if ((value != null))
					{
						value.Buggs_Users1.Add(this);
						this._UserNameId = value.Id;
					}
					else
					{
	...
	public partial class Crash : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _HasNewLogFile;
    ...
    partial void OnHasNewLogFileChanging(System.Nullable<bool> value);
    partial void OnHasNewLogFileChanged();
    ...
    partial void OnEngineVersionChanged();
		...
		public string UserName
		{
			...
			set
			{
				if ((this._UserName != value))
				{
					if (this._UserByName.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnUserNameChanging(value);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HasNewLogFile", DbType="Bit")]
		public System.Nullable<bool> HasNewLogFile
		{
			get
			{
				return this._HasNewLogFile;
			}
			set
			{
				if ((this._HasNewLogFile != value))
				{
					this.OnHasNewLogFileChanging(value);
					this.SendPropertyChanging();
					this._HasNewLogFile = value;
					this.SendPropertyChanged("HasNewLogFile");
					this.OnHasNewLogFileChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Crash1", Storage="_UserByName", ThisKey="UserName", OtherKey="UserName", IsForeignKey=true)]
		public User UserByName
		{
			get
			{
				return this._UserByName.Entity;
			}
			set
			{
				User previousValue = this._UserByName.Entity;
				if (((previousValue != value) 
							|| (this._UserByName.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._UserByName.Entity = null;
						previousValue.CrashesFromName.Remove(this);
					}
					this._UserByName.Entity = value;
					if ((value != null))
					{
						value.CrashesFromName.Add(this);
					...
					this.SendPropertyChanged("UserByName");
				}
			}
		}
