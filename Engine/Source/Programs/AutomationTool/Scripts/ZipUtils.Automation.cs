...
public class ZipUtils : BuildCommand
{
    public override ExitCode Execute()
    {
        ...
        else /*(bZip)*/
        {
           ...
           InternalZipFiles(ZipFilePath, ArchiveFolder, Filter, CompressionLevel);           
        }
    ...
    internal static void InternalZipFiles(string ZipFileName, string BaseDirectory, FileFilter Filter, int CompressionLevel = 0)
    {
