...
xcopy RunUT-Test.bat P:\Builds\UnrealTournament\++depot+UE4-UT-Releases-CL-%1\WindowsNoEditor
xcopy RunUT-Test32.bat P:\Builds\UnrealTournament\++depot+UE4-UT-Releases-CL-%1\WindowsNoEditor
