...
DECLARE_DELEGATE_OneParam(FPlatformChunkInstallErrorDelegate, const FText&);
...
public:
	...
	void Initialize(const FString& InBaseUrl, const FString& InMcpConfig);
	bool IsEnabled() const { return bEnabled; }
	bool IsReadyToInstall() const { return InstallerState > ChunkInstallState::PostSetup;  }

private:

	void InitialiseSystem(const FString& InBaseUrl, const FString& InMcpConfig);
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FPlatformChunkInstallErrorMultiDelegate, const FText&);
