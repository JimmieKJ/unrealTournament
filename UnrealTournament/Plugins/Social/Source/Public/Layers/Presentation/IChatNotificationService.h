...
public:
	...
	DECLARE_EVENT_TwoParams(IChatNotificationService, FOnJoinGameEvent, const FUniqueNetId& /* FriendId*/, const FUniqueNetId& /*SessionId*/);
	virtual FOnJoinGameEvent& OnJoinGame() = 0;
};