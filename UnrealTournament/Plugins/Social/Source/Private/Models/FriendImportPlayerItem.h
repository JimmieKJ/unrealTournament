 ...
 */
class FFriendImportPlayerItem : public IFriendItem 
{
public:

	FFriendImportPlayerItem(const TSharedRef<FOnlineUser>& InOnlineUser, const FString& InAuthType) :
...
private:
	...
	FFriendImportPlayerItem();

private:

	const TSharedRef<FOnlineUser> OnlineUser;
