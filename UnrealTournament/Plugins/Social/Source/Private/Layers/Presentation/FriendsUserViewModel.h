...
*/
FACTORY(TSharedRef< FFriendsUserViewModel >, FFriendsUserViewModel, const TSharedRef<class FFriendsService>& FriendsService, const TSharedRef<class FWebImageService>& WebImageService);