...
private:
	...
	DECLARE_DERIVED_EVENT(FChatNotificationServiceImpl, IChatNotificationService::FOnJoinGameEvent, FOnJoinGameEvent);
	virtual FOnJoinGameEvent& OnJoinGame() override
	{
		return JoinGameDelegate;
	}

	FOnNotificationAvailableEvent NotificationAvailableDelegate;
	FOnSendNotificationEvent SendNotificationDelegate;
	FOnJoinGameEvent JoinGameDelegate;
