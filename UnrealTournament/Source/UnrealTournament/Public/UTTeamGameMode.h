...
class UNREALTOURNAMENT_API AUTTeamGameMode : public AUTGameMode
{
	...
	virtual void ModifyDamage_Implementation(int32& Damage, FVector& Momentum, APawn* Injured, AController* InstigatedBy, const FHitResult& HitInfo, AActor* DamageCauser, TSubclassOf<UDamageType> DamageType) override;
