...
/** utility to create a copy of a skeletal mesh for outline effect purposes
 * the mesh is initialized but not registered
 */
extern USkeletalMeshComponent* CreateCustomDepthOutlineMesh(USkeletalMeshComponent* Archetype, AActor* Owner);
