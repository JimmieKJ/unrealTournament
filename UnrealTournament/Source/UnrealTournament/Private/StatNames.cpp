...
const FName NAME_BioLauncherKills(TEXT("BioLauncherKills"));
...
const FName NAME_BioLauncherDeaths(TEXT("BioLauncherDeaths"));
...
const FName NAME_BioLauncherShots(TEXT("BioLauncherShots"));
...
const FName NAME_BioLauncherHits(TEXT("BioLauncherHits"));
