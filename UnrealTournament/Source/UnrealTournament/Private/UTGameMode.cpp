	...
	: Super(PCIP)
{
	...
	static ConstructorHelpers::FObjectFinder<UBlueprint> PlayerPawnObject(TEXT("Blueprint'/Game/RestrictedAssets/Blueprints/WIP/Nick/NickUTCharacter2.NickUTCharacter2'"));
