...
TSharedRef<SWidget> SUWSystemSettingsDialog::BuildGraphicsTab()
{
	...
	TSharedRef<SBox> PPAdvanced = SNew(SBox)
		[
			...
			+ AddConsoleVarSliderWidget(MakeShareable(new SSlateConsoleVarDelegate(TEXT("r.Tonemapper.Quality"), FVector2D(0.0f, 1.0f))), NSLOCTEXT("SUWSystemSettingsDialog", "TonemapperQuality", "Tonemapper Quality"))
