...
void SUTQuickMatch::NoAvailableMatches()
{
	...
	PlayerOwner->MessageBoxW(NSLOCTEXT("QuickMatch", "NoServersTitle", "ONLINE FAILURE"), NSLOCTEXT("QuickMatch", "NoServerTitle", "The Online System is down for maintence, please try again in a few minutes."));
}
