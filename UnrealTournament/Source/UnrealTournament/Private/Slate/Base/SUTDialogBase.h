...
/**
 *	This is the base for the UT Dialog class.  UT Dialog's are windows that can appear at any layer but have a caption and button bar.  
 **/
#pragma once
...
class UNREALTOURNAMENT_API SUTDialogBase : public SCompoundWidget
{
	SLATE_BEGIN_ARGS(SUTDialogBase)
