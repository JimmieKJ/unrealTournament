...
public class UnrealTournament : ModuleRules
{
    public UnrealTournament(TargetInfo Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "AIModule", "OnlineSubsystem", "OnlineSubsystemUtils", "RenderCore", "Navmesh", "Json", "HTTP", "UMG" });
