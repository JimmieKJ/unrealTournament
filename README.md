...
The current Unreal Tournament project is based on Unreal Engine version  [4.1.0](https://github.com/EpicGames/UnrealEngine/releases/tag/4.1.0-release).  

In order to contribute you should **setup a Git client** on your computer.  [This page](http://help.github.com/articles/set-up-git) will have the info you need.

See also https://github.com/EpicGames/UnrealEngine for getting started with the engine.
